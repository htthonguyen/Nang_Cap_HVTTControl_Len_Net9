...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(true),Designer(typeof(ExpandableSplitterDesigner)),System.Runtime.InteropServices.ComVisible(false),DefaultEvent("ExpandedChanged")]
...
//		}
		...
		public void ApplyStyle(eSplitterStyle style)
		{
			...
			{
				m_ColorScheme=new ColorScheme(HVTTControlStyle.VS2005);
				this.BackColorSchemePart=eColorSchemePart.None;
		...
		private bool ProcessShortcut(eShortcut key)
		{
			...
			{
				SetExpanded(!this.Expanded,EventSource.Keyboard);
			}
			return false;
		}
	...
	public class ExpandedChangeEventArgs:EventArgs
	{
		...
		public ExpandedChangeEventArgs(EventSource action, bool newExpandedValue)
		{
