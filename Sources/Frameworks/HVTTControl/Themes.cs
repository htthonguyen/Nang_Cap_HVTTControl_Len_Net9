...
namespace HVTT.UI.Window.Forms
{
	...
	internal class ThemeButton:Themes
	{
		...
		public void DrawBackground(Graphics g, ThemeButtonParts part, ThemHVTTButtonStates state, Rectangle r)
		{
			InternalDrawBackground(g,part,state,r);
		}
		public void DrawText(Graphics g, string text, Font font, Rectangle layoutRect, ThemeButtonParts part, ThemHVTTButtonStates state, ThemeTextFormat format, bool drawdisabled)
		{
			InternalDrawText(g,text,font,layoutRect,part,state,format,drawdisabled);
		}
		public void DrawText(Graphics g, string text, Font font, Rectangle layoutRect, ThemeButtonParts part, ThemHVTTButtonStates state, ThemeTextFormat format)
		{
			InternalDrawText(g,text,font,layoutRect,part,state,format,false);
		}
		public void DrawText(Graphics g, string text, Font font, Rectangle layoutRect, ThemeButtonParts part, ThemHVTTButtonStates state)
		{
	...
	internal class ThemHVTTButtonStates:ThemeState
	{
		protected ThemHVTTButtonStates(int themestatevalue):base(themestatevalue)
		{
		}
		// Push Buttons
		public static ThemHVTTButtonStates PushButtonNormal=new ThemHVTTButtonStates(1);
		public static ThemHVTTButtonStates PushButtonHot=new ThemHVTTButtonStates(2);
		public static ThemHVTTButtonStates PushButtonPressed=new ThemHVTTButtonStates(3);
		public static ThemHVTTButtonStates PushButtonDisabled=new ThemHVTTButtonStates(4);
		public static ThemHVTTButtonStates PushButtonDefaulted=new ThemHVTTButtonStates(5);

		// Radio Buttons
		public static ThemHVTTButtonStates RadioButtonUncheckedNormal=new ThemHVTTButtonStates(1);
		public static ThemHVTTButtonStates RadioButtonUncheckedHot=new ThemHVTTButtonStates(2);
		public static ThemHVTTButtonStates RadioButtonUncheckedPressed=new ThemHVTTButtonStates(3);
		public static ThemHVTTButtonStates RadioButtonUncheckedDisabled=new ThemHVTTButtonStates(4);
		public static ThemHVTTButtonStates RadioButtonCheckedNormal=new ThemHVTTButtonStates(5);
		public static ThemHVTTButtonStates RadioButtonCheckedHot=new ThemHVTTButtonStates(6);
		public static ThemHVTTButtonStates RadioButtonCheckedPressed=new ThemHVTTButtonStates(7);
		public static ThemHVTTButtonStates RadioButtonCheckedDisabled=new ThemHVTTButtonStates(8);

		// Check Boxes
		public static ThemHVTTButtonStates CheckBoxUncheckedNormal=new ThemHVTTButtonStates(1);
		public static ThemHVTTButtonStates CheckBoxUncheckedHot=new ThemHVTTButtonStates(2);
		public static ThemHVTTButtonStates CheckBoxUncheckedPressed=new ThemHVTTButtonStates(3);
		public static ThemHVTTButtonStates CheckBoxUncheckedDisabled=new ThemHVTTButtonStates(4);
		public static ThemHVTTButtonStates CheckBoxCheckedNormal=new ThemHVTTButtonStates(5);
		public static ThemHVTTButtonStates CheckBoxCheckedHot=new ThemHVTTButtonStates(6);
		public static ThemHVTTButtonStates CheckBoxCheckedPressed=new ThemHVTTButtonStates(7);
		public static ThemHVTTButtonStates CheckBoxCheckedDisabled=new ThemHVTTButtonStates(8);
		public static ThemHVTTButtonStates CheckBoxMixedNormal=new ThemHVTTButtonStates(9);
		public static ThemHVTTButtonStates CheckBoxMixedHot=new ThemHVTTButtonStates(10);
		public static ThemHVTTButtonStates CheckBoxMixedPressed=new ThemHVTTButtonStates(11);
		public static ThemHVTTButtonStates CheckBoxMixedDisabled=new ThemHVTTButtonStates(12);

		// Group Box
		public static ThemHVTTButtonStates GroupBoxNormal=new ThemHVTTButtonStates(1);
		public static ThemHVTTButtonStates GroupBoxDisabled=new ThemHVTTButtonStates(2);
	}
	...
	internal class ThemeRebar:Themes
	{
		...
		public void DrawBackground(Graphics g, ThemeRebarParts part, ThemeRHVTTBarStates state, Rectangle r)
		{
			InternalDrawBackground(g,part,state,r);
		}
	}
	...
	internal class ThemeRHVTTBarStates:ThemeState
	{
		protected ThemeRHVTTBarStates(int themestatevalue):base(themestatevalue) {}
		public static ThemeRHVTTBarStates Normal=new ThemeRHVTTBarStates(0);
		public static ThemeRHVTTBarStates ChevronNormal=new ThemeRHVTTBarStates(1);
		public static ThemeRHVTTBarStates ChevronHot=new ThemeRHVTTBarStates(2);
		public static ThemeRHVTTBarStates ChevronPressed=new ThemeRHVTTBarStates(3);
	}
