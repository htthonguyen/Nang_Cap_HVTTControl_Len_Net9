...
namespace HVTT.UI.Window.Forms
{
    ...
    /// </summary>
    [ToolboxItem(true),Designer(typeof(HVTT.UI.Window.Forms.Design.ExpandablePanelDesigner)),ToolboxBitmap(typeof(ExpandablePanel),"ExpandablePanel.ico")]
    public class ExpandablePanel:HVTTPanel
    {
        ...
        private HVTTPanel m_VerticalExpandPane = null;
        ...
        private void SetExpanded(bool expanded, EventSource action)
        {
        ...
        private void UpdateExpandButtonImage()
        {
            ...
            if (this.Expanded)
            {
                ...
                {
                    if (this.ColorSchemeStyle == HVTTControlStyle.Office2007)
                    {
        ...
        {
            m_VerticalExpandPane = new HVTTPanel();
        ...
        /// </summary>
        [Browsable(true), DefaultValue(""), Category("Title"), Description("Indicates text for the title of the panel."), Localizable(true), Editor(typeof(Design.TextMarkupUIEditor), typeof(System.Drawing.Design.UITypeEditor))]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), NotifyParentPropertyAttribute(true), Category("Title"), Description("Gets or sets title style."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), NotifyParentPropertyAttribute(true), Category("Title"), Description("Gets or sets the title style when mouse hovers over the title."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), NotifyParentPropertyAttribute(true), Category("Title"), Description("Gets or sets the Title style when mouse button is pressed on the title."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// </summary>
        [Browsable(false)]
        public HVTTPanel VerticalExpandPanel
        {
