...
{
    /// <summary>
    /// Represents Office 12 Rendering Control renderer.
    /// </summary>
    public class Office2007Renderer : BaseRenderer
    {
        ...
        {
            RibbonTabGroupPainter painter = PainterFactory.CreateRibbonTabGroupPainter(e.RibbonTabItemGroup);
            if (painter is IOffice2007Painter)
                ((IOffice2007Painter)painter).ColorTable = m_ColorTable;
        ...
        public override void DrawToolbarBackground(ToolbarRendererEventArgs e)
        {
            ...
            if (e.Bar.BarState == HVTTBarState.Docked)
                painter.PaintDockedBackground(e);
            else if (e.Bar.BarState == HVTTBarState.Floating)
