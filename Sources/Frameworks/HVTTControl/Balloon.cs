...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(false),System.Runtime.InteropServices.ComVisible(false),Designer(typeof(System.Windows.Forms.Design.ParentControlDesigner))]
	public class Balloon : System.Windows.Forms.Form
	{
		...
		{
			System.Drawing.Size newSize=Size.Empty;
...
//			}
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Appearance"),DefaultValue(255),Description("Specifies the transparency of background image.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),DefaultValue(eBallonStyle.Balloon),Description("Specifies balloon style.")]
		...
		private void AutoCloseTimeOutEllapsed(object sender, EventArgs e)
		{
			if(this.IsDisposed)
				return;
			DestroyAutoCloseTimer();
