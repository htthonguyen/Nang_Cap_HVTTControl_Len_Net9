...
namespace HVTT.UI.Window.Forms
{
	...
	public class SideBarContainerItem:ImageItem, IDesignTimeProvider
	{
		...
		public override void RecalcSize()
		{
			...
			// Recalculation of the size for this item is different then rest of the HVTTCONTROLS.
		...
		public override HVTTOrientation Orientation
		{
			get
			{
				return HVTTOrientation.Horizontal;
			}
			set
			{
				return;
		...
		protected internal override void OnItemAdded(BaseItem item)
		{
			...
			if(this.ContainerControl is SideBar && item is SideBarPanelItem)
			{
                ...
                //if(panel.Appearance==SideBarAppearance.Flat && this.DesignMode)
                //{
