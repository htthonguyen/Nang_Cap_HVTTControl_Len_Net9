...
{
    [ToolboxItem(false)]
    internal class PanelExTitle:HVTTPanel
    {
        ...
        private TitleButtonAlignment m_ButtonAlignment = TitleButtonAlignment.Right;
        ...
        public PanelExTitle()
        {
            ...
            m_ExpandChangeButton.Style = HVTTControlStyle.Office2003;
        ...
        public void UpdateButtonPosition()
        {
            ...
            if (m_ButtonAlignment == TitleButtonAlignment.Right)
            {
        ...
        protected override void RefreshTextClientRectangle()
        {
            ...
            if (m_ButtonAlignment == TitleButtonAlignment.Left)
            {
        ...
        /// </summary>
        [Browsable(false), DefaultValue(TitleButtonAlignment.Right), Category("Expand Button"), Description("Indicates the alignment of button."), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public TitleButtonAlignment ButtonAlignment
        {
