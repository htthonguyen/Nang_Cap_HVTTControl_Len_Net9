...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(true), Designer(typeof(Design.NavigationPaneDesigner))]
	public class NavigationPane : System.Windows.Forms.UserControl
	{
		private HVTT.UI.Window.Forms.PanelExTitle panelTitle;
		private HVTT.UI.Window.Forms.NavigationBar navBar;
        ...
        private HVTTPanel m_PanePopupPanel = null;
        private int m_AnimationTime = 100;
        private bool m_PopupPaneVisible = false;
        private HVTTPanel m_PopupPanelContainer = null;
		...
		public NavigationPane()
		{
            ...
            navBar.LocalizeString += new HVTTManager.LocalizeStringEventHandler(navBar_LocalizeString);
        ...
        public void SetCurrentPanel(String ButtonName)
        {
            ...
            foreach (Control c in this.Controls)
            {
                if (c is NavigationPanePanel)
                {
                    ...
                    if (panel.ParentItem.Name == ButtonName)
                    {
                        item = panel.ParentItem as ButtonItem;
                        ItemCheckedChanged(item, new EventArgs());
                    }
                }
            }
        }
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Layout"),DefaultValue(32)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Appearance"),Description("Indicates size of the image that will be use to resize images to when button button is on the bottom summary line of navigation bar and AutoSizeButtonImage=true.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Behavior"),Description("Indicates Configure Buttons button is visible."),DefaultValue(true)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Behavior"),Description("Indicates whether Show More Buttons and Show Fewer Buttons menu items are visible on Configure buttons menu."),System.ComponentModel.DefaultValue(true)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Behavior"),Description("Gets or sets whether Navigation Pane Options menu item is visible on Configure buttons menu."),System.ComponentModel.DefaultValue(true)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Behavior"),Description("Indicates whether Navigation Pane Add/Remove Buttons menu item is visible on Configure buttons menu."),System.ComponentModel.DefaultValue(true)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DesignerSerializationVisibility(DesignerSerializationVisibility.Content),Category("Appearance"),Description("PanelEx control that is used to display title.")]
		public HVTTPanel TitlePanel
		{
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Layout"),Description("Indicates the padding in pixels at the top portion of the item."),DefaultValue(4)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Layout"),Description("Indicates the padding in pixels at the bottom of the item."),DefaultValue(4)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Appearance"),Description("Indicates whether images are automatically resized to size specified in ImageSizeSummaryLine when button is on the bottom summary line of navigation bar."),DefaultValue(true)]
        ...
        /// </summary>
        [Browsable(true), DefaultValue(TitleButtonAlignment.Right), Category("Title"), Description("Indicates the alignment of expand button inside title bar.")]
        public TitleButtonAlignment TitleButtonAlignment
        {
        ...
        public bool Expanded
        {
            ...
            set
            {
                ...
                if (m_Expanded != value)
                {
					SetExpanded(value, EventSource.Code);
                }
            }
        }

		private void SetExpanded(bool expanded, EventSource source)
		{
        ...
        {
            SetExpanded(!this.Expanded,EventSource.Mouse);
        }
        ...
        {
            m_PanePopupPanel = new HVTTPanel();
        ...
        private void UpdateExpandButton()
        {
            ...
            if (m_Expanded)
            {
                if (panelTitle.ButtonAlignment == TitleButtonAlignment.Right || m_TitleImageCollapse!=null)
                {
            ...
            {
                if (panelTitle.ButtonAlignment == TitleButtonAlignment.Right || m_TitleImageExpand != null)
                {
                    panelTitle.ExpandChangeButton.Image = GetExpandImage(false);
                    panelTitle.ExpandChangeButton.HoverImage = GetExpandImage(true);
                }
        ...
        private void ColorSchemeStyleChanged()
        {
            ColorScheme cs = null;
            HVTTControlStyle style = navBar.Style;
		...
		{
			this.panelTitle = new HVTT.UI.Window.Forms.PanelExTitle();
			this.navBar = new HVTT.UI.Window.Forms.NavigationBar();
			...
			this.panelTitle.Style.BackColor1.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.PanelBackground;
			this.panelTitle.Style.BackColor2.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.PanelBackground2;
			this.panelTitle.Style.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
            this.panelTitle.Style.BorderSide = BorderSide.Bottom;
			this.panelTitle.Style.BorderColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.PanelBorder;
			this.panelTitle.Style.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.PanelText;
			...
			this.navBar.BackgroundStyle.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
            this.navBar.BackgroundStyle.BorderSide = BorderSide.Top;
