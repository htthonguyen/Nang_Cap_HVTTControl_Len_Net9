...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(true),System.Runtime.InteropServices.ComVisible(false), Designer(typeof(Design.NavigationBarDesigner))]
	public class NavigationBar: BarBaseControl,ISupportInitialize
	{
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Behavior"),Description("Indicates whether summary line is visible."),System.ComponentModel.DefaultValue(true)]
		...
		protected virtual Rectangle GetSplitterRectangle()
		{
			...
			{
				if((this.BackgroundStyle.BorderSide & BorderSide.Top)==BorderSide.Top)
					r.Y++;
				if((this.BackgroundStyle.BorderSide & BorderSide.Right)==BorderSide.Right)
					r.Width--;
				if((this.BackgroundStyle.BorderSide & BorderSide.Left)==BorderSide.Left)
				{
					r.X++;
					r.Width--;
				}
		...
		internal void SplitterMouseMove(MouseEventArgs e)
		{
...
//					this.Height+=itemHeight+1;
		...
		internal void SplitterMouseLeave()
		{
			if(m_SavedSplitterCursor!=null)
			{
				if(this.GetDesignMode())
		...
		internal void SplitterMouseDown(MouseEventArgs e)
		{
		...
		internal bool IsSplitterMouseDown
		{
			get {return m_SplitterMouseDown;}
		}

		internal void SplitterMouseUp(MouseEventArgs e)
		{
			if(m_SplitterMouseDown)
			{
		...
		/// proper layout.
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Layout"),Description("Indicates whether splitter on top of the navigation bar is visible."),DefaultValue(false)]
