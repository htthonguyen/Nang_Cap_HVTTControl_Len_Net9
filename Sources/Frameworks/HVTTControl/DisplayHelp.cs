...
namespace HVTT.UI.Window.Forms
{
	...
	internal class DisplayHelp
	{
        ...
        public static GraphicsPath GetRoundedRectanglePath(Rectangle clientRectangle, int cornerSize, eStyleBackgroundPathPart pathPart,
            CornerType topLeftCornerType, CornerType topRightCornerType, CornerType bottomLeftCornerType, CornerType bottomRightCornerType)
        {
        ...
        public static GraphicsPath GetRoundedRectanglePath(Rectangle clientRectangle, int cornerSize, eStyleBackgroundPathPart pathPart,
            CornerType topLeftCornerType, CornerType topRightCornerType, CornerType bottomLeftCornerType, CornerType bottomRightCornerType, float partSize)
        {
            GraphicsPath path = new GraphicsPath();
            ...
            CornerType corner = topLeftCornerType;
            ...
            bool leftBorder, bool rightBorder, bool topBorder, bool bottomBorder)
        {
            ...
            if (leftBorder)
            {
                path.AddLine(clientRectangle.X, clientRectangle.Bottom -
                    (bottomBorder && (bottomLeftCornerType == CornerType.Diagonal || bottomLeftCornerType == CornerType.Rounded) ? cornerSize : 0),
                    clientRectangle.X, clientRectangle.Y +
                    (topBorder && (topLeftCornerType == CornerType.Diagonal || topLeftCornerType == CornerType.Rounded) ? cornerSize : 0));
            }
            ...
            if (topBorder)
            {
                path.AddLine(clientRectangle.X + 
                    ((topLeftCornerType == CornerType.Diagonal || topLeftCornerType == CornerType.Rounded) ? cornerSize : 0)
                    , clientRectangle.Y, clientRectangle.Right -
                    (rightBorder && (topRightCornerType == CornerType.Diagonal || topRightCornerType == CornerType.Rounded) ? cornerSize : 0),
                    clientRectangle.Y);
            }
            ...
            if (rightBorder)
            {
                path.AddLine(clientRectangle.Right, clientRectangle.Y +
                    ((topRightCornerType == CornerType.Diagonal || topRightCornerType == CornerType.Rounded) ? cornerSize : 0),
                    clientRectangle.Right, clientRectangle.Bottom -
                    (bottomBorder && (bottomRightCornerType == CornerType.Diagonal || bottomRightCornerType == CornerType.Rounded) ? cornerSize : 0));
            }
            ...
            if (bottomBorder)
            {
                path.AddLine(clientRectangle.Right -
                    ((bottomRightCornerType == CornerType.Diagonal || bottomRightCornerType == CornerType.Rounded) ? cornerSize : 0),
                    clientRectangle.Bottom,
                    clientRectangle.X + 
                    ((bottomLeftCornerType == CornerType.Diagonal || bottomLeftCornerType == CornerType.Rounded) ? cornerSize : 0),
                    clientRectangle.Bottom);
            }
        ...
        public static void DrawRoundGradientRectangle(Graphics g, Rectangle bounds, Color color1, Color color2, int gradientAngle, int penWidth, int roundCornerSize)
        {
            ...
            using (GraphicsPath roundPath = GetRoundedRectanglePath(r, roundCornerSize))
            {
                ...
                if (color2.IsEmpty)
                {
                    DrawRoundedRectangle(g, color1, bounds, roundCornerSize);
                    //using (SolidBrush brush = new SolidBrush(color1))
