...
namespace HVTT.UI.Window.Forms
{
	...
	internal class SideBarColorSchemePicker : System.Windows.Forms.Form
	{
		...
		public SideBarColorScheme SelectedColorScheme=SideBarColorScheme.Blue;
		private HVTT.UI.Window.Forms.SideBar sideBar1;
		private HVTT.UI.Window.Forms.SideBarPanelItem sideBarPanelItem1;
		private HVTT.UI.Window.Forms.ButtonItem buttonItem1;
		private HVTT.UI.Window.Forms.ButtonItem buttonItem2;
		private HVTT.UI.Window.Forms.ButtonItem buttonItem3;
		private HVTT.UI.Window.Forms.ButtonItem buttonItem4;
		private HVTT.UI.Window.Forms.SideBarPanelItem sideBarPanelItem2;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.sideBar1 = new HVTT.UI.Window.Forms.SideBar();
			this.sideBarPanelItem1 = new HVTT.UI.Window.Forms.SideBarPanelItem();
			this.buttonItem1 = new HVTT.UI.Window.Forms.ButtonItem();
			this.buttonItem2 = new HVTT.UI.Window.Forms.ButtonItem();
			this.buttonItem3 = new HVTT.UI.Window.Forms.ButtonItem();
			this.buttonItem4 = new HVTT.UI.Window.Forms.ButtonItem();
			this.sideBarPanelItem2 = new HVTT.UI.Window.Forms.SideBarPanelItem();
			this.SuspendLayout();
			// 
			// listBox1
			// 
			...
			this.sideBar1.Appearance = HVTT.UI.Window.Forms.SideBarAppearance.Flat;
			this.sideBar1.BorderStyle = HVTT.UI.Window.Forms.eBorderType.None;
			...
			this.sideBar1.Panels.AddRange(new HVTT.UI.Window.Forms.BaseItem[] {
			...
			this.sideBarPanelItem1.BackgroundStyle.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
			...
			this.sideBarPanelItem1.HeaderSideStyle.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
			...
			this.sideBarPanelItem1.HeaderSideStyle.BorderSide = ((HVTT.UI.Window.Forms.BorderSide.Left | HVTT.UI.Window.Forms.BorderSide.Top) 
			...
			this.sideBarPanelItem1.HeaderStyle.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
			...
			this.sideBarPanelItem1.HeaderStyle.BorderSide = ((HVTT.UI.Window.Forms.BorderSide.Right | HVTT.UI.Window.Forms.BorderSide.Top) 
				| HVTT.UI.Window.Forms.BorderSide.Bottom);
			...
			this.sideBarPanelItem1.SubItems.AddRange(new HVTT.UI.Window.Forms.BaseItem[] {
																								this.buttonItem1,
																								this.buttonItem2,
																								this.buttonItem3,
																								this.buttonItem4});
			...
			this.sideBarPanelItem2.BackgroundStyle.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
			...
			this.sideBarPanelItem2.HeaderSideStyle.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
			...
			this.sideBarPanelItem2.HeaderSideStyle.BorderSide = ((HVTT.UI.Window.Forms.BorderSide.Left | HVTT.UI.Window.Forms.BorderSide.Top) 
				| HVTT.UI.Window.Forms.BorderSide.Bottom);
			...
			this.sideBarPanelItem2.HeaderStyle.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
			...
			this.sideBarPanelItem2.HeaderStyle.BorderSide = ((HVTT.UI.Window.Forms.BorderSide.Right | HVTT.UI.Window.Forms.BorderSide.Top) 
				| HVTT.UI.Window.Forms.BorderSide.Bottom);
		...
		private void SideBarColorSchemePicker_Load(object sender, System.EventArgs e)
		{
			...
			foreach(string s in Enum.GetNames(typeof(SideBarColorScheme)))
			{
		...
		{
			SideBarColorScheme scheme;
			if(listBox1.SelectedIndex<0)
				return;
			string sSel=listBox1.SelectedItem.ToString();
			scheme=(SideBarColorScheme)Enum.Parse(typeof(SideBarColorScheme),sSel,false);
