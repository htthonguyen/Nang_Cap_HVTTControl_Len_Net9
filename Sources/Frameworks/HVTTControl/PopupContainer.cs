...
{
	/// <summary>
	/// Use as a popup container for HVTTCONTROLS objects.
	/// </summary>
	...
	public class PopupContainer:Control
	{
		...
		private HVTTMarkStatus HostedBar
		{
			get
			{
				if(this.Controls.Count>0 && this.Controls[0] is HVTTMarkStatus)
					return this.Controls[0] as HVTTMarkStatus;
				return null;
			}
		}
