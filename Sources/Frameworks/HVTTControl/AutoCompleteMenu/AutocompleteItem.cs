...
namespace HVTT.UI.Window.Forms.HVTTAutoCompleteMenu
{
    ...
    public class AutocompleteItem
    {
        ...
        public List<MenuColumn> MenuColumns { get; set; }
        ...
        public AutocompleteItem(string text,List<MenuColumn>menuColumns) : this()
        {
            Text = text;
            MenuColumns = menuColumns;
        }
        public AutocompleteItem(string text, List<MenuColumn> menuColumns,String keyText) : this()
        {
            Text = text;
            MenuColumns = menuColumns;
            KeyText = keyText;
