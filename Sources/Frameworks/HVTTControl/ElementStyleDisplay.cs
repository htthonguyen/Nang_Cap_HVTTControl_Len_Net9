...
namespace HVTT.UI.Window.Forms
{
	...
	public class ElementStyleDisplay
	{
		...
		public static Region GetStyleRegion(ElementStyleDisplayInfo e)
		{
            ...
            if (e.Style.PaintBorder && e.Style.CornerType!=CornerType.Square)
            {
                rectPath.Width--;
                rectPath.Height--;
            }
            ...
            if (e.Style.PaintBorder && (e.Style.CornerType == CornerType.Rounded || e.Style.CornerType == CornerType.Diagonal || 
                e.Style.CornerTypeTopLeft == CornerType.Rounded || e.Style.CornerTypeTopLeft == CornerType.Diagonal ||
                e.Style.CornerTypeTopRight==CornerType.Rounded || e.Style.CornerTypeTopRight==CornerType.Diagonal ||
                e.Style.CornerTypeBottomLeft==CornerType.Rounded || e.Style.CornerTypeBottomLeft==CornerType.Diagonal ||
                e.Style.CornerTypeBottomRight==CornerType.Rounded || e.Style.CornerTypeBottomRight==CornerType.Diagonal))
            {
        ...
        public static GraphicsPath GetInsideClip(ElementStyleDisplayInfo e)
        {
            ...
            if (e.Style.PaintBorder)
            {
                if (e.Style.PaintTopBorder)
                {
                    ...
                    if (e.Style.BorderTop == StyleBorderType.Etched || e.Style.BorderTop == StyleBorderType.Double)
                    {
                        rectPath.Y += e.Style.BorderTopWidth;
                        rectPath.Height -= e.Style.BorderTopWidth;
                    }
                ...
                if (e.Style.PaintBottomBorder)
                {
                    ...
                    if (e.Style.BorderBottom == StyleBorderType.Etched || e.Style.BorderBottom == StyleBorderType.Double)
                        rectPath.Height -= e.Style.BorderBottomWidth;
                }
                ...
                if (e.Style.PaintLeftBorder)
                {
                    ...
                    if (e.Style.BorderLeft == StyleBorderType.Etched || e.Style.BorderLeft == StyleBorderType.Double)
                    {
                        rectPath.X += e.Style.BorderLeftWidth;
                        rectPath.Width -= e.Style.BorderLeftWidth;
                    }
                ...
                if (e.Style.PaintRightBorder)
                {
                    ...
                    if (e.Style.BorderRight == StyleBorderType.Etched || e.Style.BorderRight == StyleBorderType.Double)
                        rectPath.Width -= e.Style.BorderRightWidth;
                }
            }
		...
		private static CornerType GetCornerType(CornerType baseType, CornerType specificType)
		{
			if(specificType!=CornerType.Inherit)
				return specificType;
			return baseType;
		}
		...
		public static void PaintBorder(ElementStyleDisplayInfo e)
		{
            ...
            CornerType cornerTopLeft = GetCornerType(style.CornerType, style.CornerTypeTopLeft);
            CornerType cornerTopRight = GetCornerType(style.CornerType, style.CornerTypeTopRight);
            CornerType cornerBottomLeft = GetCornerType(style.CornerType, style.CornerTypeBottomLeft);
            CornerType cornerBottomRight = GetCornerType(style.CornerType, style.CornerTypeBottomRight);

            if (style.PaintBorder && style.Border == StyleBorderType.Solid && cornerTopLeft == CornerType.Rounded && cornerTopRight == CornerType.Rounded &&
                cornerBottomLeft == CornerType.Rounded && cornerBottomRight == CornerType.Rounded &&
                ...
                && style.BorderTopWidth == style.BorderWidth && style.BorderBottomWidth == style.BorderWidth)
            {
                ...
                DisplayHelp.DrawRoundGradientRectangle(e.Graphics, bounds, style.BorderColor, style.BorderColor2, style.BorderGradientAngle, style.BorderWidth, style.CornerDiameter);
                return;
            }
            else if (style.PaintAllBorders && style.Border == StyleBorderType.Solid && cornerTopLeft == CornerType.Square && cornerTopRight == CornerType.Square &&
                cornerBottomLeft == CornerType.Square && cornerBottomRight == CornerType.Square && style.BorderLeftWidth == style.BorderWidth && style.BorderRightWidth == style.BorderWidth
                && style.BorderTopWidth == style.BorderWidth && style.BorderBottomWidth == style.BorderWidth)
            {
                if (style.BorderWidth == 1)
                {
                ...
                DisplayHelp.DrawGradientRectangle(e.Graphics, bounds, style.BorderColor, style.BorderColor2, style.BorderGradientAngle, style.BorderWidth);
                return;
            }

            if (!style.BorderColor2.IsEmpty || !style.BorderColorLight.IsEmpty)
            {
                if (style.Border == StyleBorderType.Solid)
                {
                ...
                else if (style.Border == StyleBorderType.Etched)
                {
                    Rectangle r = bounds;
                ...
                else if ((style.BorderTop == StyleBorderType.Double && style.BorderLeft == StyleBorderType.Double &&
                    style.BorderRight == StyleBorderType.Double && style.BorderBottom == StyleBorderType.Double) ||
                   (style.BorderTop == StyleBorderType.None && style.BorderLeft == StyleBorderType.Double &&
                   style.BorderRight == StyleBorderType.Double && style.BorderBottom == StyleBorderType.Double))
                    {
                    Rectangle r = bounds;
                    Region oldClip = null;
			...
			if(style.PaintLeftBorder)
			{
				...
				if(cornerTopLeft!=CornerType.Square)
				{
					p[0].Y+=style.CornerDiameter;
				}
				if(cornerBottomLeft!=CornerType.Square)
				{
					p[1].Y-=style.CornerDiameter;
				}

                ElementStyleDisplay.DrawBorderLine(e.Graphics, p, style.BorderLeft, style.BorderLeftWidth, color, colorEnd, colorLightStart, colorLightEnd, BorderSide.Left);

				if(style.PaintTopBorder && cornerTopLeft!=CornerType.Square)
				{
					if(cornerTopLeft==CornerType.Diagonal)
					{
						p[0].X=bounds.X;
						p[0].Y=bounds.Y+style.CornerDiameter;
						p[1].X=bounds.X+style.CornerDiameter;
						p[1].Y=bounds.Y;
                        ElementStyleDisplay.DrawBorderLine(e.Graphics, p, style.BorderLeft, style.BorderLeftWidth, color, colorEnd, colorLightStart, colorLightEnd, BorderSide.TopLeft);
					}
					else if(cornerTopLeft==CornerType.Rounded)
					{
				...
				if(style.PaintBottomBorder && cornerBottomLeft!=CornerType.Square)
				{
					if(cornerBottomLeft==CornerType.Diagonal)
					{
						p[0].X=bounds.X;
						p[0].Y=bounds.Bottom-style.CornerDiameter;
						p[1].X=bounds.X+style.CornerDiameter;
						p[1].Y=bounds.Bottom;
                        ElementStyleDisplay.DrawBorderLine(e.Graphics, p, style.BorderLeft, style.BorderLeftWidth, color, colorEnd, colorLightStart, colorLightEnd, BorderSide.BottomLeft);
					}
					else if(cornerBottomLeft==CornerType.Rounded)
					{
			...
			if(style.PaintTopBorder)
			{
				...
				if(cornerTopRight!=CornerType.Square)
				{
					p[1].X-=style.CornerDiameter;
				}
                ElementStyleDisplay.DrawBorderLine(e.Graphics, p, style.BorderTop, style.BorderTopWidth, color, colorEnd, colorLightStart, colorLightEnd, BorderSide.Top);
			}
			...
			if(style.PaintBottomBorder)
			{
				...
				if(cornerBottomRight!=CornerType.Square)
				{
					p[1].X-=style.CornerDiameter;
				}

                ElementStyleDisplay.DrawBorderLine(e.Graphics, p, style.BorderBottom, style.BorderBottomWidth, color, colorEnd, colorLightStart, colorLightEnd, BorderSide.Bottom);
			}
			...
			if(style.PaintRightBorder)
			{
                ...
                ElementStyleDisplay.DrawBorderLine(e.Graphics, p, style.BorderRight, style.BorderRightWidth, color, colorEnd, colorLightStart, colorLightEnd, BorderSide.Right);

				if(style.PaintTopBorder && cornerTopRight!=CornerType.Square)
				{
					if(cornerTopRight==CornerType.Diagonal)
					{
						p[0].X=bounds.Right-style.CornerDiameter;
						p[0].Y=bounds.Y;
						p[1].X=bounds.Right;
						p[1].Y=bounds.Y+style.CornerDiameter;
                        ElementStyleDisplay.DrawBorderLine(e.Graphics, p, style.BorderLeft, style.BorderRightWidth, color, colorEnd, colorLightStart, colorLightEnd, BorderSide.TopRight);
					}
					else if(cornerTopRight==CornerType.Rounded)
					{
				...
				if(style.PaintBottomBorder && cornerBottomRight!=CornerType.Square)
				{
					if(cornerBottomRight==CornerType.Diagonal)
					{
						p[0].X=bounds.Right;
						p[0].Y=bounds.Bottom-style.CornerDiameter;
						p[1].X=bounds.Right-style.CornerDiameter;
						p[1].Y=bounds.Bottom;
						ElementStyleDisplay.DrawBorderLine(e.Graphics,p,style.BorderLeft,style.BorderRightWidth,color, colorEnd, colorLightStart, colorLightEnd,BorderSide.BottomRight);
					}
					else if(cornerBottomRight==CornerType.Rounded)
					{
		...
		private static Pen CreatePen(StyleBorderType border,int lineWidth, Color color)
		{
		...
		private static void DrawBorderLine(Graphics g,Point[] p,StyleBorderType border,int lineWidth, Color colorStart, Color colorEnd, Color colorLightStart, Color colorLightEnd, BorderSide side)
		{
            if (border == StyleBorderType.Etched || border == StyleBorderType.Double)
            {
                ...
                else if (side == BorderSide.Left || side == BorderSide.BottomLeft || side == BorderSide.TopLeft)
                {
                    p[0].X += lineWidth;
                    p[1].X += lineWidth;
                }
                else if (side == BorderSide.Right || side == BorderSide.BottomRight || side == BorderSide.TopRight)
                {
                    p[0].X -= lineWidth;
                    p[1].X -= lineWidth;
                }
		...
		private static void DrawCornerArc(Graphics g,ArcData arc,StyleBorderType border,int lineWidth, Color color)
		{
		...
		private static DashStyle GetDashStyle(StyleBorderType border)
		{
			DashStyle style=DashStyle.Solid;
			switch(border)
			{
				case StyleBorderType.Dash:
                    style=DashStyle.Dash;
					break;
				case StyleBorderType.DashDot:
					style=DashStyle.DashDot;
					break;
				case StyleBorderType.DashDotDot:
					style=DashStyle.DashDotDot;
					break;
				case StyleBorderType.Dot:
					style=DashStyle.Dot;
					break;
			}
			return style;
		...
		public static void PaintBackgroundImage(ElementStyleDisplayInfo e)
		{
            ...
            StyleBackgroundImage imagePosition = style.BackgroundImagePosition;
            bool transform = false;
            Image backgroundImage = style.BackgroundImage;

            if (e.RightToLeft)
            {
                if (imagePosition == StyleBackgroundImage.TopLeft)
                {
                    imagePosition = StyleBackgroundImage.TopRight;
                    transform = true;
                }
                else if (imagePosition == StyleBackgroundImage.TopRight)
                    imagePosition = StyleBackgroundImage.TopLeft;
                else if (imagePosition == StyleBackgroundImage.BottomLeft)
                    imagePosition = StyleBackgroundImage.BottomRight;
                else if (imagePosition == StyleBackgroundImage.BottomRight)
                    imagePosition = StyleBackgroundImage.BottomLeft;
            }
			...
			{
				case StyleBackgroundImage.Stretch:
				{
					if(imageAtt!=null)
				...
				case StyleBackgroundImage.Center:
				{
				...
				case StyleBackgroundImage.TopLeft:
				case StyleBackgroundImage.TopRight:
				case StyleBackgroundImage.BottomLeft:
				case StyleBackgroundImage.BottomRight:
				{
                    Rectangle destRect = new Rectangle(bounds.X, bounds.Y, backgroundImage.Width, backgroundImage.Height);
                    if (imagePosition == StyleBackgroundImage.TopRight)
				...
				case StyleBackgroundImage.Tile:
				{
					if(imageAtt!=null)
					{
		...
		public static GraphicsPath GetBackgroundPath(ElementStyle style, Rectangle bounds, eStyleBackgroundPathPart pathPart)
		{
            ...
            if (pathPart==eStyleBackgroundPathPart.Complete && style.CornerTypeBottomLeft == CornerType.Inherit && style.CornerTypeBottomRight == CornerType.Inherit &&
                style.CornerTypeTopLeft == CornerType.Inherit && style.CornerTypeTopRight == CornerType.Inherit)
            {
            ...
            else
            {
                ...
                CornerType corner = style.CornerTypeTopLeft;
                if (corner == CornerType.Inherit)
                    corner = style.CornerType;

            	if(pathPart==eStyleBackgroundPathPart.BottomHalf)
            		corner=CornerType.Square;
            		
                if (corner == CornerType.Rounded)
                {
                    ArcData ad = GetCornerArc(clientRectangle, style.CornerDiameter, eCornerArc.TopLeft);
                    path.AddArc(ad.X, ad.Y, ad.Width, ad.Height, ad.StartAngle, ad.SweepAngle);
                }
                else if (corner == CornerType.Diagonal)
                {
