    ...
    internal class TextDrawing
    {
        ...
        public static void DrawStringLegacy(Graphics g, string text, Font font, Color color, Rectangle bounds, eTextFormat format)
        {
            ...
            using(SolidBrush brush=new SolidBrush(color))
                g.DrawString(text,font,brush,bounds,GetStringFormat(format));
        }
        ...
        {
            return Size.Ceiling(g.MeasureString(text, font, proposedSize, GetStringFormat(format)));
        }

        public static Size MeasureStringLegacy(Graphics g, string text, Font font, Size proposedSize, eTextFormat format)
        {
            return g.MeasureString(text, font, proposedSize, GetStringFormat(format)).ToSize();
        }
        ...
        {
            StringFormat sf = new StringFormat(UseGenericDefault?StringFormat.GenericDefault:StringFormat.GenericTypographic);
