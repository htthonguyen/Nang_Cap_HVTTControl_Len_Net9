...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(true),System.Runtime.InteropServices.ComVisible(false),Designer(typeof(ExplorerBarDesigner))]
        ...
        ISupportInitialize, IBarDesignerServices, ICustomSerialization, IAccessibilitySupport
	{
		...
		public ExplorerBar()
		{
			...
			m_ColorScheme=new ColorScheme(HVTTControlStyle.Office2003);
...
//				EventMouseMove(this,e);
		...
		/// </summary>
		[System.ComponentModel.Editor(typeof(ColorSchemeVSEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Gets or sets Color Scheme."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		protected bool IsThemed
		{
			get
			{
				if(m_ThemeAware && (m_ItemContainer.Style==HVTTControlStyle.OfficeXP || m_ItemContainer.Style==HVTTControlStyle.Office2003) && BarFunctions.ThemedOS && Themes.ThemesActive)
					return true;
				return false;
			}
		}
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies whether ExplorerBar is drawn using Themes when running on OS that supports themes like Windows XP.")]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Style"), Description("Gets or sets bar background style."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Appearance"),Description("Specifies the vertical spacing between the group items."),DefaultValue(15)]
		...
		private void SyncGroupColors()
		{
            ...
            //ExplorerBarStockStyle thisSpecial=GetSpecialStyle(m_StockStyle);
			...
			foreach(BaseItem item in m_ItemContainer.SubItems)
			{
				...
				if(group==null)
					continue;
				if(group.StockStyle==ExplorerBarStockStyle.SystemColors)
				{
					group.StockStyle = ExplorerBarStockStyle.SystemColors;
				}
			}
		}
		private ExplorerBarStockStyle GetSpecialStyle(ExplorerBarStockStyle style)
		{
			ExplorerBarStockStyle special=ExplorerBarStockStyle.Custom;
			switch(style)
			{
				case ExplorerBarStockStyle.Blue:
                    special=ExplorerBarStockStyle.BlueSpecial;
					break;
		...
		private bool IsStyleSpecial(ExplorerBarStockStyle style)
		{
			if(style==ExplorerBarStockStyle.BlueSpecial || style==ExplorerBarStockStyle.OliveGreenSpecial || style==ExplorerBarStockStyle.SilverSpecial)
				return true;
			return false;
		}
		...
		/// </summary>
		[System.ComponentModel.Editor(typeof(ExplorerBarPanelsEditor), typeof(System.Drawing.Design.UITypeEditor)),DesignerSerializationVisibility(DesignerSerializationVisibility.Content),System.ComponentModel.Category("Data"),System.ComponentModel.Description("Returns the collection of Explorer Bar Groups.")]
...
//		}
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(100),Category("Behavior"),Description("Indicates maximum animation time in milliseconds, default value is 100.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),DefaultValue(ExplorerBarStockStyle.Custom),Description("Applies the stock style to the object.")/*,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)*/]
		public ExplorerBarStockStyle StockStyle
		{
			...
			set
			{
				...
				foreach(BaseItem item in m_ItemContainer.SubItems)
				{
					if(item is ExplorerBarGroupItem && ((ExplorerBarGroupItem)item).StockStyle != ExplorerBarStockStyle.Custom)
					{
...
//				this.ForeColor=BarFunctions.ColorFromString(xmlThisBar.GetAttribute("forecolor"));
	...
	{
		public ExplorerBarPanelsEditor(Type type):base(type)
		{
		}
