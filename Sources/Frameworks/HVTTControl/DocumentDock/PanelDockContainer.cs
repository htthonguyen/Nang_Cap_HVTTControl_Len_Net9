...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(false),Designer(typeof(Design.PanelDockContainerDesigner))]
	public class PanelDockContainer:HVTTPanel
	{
		...
		private eTabStripAlignment TabAlignment
		{
			get
			{
				...
				{
					if(m_DockContainerItem.ContainerControl is HVTTMarkStatus)
					{
						return ((HVTTMarkStatus)m_DockContainerItem.ContainerControl).DockTabAlignment;
					}
				}
		...
		private TabStrip GetDockTabStrip()
		{
			...
			if(m_DockContainerItem!=null && m_DockContainerItem.ContainerControl is HVTTMarkStatus)
			{
				HVTTMarkStatus bar=m_DockContainerItem.ContainerControl as HVTTMarkStatus;
