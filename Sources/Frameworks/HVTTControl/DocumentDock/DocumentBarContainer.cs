...
namespace HVTT.UI.Window.Forms
{
	...
	public class DocumentBarContainer:DocumentBaseContainer
	{
		...
		private HVTTMarkStatus m_Bar=null;
		...
		public DocumentBarContainer(HVTTMarkStatus bar)
		{
			m_Bar=bar;
		...
		public DocumentBarContainer(HVTTMarkStatus bar, int proposedWidth, int proposedHeight)
		{
			m_Bar=bar;
		...
		{
			get {return m_Bar.GetAdjustedFullSize(m_Bar.MinimumDockSize(HVTTOrientation.Horizontal));}
		}
		#endregion
	}
}
