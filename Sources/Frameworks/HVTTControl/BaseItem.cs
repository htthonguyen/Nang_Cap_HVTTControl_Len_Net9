...
{
    /// <summary>
    /// Defines the base class for items that are used by HVTTCONTROLS.
    /// </summary>
    [System.ComponentModel.ToolboxItem(false),System.ComponentModel.DesignTimeVisible(false)]
    public abstract class BaseItem : IDisposable, ICloneable, System.ComponentModel.IComponent, IBlock
	{
...
//		public event EventHandler DisplayedChanged;
		...
		protected HVTTControlStyle m_Style;
		...
		protected HVTTOrientation m_Orientation;
		protected bool m_SystemItem;
		protected HVTTSupportedOrientation m_SupportedOrientation=HVTTSupportedOrientation.Both;
		...
		private DesignInsertPosition m_DesignInsertMarker=DesignInsertPosition.None;
		...
		internal bool _IgnoreClick=false;
        ...
        internal Point DesignTimeMouseDownPoint = Point.Empty;
		...
		public BaseItem(string sItemName, string ItemText)
		{
			...
			m_Enabled=true;
			m_BeginGroup=false;
			m_Style=HVTTControlStyle.OfficeXP;
			m_Description="";
			m_Tooltip="";
			m_Name=sItemName;
			m_Category="";
			m_Orientation=HVTTOrientation.Horizontal;
			m_ToolTipWnd=null;
			m_Id=++s_IdCounter;
		...
		protected internal virtual void Serialize(ItemSerializationContext context)
		{
			...
			if(aname.Name!="HVTT.UI.Window.Forms")
		...
		protected internal virtual void Deserialize(ItemSerializationContext context)
		{
			...
			m_Style=(HVTTControlStyle)System.Xml.XmlConvert.ToInt32(ItemXmlSource.GetAttribute("style"));
...
//					oi=a.CreateInstance(xmlChild.GetAttribute("class")) as BaseItem;
        ...
        ///// <summary>
        ///// Design-time property that indicates whether typed CommandLink object on form is generated for the item. Typed CommandLink objects like
        ///// ButtonItemCommandLink are used to provide direct access to the command they are linked to. The link is established through CommandLink.Name property
        ///// which is matched to coresponding typed instance of BaseItem object. Command links apply only to items created with HVTTManager.
        ///// </summary>
        //[Browsable(false), HVTTBrowsable(true), DefaultValue(false), Category("Design"), Description(""), EditorBrowsable(EditorBrowsableState.Never), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        //public bool GenerateCommandLink
        //{
        //    get { return m_GenerateCommandLink; }
        //    set { m_GenerateCommandLink = value; }
        //}
        ...
        private object GetContainerControl(bool checkIsContainer)
        {
            if (m_Parent == null)
                return m_ContainerControl;
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Indicates whether is item enabled.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates whether this item is beginning of the group.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Determines whether the item is visible or hidden.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.DefaultValue(true),System.ComponentModel.Description("Indicates whether the item will auto-collapse (fold) when clicked.")]
        ...
        /// </summary>
        [Browsable(false), HVTTBrowsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), EditorBrowsable(EditorBrowsableState.Never)]
...
//				owner.InvokeItemDisplayedChanged(this,new EventArgs());
		...
		public virtual void InternalMouseEnter()
		{
			...
			if(!this.DesignMode)
			{
				...
				if(objContainer is HVTTMarkStatus && this.IsOnMenuBar)
				{
					HVTTMarkStatus.BarAccessibleObject acc=objContainer.AccessibilityObject as HVTTMarkStatus.BarAccessibleObject;
					if(acc!=null)
					{
		...
		public virtual void InternalMouseHover()
		{
			...
			if(m_HotSubItem!=null)
			{
				if(!m_AutoExpand)
				{
					...
					if(objItem!=null && m_HotSubItem!=objItem && (this.IsOnMenu || this.ContainerControl is HVTTMarkStatus || this.ContainerControl is RibbonBar))
		...
		public virtual void InternalKeyDown(System.Windows.Forms.KeyEventArgs objArg)
		{
			...
			if(objArg.KeyCode==System.Windows.Forms.Keys.Enter  || objArg.KeyCode==System.Windows.Forms.Keys.Return)
			{
				...
				{
					RaiseClick(EventSource.Keyboard);
					objArg.Handled=true;
        ...
        protected virtual void LeaveHotSubItem(BaseItem newMouseOverItem)
        {
            if (m_HotSubItem != null)
            {
                ...
                if (newMouseOverItem != null && m_HotSubItem.Expanded && (this.IsOnMenu || this.ContainerControl is HVTTMarkStatus))
		...
		public virtual void InternalMouseMove(System.Windows.Forms.MouseEventArgs objArg)
		{
			...
			if(m_IsContainer && !m_DesignMode)
			{
                        ...
                        if (objNew != this)
                        {
                            ...
                            if (m_AutoExpand && objNew.ShowSubItems && objNew.GetEnabled())
                            {
                                if (objNew is PopupItem)
                                {
                                    ...
                                    HVTTPopupAnimation oldAnim = pi.PopupAnimation;
                                    pi.PopupAnimation = HVTTPopupAnimation.None;
				...
				{
                    if (m_TextMarkup != null)
                        m_TextMarkup.MouseMove(this.ContainerControl as System.Windows.Forms.Control, objArg);
					if(MouseMove!=null)
						MouseMove(this,objArg);
					IOwnerItemEvents owner=this.GetIOwnerItemEvents();
					if(owner!=null && !this.SystemItem && !this.IsOnCustomizeMenu && !this.IsOnCustomizeDialog)
        ...
        public virtual void RaiseClick(EventSource source)
        {
            ...
            try
            {
                ...
                if (rootParent != null)
                {
                    HVTTMarkStatus bar = rootParent.ContainerControl as HVTTMarkStatus;
                    if (bar != null)
                        bar.InvokeItemClick(this, new EventArgs());
                }
		...
		/// </summary>
		/// <returns>HVTTManager that owns the item.</returns>
		public object GetOwner()
		{
			...
			if (objCtrl is HVTTMarkStatus)
                return ((HVTTMarkStatus)objCtrl).Owner;
		...
		{
			if(m_Expanded && (m_ComponentSite!=null && !m_ComponentSite.DesignMode || m_ComponentSite==null))
				this.Expanded=false;
			...
			if(m_ComponentSite==null || m_ComponentSite!=null && !m_ComponentSite.DesignMode)
			{
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Content)]
...
//		/// </summary>
//		[System.ComponentModel.Browsable(false), HVTTBrowsable(false),System.ComponentModel.Category("Data"),System.ComponentModel.DefaultValue(""),System.ComponentModel.TypeConverter(typeof(System.ComponentModel.StringConverter)),Obsolete("ItemData is being replaced by Tag property.")]
...
//		}
		...
		/// Allows the user to associate custom user data with the item.
		/// </summary>
		[System.ComponentModel.Browsable(true), HVTTBrowsable(true),System.ComponentModel.Category("Data"),System.ComponentModel.DefaultValue(""),System.ComponentModel.TypeConverter(typeof(System.ComponentModel.StringConverter)),System.ComponentModel.Localizable(true)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Hidden),System.ComponentModel.DefaultValue(HVTTControlStyle.OfficeXP),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Determines the display of the item when shown.")]
		public virtual HVTTControlStyle Style
		{
			get
			{
				return m_Style;
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(eItemAlignment.Near),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Determines alignment of the item inside the container.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(""),Category("Design"),Description("Indicates description of the item that is displayed during design."), Localizable(true)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates whether item will stretch to consume empty space. Items on stretchable, no-wrap Bars only.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(""),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates the text that is displayed when mouse hovers over the item."),System.ComponentModel.Localizable(true)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(""),Category("Design"),Description("Indicates item category used to group similar items at design-time."), Localizable(true)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Design"),System.ComponentModel.Description("Indicates the name used to identify item.")]
		public string Name
		{
			get
			{
        ...
        /// </summary>
        [Browsable(true), Category("Design"), Description("Indicates global name of the item that is used to synchorize the Global properties for the item across all instances with same global name."), DefaultValue("")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false)]
		public HVTTSupportedOrientation SupportedOrientation
		{
			get
			{
		...
		/// set visible property to the same value on all items with the same name.
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Indicates whether certain global properties are propagated to all items with the same name when changed.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
		public virtual HVTTOrientation Orientation
		{
			get
			{
        ...
        internal void SetOrientation(HVTTOrientation o)
        {
            if (m_Orientation != o)
            {
                m_Orientation = o;
		...
		public virtual void ShowToolTip()
		{
			...
			if(m_Visible && m_Displayed && !m_Expanded)
			{
				...
				if(this.ContainerControl is HVTTMarkStatus && !((HVTTMarkStatus)this.ContainerControl).ShowToolTips)
					return;

				if(this.ContainerControl is MenuPanel && !((MenuPanel)this.ContainerControl).ShowToolTips)
					return;
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The text contained in the item."),System.ComponentModel.Localizable(true),System.ComponentModel.DefaultValue("")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Indicates whether item can be customized by user.")]
		...
		public virtual bool IsOnMenuBar
		{
			...
			{
				System.Windows.Forms.Control ctrl=this.ContainerControl as System.Windows.Forms.Control;
				if(ctrl!=null && ctrl is HVTTMarkStatus)
					return ((HVTTMarkStatus)ctrl).MenuBar;
				return false;
			}
		}
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Design"),System.ComponentModel.Description("Indicates list of shortcut keys for this item."),System.ComponentModel.Editor(typeof(Design.ShortcutsDesigner),typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.TypeConverter(typeof(Design.ShortcutsConverter)),System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Content)]
		...
		public static void CollapseAll(BaseItem objItem)
		{
			...
			do
			{
				...
				else if(objCtrl is HVTTMarkStatus)
				{
					if(((HVTTMarkStatus)objCtrl).ParentInternal==null)
						break;
					objItem=((HVTTMarkStatus)objCtrl).ParentItem;
				}
		...
		public static bool IsOnPopup(BaseItem item)
		{
			...
			if(objCont is MenuPanel)
				return true;
            if(objCont is HVTTMarkStatus)
			{
				if(((HVTTMarkStatus)objCont).BarState==HVTTBarState.Popup)
					return true;
			}
			return false;
		}
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Gets or sets whether Click event will be auto repeated when mouse button is kept pressed over the item.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(600),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Gets or sets the auto-repeat interval for the click event when mouse button is kept pressed over the item.")]
		...
		internal DesignInsertPosition DesignInsertMarker
		{
		...
		private bool IsDesignMarkHorizontal
		{
			get
			{
                ...
                {
                    if (((ItemContainer)this.Parent).LayoutOrientation == HVTTOrientation.Horizontal)
                        return true;
                    else
                        return false;
                }

				if(m_Orientation==HVTTOrientation.Horizontal && !this.IsOnMenu && !(this.Parent is SideBarPanelItem) && !(this.Parent is ExplorerBarGroupItem))
					return true;
		...
		protected internal void DrawInsertMarker(System.Drawing.Graphics g)
		{
            ...
            if (m_DesignInsertMarker == DesignInsertPosition.None || !this.Visible || !this.Displayed || !(owner != null && owner.DragInProgress || this.DesignMode))
                return;
			...
			if(IsDesignMarkHorizontal)
			{
                ...
                if (m_DesignInsertMarker == DesignInsertPosition.After)
                {
			...
			else
			{
                ...
                //if(m_DesignInsertMarker==DesignInsertPosition.Before)
                //{
                //    p[0].X=m_Rect.Left+1;
                //    p[0].Y=m_Rect.Top;
                //    p[1].X=m_Rect.Left+1;
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(null),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies the mouse cursor displayed when mouse is over the item.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never),System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(false),Category("Appearance"),Description("Specifies whether item is drawn using Themes when running on OS that supports themes like Windows XP.")]
		...
		{
			return new ItemAccessibleObject(this);
		}

		/// <summary>
		/// Gets or sets the default action description of the control for use by accessibility client applications.
		/// </summary>
		[HVTTBrowsable(true),System.ComponentModel.Browsable(true),System.ComponentModel.Category("Accessibility"),System.ComponentModel.DefaultValue(""),System.ComponentModel.Description("Gets or sets the default action description of the control for use by accessibility client applications.")]
		...
		/// </summary>
		[HVTTBrowsable(true),System.ComponentModel.Browsable(true),System.ComponentModel.Category("Accessibility"),System.ComponentModel.DefaultValue(""),System.ComponentModel.Description("Gets or sets the description of the control used by accessibility client applications.")]
		...
		/// </summary>
		[HVTTBrowsable(true),System.ComponentModel.Browsable(true),System.ComponentModel.Category("Accessibility"),System.ComponentModel.Description("Gets or sets the name of the control used by accessibility client applications."),System.ComponentModel.DefaultValue("")]
		...
		/// </summary>
		[HVTTBrowsable(true),System.ComponentModel.Browsable(true),System.ComponentModel.Category("Accessibility"),System.ComponentModel.Description("Gets or sets the accessible role of the item."),System.ComponentModel.DefaultValue(System.Windows.Forms.AccessibleRole.Default)]
		...
		/// </summary>
		[HVTTBrowsable(false),System.ComponentModel.Browsable(false),System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
		...
		{
			if(this.ContainerControl is HVTTMarkStatus && ((HVTTMarkStatus)this.ContainerControl).m_AccessibleObjectCreated)
			{
				HVTTMarkStatus.BarAccessibleObject a=((HVTTMarkStatus)this.ContainerControl).AccessibilityObject as HVTTMarkStatus.BarAccessibleObject;
				if(a!=null)
