...
namespace HVTT.UI.Window.Forms.Editors
{
	...
	public class HVTTTreeGridView:HVTT.UI.Window.Forms.Controls.DataGridView
	{		
		private int _indentWidth;
        private HVTTTreeGridNode _root;
        ...
        protected override void OnKeyDown(KeyEventArgs e)
		{
			...
			if (!e.Handled)
			{
				if (e.KeyCode == System.Windows.Forms.Keys.F2 && this.CurrentCellAddress.X > -1 && this.CurrentCellAddress.Y >-1)
				{
                ...
                else if (e.KeyCode == System.Windows.Forms.Keys.F2 && !this.IsCurrentCellInEditMode)
				{
        ...
        public HVTTTreeGridNode GetNodeForRow(DataGridViewRow row)
        {
            return row as HVTTTreeGridNode;
        }

        [Description("Returns the TreeGridNode for the given DataGridViewRow")]
        public HVTTTreeGridNode GetNodeForRow(int index)
        {
        ...
        public new HVTTTreeGridNode CurrentRow
		{
			get
			{
                return base.CurrentRow as HVTTTreeGridNode;
			}
		}
        ...
        public HVTTTreeGridNode CurrentNode
		{
			get
			{
        ...
        public new int RowCount
        {
            ...
            set
            {
                for (int i = 0; i < value; i++)
                    this.Nodes.Add(new HVTTTreeGridNode());
        ...
        protected override void OnRowsAdded(DataGridViewRowsAddedEventArgs e)
        {
            ...
            HVTTTreeGridNode row;
            while (count >= 0)
            {
                row = base.Rows[e.RowIndex + count] as HVTTTreeGridNode;
                if (row != null)
                {
                    row.Sited();
                }
        ...
        internal protected virtual void UnSiteNode(HVTTTreeGridNode node)
		{
        ...
        internal protected virtual bool CollapseNode(HVTTTreeGridNode node)
		{
			if (node.IsExpanded)
			{
        ...
        internal protected virtual void SiteNode(HVTTTreeGridNode node)
		{
			//TODO: Raise exception if parent node is not the root or is not sited.
			int rowIndex = -1;
            HVTTTreeGridNode currentRow;
			node._grid = this;
			...
			if (currentRow != null)
			{
				while (currentRow.Level >= node.Level)
				{
					...
					{
                        currentRow = base.Rows[currentRow.RowIndex + 1] as HVTTTreeGridNode;
        ...
        internal protected virtual void SiteNode(HVTTTreeGridNode node, int index)
		{
        ...
        internal protected virtual bool ExpandNode(HVTTTreeGridNode node)
		{
