...
namespace HVTT.UI.Window.Forms.Editors
{
	...
	///HVTTTreeGridCell
	/// </summary>
	public class HVTTTreeGridCell:DataGridViewTextBoxCell
	{
        ...
        {
            HVTTTreeGridCell c = (HVTTTreeGridCell)base.Clone();
		...
		internal protected virtual void UpdateStyle(){
			...
			System.Windows.Forms.Padding p = this._previousPadding;
			Size preferredSize;
			...
			if (preferredSize.Height < _imageHeight)
			{
				...
				this.Style.Padding = new System.Windows.Forms.Padding(p.Left + (level * INDENT_WIDTH) + _imageWidth + INDENT_MARGIN,
		...
		public int Level
		{
			get
			{
                HVTTTreeGridNode row = this.OwningNode;
				if (row != null)
				{
					return row.Level;
				}
		...
		protected override void Paint(Graphics graphics, Rectangle clipBounds, Rectangle cellBounds, int rowIndex, DataGridViewElementStates cellState, object value, object formattedValue, string errorText, DataGridViewCellStyle cellStyle, DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
		{
            ...
            HVTTTreeGridNode node = this.OwningNode;
            if (node == null) return;
            ...
            if (node._grid.ShowLines)
            {
                using (Pen linePen = new Pen(SystemBrushes.ControlDark, 1.0f))
                {
                    ...
                    else
                    {
                        ...
                        HVTTTreeGridNode previousNode = node.Parent;
        ...
        public HVTTTreeGridNode OwningNode
		{
            get { return base.OwningRow as HVTTTreeGridNode; }
		}
	}
	...
	public class TreeGridColumn : DataGridViewTextBoxColumn
	{
		...
		{
            this.CellTemplate = new HVTTTreeGridCell();
		}
