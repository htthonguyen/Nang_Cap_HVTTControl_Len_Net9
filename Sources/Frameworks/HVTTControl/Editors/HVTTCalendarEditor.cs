...
{
    internal partial class HVTTCalendarEditor : UserControl
    {
        public HVTTCalendarEditor()
        {
            InitializeComponent();
        ...
        public event EventHandler ToDayClick;
        public event EventHandler ResetDate;
        ...
        {
            _miSelectDay = DateTime.Now.Day;
            _miSelectMonth = DateTime.Now.Month;
            _miSelectYear = DateTime.Now.Year;
        ...
        {
            _miSelectYear = d.Year;
            _miSelectMonth = d.Month;
            _miSelectDay = d.Day;
