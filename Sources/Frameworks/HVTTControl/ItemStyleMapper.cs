...
namespace HVTT.UI.Window.Forms
{
    ...
    public class ItemStyleMapper
    {
        ...
        public StringAlignment Alignment
        {
            ...
            set
            {
                TypeDescriptor.GetProperties(m_ElementStyle)["TextAlignment"].SetValue(m_ElementStyle,(StyleTextAlignment)value);
            }
        }
        ...
        public StringAlignment LineAlignment
        {
            ...
            set
            {
                TypeDescriptor.GetProperties(m_ElementStyle)["TextLineAlignment"].SetValue(m_ElementStyle,(StyleTextAlignment)value);
            }
        }
        ...
        public StringTrimming TextTrimming
        {
            ...
            set
            {
                TypeDescriptor.GetProperties(m_ElementStyle)["TextTrimming"].SetValue(m_ElementStyle,(StyleTextTrimming)value);
            }
        }
        ...
        {
            get { return (BackgroundImagePosition)m_ElementStyle.BackgroundImagePosition; }
            set
            {
                TypeDescriptor.GetProperties(m_ElementStyle)["BackgroundImagePosition"].SetValue(m_ElementStyle,(StyleBackgroundImage)value);
            }
        }
        ...
        public eBorderType Border
        {
            ...
            set
            {
                StyleBorderType b=StyleBorderType.None;
                if(value!=eBorderType.None)
                    b=StyleBorderType.Solid;
        ...
        {
            get { return BorderSide.None; }
            set
            {
                if((value & BorderSide.Left)==BorderSide.Left)
                    TypeDescriptor.GetProperties(m_ElementStyle)["BorderLeft"].SetValue(m_ElementStyle,StyleBorderType.Solid);
                else
                    TypeDescriptor.GetProperties(m_ElementStyle)["BorderLeft"].SetValue(m_ElementStyle,StyleBorderType.None);

                if((value & BorderSide.Right)==BorderSide.Right)
                    TypeDescriptor.GetProperties(m_ElementStyle)["BorderRight"].SetValue(m_ElementStyle,StyleBorderType.Solid);
                else
                    TypeDescriptor.GetProperties(m_ElementStyle)["BorderRight"].SetValue(m_ElementStyle,StyleBorderType.None);

                if((value & BorderSide.Top)==BorderSide.Top)
                    TypeDescriptor.GetProperties(m_ElementStyle)["BorderTop"].SetValue(m_ElementStyle,StyleBorderType.Solid);
                else
                    TypeDescriptor.GetProperties(m_ElementStyle)["BorderTop"].SetValue(m_ElementStyle,StyleBorderType.None);

                if((value & BorderSide.Bottom)==BorderSide.Bottom)
                    TypeDescriptor.GetProperties(m_ElementStyle)["BorderBottom"].SetValue(m_ElementStyle,StyleBorderType.Solid);
                else
                    TypeDescriptor.GetProperties(m_ElementStyle)["BorderBottom"].SetValue(m_ElementStyle,StyleBorderType.None);
