...
{
    /// <summary>
    /// Provides display capabilites for TabStrip with Office 2007 Document style.
    /// </summary>
    internal class TabStripOffice2007DocumentDisplay : TabStripBaseDisplay
    {
        ...
        protected override void AdjustCloseButtonRectangle(ref Rectangle close, bool closeOnLeftSide, bool vertical)
        {
            ...
            {
                if(!vertical)
                    close.X -= TabCloseButtonSpacing + close.Y / 5;
                else
                    close.Y -= TabCloseButtonSpacing + close.X / 5;
