...
namespace HVTT.UI.Window.Forms
{
        ...
        /// </summary>
        internal sealed class BarFunctions
        {
            ...
            /// <returns>New instance of a bar. Note that bar is not added to the HVTTManager.Bars collection and DockSide is not set.</returns>
            public static HVTTMarkStatus CreateDuplicateDockBar(HVTTMarkStatus instance)
            {
                // Create new Bar and invoke the drag there
                HVTTMarkStatus bar = new HVTTMarkStatus(instance.Text);
            ...
            /// <returns>New instance of a bar. Note that bar is not added to the HVTTManager.Bars collection and DockSide is not set.</returns>
            public static HVTTMarkStatus CreateDuplicateDockBar(HVTTMarkStatus instance, IDesignerServices services)
            {
                HVTTMarkStatus bar = services.CreateComponent(typeof(HVTTMarkStatus)) as HVTTMarkStatus;
                return CreateDuplicateDockBar(instance, bar);
            }

            private static HVTTMarkStatus CreateDuplicateDockBar(HVTTMarkStatus instance, HVTTMarkStatus bar)
            {
            ...
            public static void ApplyAutoDocumentBarStyle(HVTTMarkStatus bar)
            {
                ...
                if (bar.GrabHandleStyle != HVTTGrabHandleStyle.None)
                    bar.GrabHandleStyle = HVTTGrabHandleStyle.None;
            }

            public static void RestoreAutoDocumentBarStyle(HVTTMarkStatus bar)
            {
                bar.SetDockTabStyle(bar.Style);
                if (bar.AlwaysDisplayDockTab)
                ...
                if (bar.GrabHandleStyle != HVTTGrabHandleStyle.Caption)
            ...
            public static void DrawMenuCheckBox(ItemPaintArgs pa, System.Drawing.Rectangle r, HVTTControlStyle style, bool MouseOver)
            {
                System.Drawing.Graphics g = pa.Graphics;
                Color clr;
                if (style != HVTTControlStyle.Office2000)
                {
                    if (MouseOver)
                    {
                ...
                else if (style == HVTTControlStyle.Office2000)
                {
                    // Draw checked box
            ...
            internal static BaseItem CreateItemFromXml(System.Xml.XmlElement xmlItem)
            {
                ...
                switch (cl)
                {
                    case "HVTT.UI.Window.Forms.ButtonItem":
                        returnItem = new ButtonItem();
                        break;
                    case "HVTT.UI.Window.Forms.TextBoxItem":
                        returnItem = new TextBoxItem();
                        break;
                    case "HVTT.UI.Window.Forms.ComboBoxItem":
                        returnItem = new ComboBoxItem();
                        break;
                    case "HVTT.UI.Window.Forms.LabelItem":
                        returnItem = new LabelItem();
                        break;
                    case "HVTT.UI.Window.Forms.CustomizeItem":
                        returnItem = new CustomizeItem();
                        break;
                    case "HVTT.UI.Window.Forms.ControlContainerItem":
                        returnItem = new ControlContainerItem();
                        break;
                    case "HVTT.UI.Window.Forms.DockContainerItem":
                        returnItem = new DockContainerItem();
                        break;
                    case "HVTT.UI.Window.Forms.MdiWindowListItem":
                        returnItem = new MdiWindowListItem();
                        break;
                    case "HVTT.UI.Window.Forms.SideBarContainerItem":
                        returnItem = new SideBarContainerItem();
                        break;
                    case "HVTT.UI.Window.Forms.SideBarPanelItem":
                        returnItem = new SideBarPanelItem();
                        break;
                    case "HVTT.UI.Window.Forms.ExplorerBarGroupItem":
                        returnItem = new ExplorerBarGroupItem();
                        break;
                    case "HVTT.UI.Window.Forms.ExplorerBarContainerItem":
                        returnItem = new ExplorerBarContainerItem();
                        break;
                    case "HVTT.UI.Window.Forms.ProgressBarItem":
                        returnItem = new ProgressBarItem();
                        break;
                    case "HVTT.UI.Window.Forms.ColorPickerDropDown":
            ...
            internal static void SyncProperty(BaseItem item, string propertyName)
            {
                if (item.GlobalName.Length > 0)
                {
                    ...
                    SetPropertyByGlobalName(item.GetOwner(), item.GetType(), item.GlobalName, propDesc, propDesc.GetValue(item));
                }
                else if (item.Name.Length > 0)
                {
                    PropertyDescriptor propDesc = TypeDescriptor.GetProperties(item)[propertyName];
                    SetProperty(item.GetOwner(), item.GetType(), item.Name, propDesc, propDesc.GetValue(item));
                }
            }
            ...
            internal static void SetProperty(object owner, System.Type itemType, string itemName, System.ComponentModel.PropertyDescriptor prop, object value)
            {
                ...
                HVTTManager dnbmanager = owner as HVTTManager;
            ...
            internal static ResourceManager GetResourceManager(bool bDefault)
            {
                ...
                HVTTResourcesAttribute att = Attribute.GetCustomAttribute(System.Reflection.Assembly.GetExecutingAssembly(), typeof(HVTTResourcesAttribute)) as HVTTResourcesAttribute;
                if (att != null && att.NamespacePrefix != "")
                    defaultResource = att.NamespacePrefix + defaultResource;
                else
                    defaultResource = "HVTT.UI.Window.Forms" + defaultResource;
            ...
            {
                DrawBorder(g, bordertype, r, singleLineColor, BorderSide.Left | BorderSide.Right | BorderSide.Top | BorderSide.Bottom);
            }
            internal static void DrawBorder(Graphics g, eBorderType bordertype, Rectangle r, Color singleLineColor, BorderSide side)
            {
                DrawBorder(g, bordertype, r, singleLineColor, side, System.Drawing.Drawing2D.DashStyle.Solid);
            }
            internal static void DrawBorder(Graphics g, eBorderType bordertype, Rectangle r, Color singleLineColor, BorderSide side, System.Drawing.Drawing2D.DashStyle borderDashStyle)
            {
                DrawBorder(g, bordertype, r, singleLineColor, side, borderDashStyle, 1);
            }
            internal static void DrawBorder(Graphics g, eBorderType bordertype, Rectangle r, Color singleLineColor, BorderSide side, System.Drawing.Drawing2D.DashStyle borderDashStyle, int lineWidth)
            {
                System.Windows.Forms.Border3DSide border3dside;
                if (side == BorderSide.All)
                    border3dside = System.Windows.Forms.Border3DSide.All;
                else
                    border3dside = (((side | BorderSide.Left) != 0) ? System.Windows.Forms.Border3DSide.Left : 0) |
                    (((side | BorderSide.Right) != 0) ? System.Windows.Forms.Border3DSide.Right : 0) |
                    (((side | BorderSide.Top) != 0) ? System.Windows.Forms.Border3DSide.Top : 0) |
                    (((side | BorderSide.Bottom) != 0) ? System.Windows.Forms.Border3DSide.Bottom : 0);
            ...
            public static ScreenInformation ScreenFromPoint(Point pScreen)
            {
            ...
            public static ScreenInformation ScreenFromControl(System.Windows.Forms.Control control)
            {
                Rectangle r;
            ...
            public static void SetExplorerBarStyle(ExplorerBar bar, ExplorerBarStockStyle stockStyle)
            {
                if (stockStyle == ExplorerBarStockStyle.SystemColors)
                {
                    bar.BackStyle.Reset();
                ...
                else if (stockStyle != ExplorerBarStockStyle.Custom)
                {
                    ePredefinedColorScheme scheme = ePredefinedColorScheme.Blue2003;
                    if (stockStyle == ExplorerBarStockStyle.Silver || stockStyle == ExplorerBarStockStyle.SilverSpecial)
                        scheme = ePredefinedColorScheme.Silver2003;
                    else if (stockStyle == ExplorerBarStockStyle.OliveGreen || stockStyle == ExplorerBarStockStyle.OliveGreenSpecial)
                        scheme = ePredefinedColorScheme.OliveGreen2003;
                    ColorScheme cs = new ColorScheme(HVTTControlStyle.Office2003);
            ...
            public static void SetExplorerBarStyle(ExplorerBarGroupItem group, ExplorerBarStockStyle stockStyle)
            {
                if (stockStyle == ExplorerBarStockStyle.SystemColors)
                {
                    ExplorerBarStockStyle stock = ExplorerBarStockStyle.Blue;
                    ExplorerBarStockStyle special = ExplorerBarStockStyle.BlueSpecial;
                    ...
                    {
                        stock = ExplorerBarStockStyle.Silver;
                        special = ExplorerBarStockStyle.SilverSpecial;
                    }
                    ...
                    {
                        stock = ExplorerBarStockStyle.OliveGreen;
                        special = ExplorerBarStockStyle.OliveGreenSpecial;
                    }
                ...
                if (stockStyle != ExplorerBarStockStyle.Custom)
                {
                    group.TitleStyle.Reset();
                    group.TitleHotStyle.Reset();
                    group.BackStyle.Reset();

                    group.TitleStyle.CornerTypeTopLeft = CornerType.Rounded;
                    group.TitleStyle.CornerTypeTopRight = CornerType.Rounded;
                    group.TitleStyle.CornerDiameter = 3;
                    group.TitleHotStyle.CornerTypeTopLeft = CornerType.Rounded;
                    group.TitleHotStyle.CornerTypeTopRight = CornerType.Rounded;
                    group.TitleHotStyle.CornerDiameter = 3;
                }

                switch (stockStyle)
                {
                    case ExplorerBarStockStyle.Blue:
                        {
                            ...
                            group.BackStyle.BorderBottom = StyleBorderType.Solid;
                            group.BackStyle.BorderTop = StyleBorderType.None;
                            group.BackStyle.BorderLeft = StyleBorderType.Solid;
                            group.BackStyle.BorderRight = StyleBorderType.Solid;
                    ...
                    case ExplorerBarStockStyle.BlueSpecial:
                        {
                    ...
                    case ExplorerBarStockStyle.OliveGreen:
                        {
                    ...
                    case ExplorerBarStockStyle.OliveGreenSpecial:
                        {
                    ...
                    case ExplorerBarStockStyle.Silver:
                        {
                            group.TitleStyle.BackColor = Color.White;
                    ...
                    case ExplorerBarStockStyle.SilverSpecial:
                        {
            ...
            public static void SetExplorerBarStyle(ButtonItem item, ExplorerBarStockStyle stockStyle)
            {
                if (stockStyle == ExplorerBarStockStyle.SystemColors)
                {
                    ExplorerBarStockStyle stock = ExplorerBarStockStyle.Blue;
            ...
            internal static void PaintBackgroundImage(Graphics g, Rectangle targetRect, Image backgroundImage, StyleBackgroundImage backgroundImagePosition, int backgroundImageAlpha)
            {
                PaintBackgroundImage(g, targetRect, backgroundImage, (BackgroundImagePosition)backgroundImagePosition, backgroundImageAlpha);
            }

            internal static void PaintBackgroundImage(Graphics g, Rectangle targetRect, Image backgroundImage, BackgroundImagePosition backgroundImagePosition, int backgroundImageAlpha)
            {
                ...
                switch (backgroundImagePosition)
                {
                    ...
                    case BackgroundImagePosition.CenterLeft:
                    case BackgroundImagePosition.CenterRight:
                        {
                            Rectangle destRect = new Rectangle(r.X, r.Y, backgroundImage.Width, backgroundImage.Height);
                            if (r.Width > backgroundImage.Width && backgroundImagePosition == BackgroundImagePosition.CenterRight)
                    ...
                    case BackgroundImagePosition.BottomRight:
                        {
                            Rectangle destRect = new Rectangle(r.X, r.Y, backgroundImage.Width, backgroundImage.Height);
                            if (backgroundImagePosition == BackgroundImagePosition.TopRight)
                                destRect.X = r.Right - backgroundImage.Width;
                            else if (backgroundImagePosition == BackgroundImagePosition.BottomLeft)
                                destRect.Y = r.Bottom - backgroundImage.Height;
                            else if (backgroundImagePosition == BackgroundImagePosition.BottomRight)
                            {
                                destRect.Y = r.Bottom - backgroundImage.Height;
                                destRect.X = r.Right - backgroundImage.Width;
                            }
            ...
            internal static Bitmap LoadBitmap(string imageName)
            {
                ...
                if (att != null && att.NamespacePrefix != "")
                {
                    ...
                    return new Bitmap(typeof(HVTT.UI.Window.Forms.HVTTManager), imageName);
            }
            ...
            public static Graphics CreateGraphics(Control objCtrl)
            {
                if (objCtrl is ItemControl)
                    ...
                    return ((HVTTMarkStatus)objCtrl).CreateGraphics();
            ...
            public static bool IsOffice2007Style(HVTTControlStyle style)
            {
                return (style == HVTTControlStyle.Office2007);
            }

            public static bool IsHVTTStyle2008(HVTTControlStyle style)
            {
                return (style == HVTTControlStyle.HVTTStyle2008);
            }
        }
        ...
        internal class LocalizationManager : IDisposable
        {
            ...
            public string GetLocalizedString(string key)
            {
                try
                {
                    ...
                    string s = m_ResourceManager.GetString(key);
                    if (s == null)
                        s = "";
                    return s;
                }
