...
//			return false;
		...
		protected virtual Rectangle GetItemContainerRectangle()
		{
			...
			{
				if(m_BackgroundStyle.BorderSide==BorderSide.All)
					r.Inflate(-1,-1);
				else
				{
					if((m_BackgroundStyle.BorderSide & BorderSide.Left)!=0)
						r.X++;
					if((m_BackgroundStyle.BorderSide & BorderSide.Right)!=0)
						r.Width--;
					if((m_BackgroundStyle.BorderSide & BorderSide.Top)!=0)
						r.Y++;
					if((m_BackgroundStyle.BorderSide & BorderSide.Bottom)!=0)
						r.Height--;
				}
			}
