...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[System.ComponentModel.ToolboxItem(false),Designer(typeof(SideBarPanelItemDesigner))]
	public class SideBarPanelItem:ImageItem,IDesignTimeProvider
	{
		...
		private BarImageSize m_ItemImageSize=BarImageSize.Default;
		...
		private SideBarAppearance m_Appearance=SideBarAppearance.Traditional;
		...
		private SideBarLayoutType m_LayoutType=SideBarLayoutType.Default;
		...
		public override void RecalcSize()
		{
			...
			else
			{
				...
				if(m_Appearance==SideBarAppearance.Flat)
			...
			if(this.Expanded)
			{
				...
				if(m_LayoutType==SideBarLayoutType.MultiColumn && m_TopItemIndex>0)
				...
				if(m_SubItems!=null)
				{
					...
					do
					{
						...
						foreach(BaseItem item in m_SubItems)
						{
							...
							if(m_LayoutType==SideBarLayoutType.MultiColumn)
							{
								item.WidthInternal=itemWidth;
								item.RecalcSize();
						...
						if(m_LayoutType==SideBarLayoutType.MultiColumn && lineHeight>0)
						{
							iVisibleHeight+=lineHeight;
							iTop+=lineHeight;
						}
				...
				if(m_ControlHost!=null)
				{
					...
					if(m_Appearance==SideBarAppearance.Traditional)
		...
		public override void Paint(ItemPaintArgs pa)
		{
			...
			if(this.Expanded && m_SubItems!=null && m_ControlHost==null)
			{
				...
				for(int i=m_TopItemIndex;i<m_SubItems.Count;i++)
				{
					...
					if(!item.Displayed || !item.Visible)
						continue;
					if(item.BeginGroup && m_LayoutType==SideBarLayoutType.Default)
					{
			...
			if(m_ControlHost==null)
			{
				...
				if(m_TopItemIndex>0 && m_EnableScrollButtons)
				{
					...
					else if(m_Appearance==SideBarAppearance.Traditional || m_HeaderStyle==null)
					{
						m_ScrollButtonRect[0]=new Rectangle(r.Right-18,r.Top+4,16,16);
					...
					else
					{
						...
						ItemStyle style=m_HeaderStyle.Clone() as ItemStyle;
						style.BorderSide=BorderSide.All;
...
//			}
		...
		private void PaintThemeScrollState()
		{
			...
			try
			{
				...
				else if(container is HVTTMarkStatus)
					scroll=((HVTTMarkStatus)container).ThemeScrollBar;
				else
				{
					bDisposeTheme=true;
        ...
        internal eTextFormat GetStringFormat()
		{
            ...
            if (m_TextAlignment == StyleTextAlignment.Center)
                format |= eTextFormat.HorizontalCenter;
            else if (m_TextAlignment == StyleTextAlignment.Far)
        ...
        private StyleTextAlignment m_TextAlignment = StyleTextAlignment.Center;
        /// <summary>
        /// Specifies panel title text alignment. Default value is Center.
        /// </summary>
        [DevCoSerialize(), Browsable(true), Category("Appearance"), DefaultValue(StyleTextAlignment.Center), Description("Specifies alignment of the text.")]
        public StyleTextAlignment TextAlignment
        {
		...
		internal void ScrollButtonClick(bool up)
		{
			...
			else
			{
				...
				if(m_LayoutType==SideBarLayoutType.MultiColumn)
				{
					...
					while(m_TopItemIndex<this.SubItems.Count)
					{
						m_TopItemIndex++;
...
//				this.Expanded=true;
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(SideBarLayoutType.Default),Category("Appearance"),Description("Gets or sets the layout type for the items.")]
		public SideBarLayoutType LayoutType
		{
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The text contained in the item."),System.ComponentModel.Localizable(true)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),Description("Gets or sets group background style."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets the item header style. Applies only when SideBar.Appearance is set to Flat."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets the item header style when mouse is over the header. Applies only when SideBar.Appearance is set to Flat."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets the item header style when left mouse button is pressed on header. Applies only when SideBar.Appearance is set to Flat."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets the item header side style. Applies only when SideBar.Appearance is set to Flat."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets the item header side style when mouse is over the header. Applies only when SideBar.Appearance is set to Flat."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		internal SideBarAppearance Appearance
		{
        ...
        /// </summary>
        [System.ComponentModel.Browsable(true), HVTTBrowsable(true), System.ComponentModel.Category("Appearance"), System.ComponentModel.Description("Specifies that text font is bold when text is rendered."), System.ComponentModel.DefaultValue(false)]
...
//				ThisItem.SetAttribute("backcolor",BarFunctions.ColorToString(m_BackColor));
			...
			if(m_ItemImageSize!=BarImageSize.Default)
...
//				m_BackColor=SystemColors.Control;
			...
			if(ItemXmlSource.HasAttribute("itemimagesize"))
				m_ItemImageSize=(BarImageSize)System.Xml.XmlConvert.ToInt32(ItemXmlSource.GetAttribute("itemimagesize"));
			else
				m_ItemImageSize=BarImageSize.Default;
		...
		protected internal override void OnItemAdded(BaseItem item)
		{
			...
			if(item is ButtonItem)
			{
				...
				//((ButtonItem)item).PopupSide=PopupSide.Left;
			}
		}
		...
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(eItemAlignment.Near),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Determines alignment of the item inside the container.")]
		public override eItemAlignment ItemAlignment
		{
			get{return base.ItemAlignment;}
			set{base.ItemAlignment=value;}
		}
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates whether item will stretch to consume empty space. Items on stretchable, no-wrap Bars only.")]
		public override bool Stretch
		{
			get {return base.Stretch;}
			set {base.Stretch=value;}
		}
//		[System.ComponentModel.Browsable(false),System.ComponentModel.DefaultValue(HVTTControlStyle.OfficeXP),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Determines the display of the item when shown.")]
//		public override HVTTControlStyle Style
//		{
//			get {return base.Style;}
//			set {base.Style=value;}
//		}
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.Category("Behavior"),System.ComponentModel.DefaultValue(true),System.ComponentModel.Description("Indicates whether the item will auto-collapse (fold) when clicked.")]
		public override bool AutoCollapseOnClick
		{
			get {return base.AutoCollapseOnClick;}
			set {base.AutoCollapseOnClick=value;}
		}
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Determines whether sub-items are displayed.")]
		public override bool ShowSubItems
		{
			get {return base.ShowSubItems;}
			set {base.ShowSubItems=value;}
		}
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(""),System.ComponentModel.Category("Design"),System.ComponentModel.Description("Indicates item category used to group similar items at design-time.")]
		public override string Category
		{
			get {return base.Category;}
			set {base.Category=value;}
		}
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(""),System.ComponentModel.Category("Design"),System.ComponentModel.Description("Indicates description of the item that is displayed during design.")]
		public override string Description
		{
			get {return base.Description;}
			set {base.Description=value;}
		}
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates whether this item is beginning of the group.")]
		...
		[System.ComponentModel.Browsable(true),HVTTBrowsable(false),System.ComponentModel.Editor(typeof(SideBarPanelItemEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.Category("Data"),System.ComponentModel.Description("Collection of sub items."),System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(BarImageSize.Default),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Specifies the Image size that will be used by items on this bar.")]
		public BarImageSize ItemImageSize
		{
			get
			{
...
//					return;
				...
				ImagePosition pos=ImagePosition.Left;
				if(m_ItemImageSize!=BarImageSize.Default)
					pos=ImagePosition.Top;
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(false),Description("Indicates a value that determines whether text is displayed in multiple lines or one long line."),Category("Layout")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Specifies whether scroll buttons are displayed when content of the panel exceeds it's height.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies the Button icon. Icons support multiple image sizes and alpha blending."),System.ComponentModel.DefaultValue(null)]
        ...
        /// </summary>
        [System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The image that will be displayed on the face of the item."),System.ComponentModel.DefaultValue(null)]
        ...
        /// </summary>
        [System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The image that will be displayed when mouse hovers over the item."),System.ComponentModel.DefaultValue(null)]
        ...
        /// </summary>
        [System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The image that will be displayed when item is pressed."),System.ComponentModel.DefaultValue(null)]
...
//		}
		...
		void IDesignTimeProvider.DrawReversibleMarker(int iPos, bool Before)
		{
			...
			if(objItem!=null)
			{
				if(objItem.DesignInsertMarker!=DesignInsertPosition.None)
					objItem.DesignInsertMarker=DesignInsertPosition.None;
				else if(Before)
					objItem.DesignInsertMarker=DesignInsertPosition.Before;
				else
					objItem.DesignInsertMarker=DesignInsertPosition.After;
				return;
			}
			else
			{
		...
		void IDesignTimeProvider.InsertItemAt(BaseItem objItem, int iPos, bool Before)
		{
			...
			if(this.ContainerControl is HVTTMarkStatus)
				((HVTTMarkStatus)this.ContainerControl).RecalcLayout();
