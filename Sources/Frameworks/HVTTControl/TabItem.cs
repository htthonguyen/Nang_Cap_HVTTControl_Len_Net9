...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
    [ToolboxItem(false), ComVisible(false), DesignTimeVisible(false), Designer(typeof(Design.TabItemDesigner))]
	public class TabItem : Component, IBlock, ISimpleTab
	{
		...
		private BaseItem m_HVTTCONTROLSItem=null;
		...
		private TabItemColor m_PredefinedColor=TabItemColor.Default;
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(-1),Category("Appearance"),Description("Indicates the tab image index"),Editor(typeof(ImageIndexEditor), typeof(UITypeEditor)),TypeConverter(typeof(ImageIndexConverter))]
        ...
        /// </summary>
        [Browsable(true),HVTTBrowsable(true),DefaultValue(null),Category("Appearance"),Description("Indicates the tab image.")]
		public Image Image
		{
			get {return m_Image;}
			set
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(null),Category("Appearance"),Description("Indicates the tab icon. Icon has same functionality as Image except that it support Alpha blending.")]
		public Icon Icon
		{
			get {return m_Icon;}
			set
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Appearance"),Description("Indicates the text displayed on the tab."),Localizable(true)]
		public string Text
		{
			get {return m_Text;}
			set
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(true),Category("Behavior"),Description("Indicates whether the tab is visible.")]
		public bool Visible
		{
		...
		{
			get {return m_HVTTCONTROLSItem;}
			set {m_HVTTCONTROLSItem=value;}
		}
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(null),Category("Behavior"),Description("Indicates the control that is attached to this tab.")]
		public Control AttachedControl
		{
			...
			set
			{
				...
				{
                    if (m_Parent != null && !m_Parent.MdiTabbedDocuments && BarFunctions.IsHandleValid(m_Parent))
					{
		...
		[Browsable(false),HVTTBrowsable(true),DefaultValue(null)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Design"),Description("Indicates the name used to identify item.")]
		public string Name
		{
			get
			{
		...
		/// </summary>
		[Browsable(true), DefaultValue(TabItemColor.Default),Category("Style"),Description("Applies predefined color to tab.")]
		public TabItemColor PredefinedColor
		{
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(""),Category("Appearance"),Description("Indicates the text that is displayed when mouse hovers over the tab."),Localizable(true)]
