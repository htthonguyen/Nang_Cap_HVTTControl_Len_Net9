...
namespace HVTT.UI.Window.Forms
{
	...
	public class ColorSchemeEditor : System.Windows.Forms.Form
	{
		...
		private HVTTMarkStatus m_SimpleBar=null;
		private HVTTMarkStatus m_FloatBar=null;
		private System.Windows.Forms.Button button3;
		private HVTTMarkStatus m_PopupBar=null;
		...
		private void AddHVTTCONTROLSControls()
		{
			if(m_Menu!=null)
			{
				m_Menu.RecalcSize();
			...
			item2.ButtonStyle=HVTTButtonStyle.ImageAndText;
			...
			//m_SimpleBar.SetBarState(HVTTBarState.Docked);
			m_SimpleBar.Size=new Size(groupBox1.ClientRectangle.Width,16);
			m_SimpleBar.GrabHandleStyle=HVTTGrabHandleStyle.StripeFlat;
			groupBox1.Controls.Add(m_SimpleBar);
			m_SimpleBar.RecalcSize();
			m_SimpleBar.Show();

			m_FloatBar.SetBarState(HVTTBarState.Floating);
			m_FloatBar.Size=new Size(groupBox1.ClientRectangle.Width,16);
		...
		private void InitializeComponent()
		{
            ...
            this.openFileDialog1.Filter = "HVTTCONTROLS Color Scheme files|*.dcs|All files|*.*";
            this.openFileDialog1.Title = "Open HVTTCONTROLS Color Scheme File";
			// 
			// saveFileDialog1
			// 
			this.saveFileDialog1.DefaultExt = "dcs";
			this.saveFileDialog1.FileName = "colorscheme1";
            this.saveFileDialog1.Filter = "HVTTCONTROLS Color Scheme files|*.dcs|All files|*.*";
            this.saveFileDialog1.Title = "Save HVTTCONTROLS Color Scheme File";
			// 
			// ColorSchemeEditor
			// 
		...
		private void btnSaveScheme_Click(object sender, System.EventArgs e)
		{
			if(saveFileDialog1.ShowDialog()==DialogResult.OK)
			{
                ...
                MessageBox.Show("Color Scheme has been saved.", "HVTTCONTROLS Color Scheme Editor", MessageBoxButtons.OK, MessageBoxIcon.Information);
			}
		}
		...
		private void btnLoadScheme_Click(object sender, System.EventArgs e)
		{
			...
			{
				HVTT.UI.Window.Forms.ColorScheme scheme=new ColorScheme();
				XmlDocument doc=new XmlDocument();
