...
namespace HVTT.UI.Window.Forms
{
    ...
    /// </summary>
    [ToolboxItem(true), Designer(typeof(Design.ContextMenuBarDesigner)), ProvideProperty("ContextMenuEx", typeof(Control)), System.Runtime.InteropServices.ComVisible(false), DefaultEvent("ItemClick")]
    public class ContextMenuBar : HVTTMarkStatus, System.ComponentModel.IExtenderProvider
    {
        ...
        /// </summary>
        [HVTTBrowsable(false), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
