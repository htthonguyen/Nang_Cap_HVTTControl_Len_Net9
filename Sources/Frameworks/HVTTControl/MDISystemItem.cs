...
namespace HVTT.UI.Window.Forms
{
	...
	public class MDISystemItem:PopupItem
	{
		...
		private void PaintButton(ItemPaintArgs pa, SystemButton btn, Rectangle r)
		{
            ...
            using (Bitmap bmp = GetButtonBitmap(g, btn, r))
            {
        ...
        internal Bitmap GetButtonBitmap(Graphics g, SystemButton btn, Rectangle r)
        {
		...
		private void CreateSystemMenu()
		{
			using(LocalizationManager lm=new LocalizationManager(this.GetOwner() as IOwnerLocalize))
			{
				...
				ButtonItem btn=new ButtonItem("HVTTCONTROLSsysmenurestore");
				...
				btn=new ButtonItem("HVTTCONTROLSsysmenuminimize");
				...
				btn=new ButtonItem("HVTTCONTROLSsysmenuclose");
				...
				btn=new ButtonItem("HVTTCONTROLSsysmenunext");
		...
		private void MenuClick(object sender, System.EventArgs e)
		{
			...
			if(objItem==null)
				return;
			m_LastButtonClick=SystemButton.None;
			if(objItem.Name=="HVTTCONTROLSsysmenurestore")
				m_LastButtonClick=SystemButton.Restore;
			else if(objItem.Name=="HVTTCONTROLSsysmenuminimize")
				m_LastButtonClick=SystemButton.Minimize;
			else if(objItem.Name=="HVTTCONTROLSsysmenuclose")
				m_LastButtonClick=SystemButton.Close;
			else if(objItem.Name=="HVTTCONTROLSsysmenunext")
