...
namespace HVTT.UI.Window.Forms
{
    ...
    public class SystemCaptionItem : MDISystemItem
    {
        ...
        {
            Size s = System.Windows.Forms.SystemInformation.CaptionButtonSize;
        ...
        public override void Refresh()
        {
            ...
            if (c != null && IsHandleValid(c))
            {
                ...
                NativeFunctions.RECT r = new NativeFunctions.RECT(0, 0, c.Width, SystemInformation.Border3DSize.Height + SystemInformation.CaptionHeight);
