...
namespace HVTT.UI.Window.Forms
{
    ...
    public class Office2007Form : Office2007RibbonForm
    {
        ...
        { 
            ...
            m_Caption.Style = HVTTControlStyle.Office2007;
        ...
        {
            return base.IsCustomFormStyleEnabled() && (!WinApi.IsGlassEnabled || this.IsMdiChild);
        }
        ...
        private Point GetMousePosition()
        {
            ...
            p.X += m_BorderWidth;
            p.Y += m_BorderWidth + m_Caption.HeightInternal; // SystemInformation.CaptionHeight;
        ...
        private void RecalcSize()
        {
            try
            {
                if (m_Caption != null)
                {
                    ...
                    m_Caption.HeightInternal = nci.CaptionTotalHeight;
                    m_Caption.IsRightToLeft = (this.RightToLeft == RightToLeft.Yes);
                    if (m_TitleLabel != null)
                    {
                        m_TitleLabel.Height = m_Caption.HeightInternal - nci.BottomBorder;
                    ...
                    if (m_SystemIcon != null)
                        m_SystemIcon.TopInternal += (m_Caption.HeightInternal - m_SystemIcon.HeightInternal - nci.BottomBorder) / 2;

                    //if (m_SystemButtons != null)
                    //    m_SystemButtons.TopInternal = nci.BottomBorder;
                }
        ...
        protected override void OnTextChanged(EventArgs e)
        {
            ...
            if(m_TitleLabel!=null) m_TitleLabel.Text = this.Text;
        ...
        protected virtual void PaintNonClientArea(Graphics g)
        {
            ...
            GraphicsPath path = GetFormPath(r);
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Office2007Form));
            this.SuspendLayout();
            // 
            // Office2007Form
            // 
