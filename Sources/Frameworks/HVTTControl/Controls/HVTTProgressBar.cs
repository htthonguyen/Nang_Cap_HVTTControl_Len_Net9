...
namespace HVTT.UI.Window.Forms.Controls
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(HVTTProgressBar), "Controls.ProgressBarX.ico"), ToolboxItem(true), DefaultEvent("Click"), System.Runtime.InteropServices.ComVisible(false)]
    public class HVTTProgressBar : BaseItemControl
    {
        ...
        public HVTTProgressBar()
        {
            m_ProgressBar = new ProgressBarItem();
            m_ProgressBar.Style = HVTTControlStyle.Office2007;
        ...
        protected override void PaintBackground(PaintEventArgs e)
        {
            ...
            if (!style.Custom  && !this.BackColor.IsEmpty && this.BackColor!=Color.Transparent)
            {
