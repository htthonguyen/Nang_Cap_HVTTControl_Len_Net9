...
namespace HVTT.UI.Window.Forms.Controls.HVTTSyntax
{
    ...
    public class AutocompleteMenu : ToolStripDropDown, IDisposable
    {
        ...
        public AutocompleteMenu(HVTTSyntaxTextBox tb)
        {
    ...
    public class AutocompleteListView : UserControl
    {
        ...
        int oldItemCount = 0;
        HVTTSyntaxTextBox tb;
        internal System.Windows.Forms.ToolTip toolTip = new System.Windows.Forms.ToolTip();
        ...
        internal AutocompleteListView(HVTTSyntaxTextBox tb)
        {
    ...
    {
        public AutocompleteItem Item { get; internal set; }
        public HVTTSyntaxTextBox Tb { get; set; }
    }
}
