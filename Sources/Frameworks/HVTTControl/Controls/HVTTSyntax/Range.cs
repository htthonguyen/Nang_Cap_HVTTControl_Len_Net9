...
namespace HVTT.UI.Window.Forms.Controls.HVTTSyntax
{
    ...
    public class Range : IEnumerable<Place>
    {
        Place start;
        Place end;
        public readonly HVTTSyntaxTextBox tb;
        int preferedPos = -1;
        int updating = 0;
        ...
        /// Constructor
        /// </summary>
        public Range(HVTTSyntaxTextBox tb)
        {
            this.tb = tb;
        }
        ...
        /// Constructor
        /// </summary>
        public Range(HVTTSyntaxTextBox tb, int iStartChar, int iStartLine, int iEndChar, int iEndLine)
            : this(tb)
        {
        ...
        /// Constructor
        /// </summary>
        public Range(HVTTSyntaxTextBox tb, Place start, Place end)
            : this(tb)
        {
            this.start = start;
            this.end = end;
        ...
        /// </summary>
        public Range(HVTTSyntaxTextBox tb, int iLine)
            : this(tb)
        {
        ...
        /// HVTTSyntaxTextBox.Selection range. So, if you want to set text, you need to use HVTTSyntaxTextBox.Selection
        /// and HVTTSyntaxTextBox.InsertText() mehtod.
        /// </remarks>
