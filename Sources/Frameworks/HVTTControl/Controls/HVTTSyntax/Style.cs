...
namespace HVTT.UI.Window.Forms.Controls.HVTTSyntax
{
    ...
    public abstract class Style : IDisposable
    {
        ...
        /// Occurs when user click on StyleVisualMarker joined to this style 
        /// </summary>
        public virtual void OnVisualMarkerClick(HVTTSyntaxTextBox tb, VisualMarkerEventArgs args)
        {
        ...
        /// </summary>
        protected virtual void AddVisualMarker(HVTTSyntaxTextBox tb, StyleVisualMarker marker)
        {
        ...
        public override void Draw(Graphics gr, Point position, Range range)
        {
            ...
            using(var f = new Font(range.tb.Font, FontStyle))
            {
                ...
                if (range.tb.ImeAllowed)
                {
                    ...
                    {
                        SizeF size = HVTTSyntaxTextBox.GetCharSize(f, line[i].c);
