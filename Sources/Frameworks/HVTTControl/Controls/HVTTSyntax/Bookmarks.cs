...
namespace HVTT.UI.Window.Forms.Controls.HVTTSyntax
{
    ...
    {
        protected HVTTSyntaxTextBox tb;
        protected List<Bookmark> items = new List<Bookmark>();
        protected int counter;

        public Bookmarks(HVTTSyntaxTextBox tb)
        {
            this.tb = tb;
    ...
    /// <summary>
    /// Bookmark of HVTTSyntaxTextBox
    /// </summary>
    public class Bookmark
    {
        public HVTTSyntaxTextBox TB { get; private set; }
        /// <summary>
        /// Name of bookmark
        /// </summary>
        ...
        public Bookmark(HVTTSyntaxTextBox tb, string name, int lineIndex)
        {
            this.TB = tb;
            this.Name = name;
