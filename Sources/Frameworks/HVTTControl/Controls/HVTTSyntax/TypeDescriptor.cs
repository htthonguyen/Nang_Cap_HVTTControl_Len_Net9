...
{
    ///
    /// These classes are required for correct data binding to Text property of HVTTSyntaxTextBox
    /// 
    ...
    class FooTextChangedDescriptor : EventDescriptor
    {
        ...
        {
            (component as HVTTSyntaxTextBox).BindingTextChanged += value as EventHandler;
        }

        public override Type ComponentType
        {
            get { return typeof(HVTTSyntaxTextBox); }
        }
