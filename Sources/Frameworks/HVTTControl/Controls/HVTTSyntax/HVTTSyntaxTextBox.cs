...
namespace HVTT.UI.Window.Forms.Controls.HVTTSyntax
{
    ...
    /// HVTTSyntaxTextBox
    /// </summary>
    public partial class HVTTSyntaxTextBox : UserControl, ISupportInitialize
    {
        ...
        private HVTTSyntaxTextBox sourceTextBox;
        ...
        /// </summary>
        [Description("Here you can change hotkeys for HVTTSyntaxTextBox.")]
        ...
        /// Allows to get text from other HVTTSyntaxTextBox.
        /// </summary>
        [Browsable(true)]
        [DefaultValue(null)]
        [Description("Allows to get text from other HVTTSyntaxTextBox.")]
        //[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public HVTTSyntaxTextBox SourceTextBox
        {
            ...
            set
            {
                if (scrollBars)
                {
                    if (!base.AutoScroll)
                        base.AutoScroll = true;
                    Size newSize = value;
                    if (WordWrap && WordWrapMode != HVTT.UI.Window.Forms.Controls.HVTTSyntax.WordWrapMode.Custom)
                    {
