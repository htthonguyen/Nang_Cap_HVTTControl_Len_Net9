...
using HVTT.UI.Window.Forms.ScrollBar;
...
namespace HVTT.UI.Window.Forms.Controls
{
    internal class NonClientPaintHandler : ISkinHook
    {
        ...
        private void CreateScrollbars()
        {
            ...
            m_HScrollBar.Orientation = HVTTOrientation.Horizontal;
        ...
        protected virtual bool WindowsMessageNCCalcSize(ref Message m)
        {
            ...
            else
            {
                ...
                if (m.WParam == IntPtr.Zero)
                {
                    ...
                    // Store the client rectangle in Window coordinates non-client coordinates
                    m_ClientRectangle = r.ToRectangle();
        ...
        internal int GetLeftBorderWidth(ElementStyle style)
        {
            if (style.PaintLeftBorder)
            {
                ...
                if (style.CornerTypeTopLeft == CornerType.Rounded || style.CornerTypeTopLeft == CornerType.Diagonal
                    || style.CornerTypeBottomLeft == CornerType.Rounded || style.CornerTypeBottomLeft == CornerType.Diagonal ||
                    (style.CornerType == CornerType.Rounded || style.CornerType == CornerType.Diagonal) &&
                    (style.CornerTypeTopLeft == CornerType.Inherit || style.CornerTypeBottomLeft == CornerType.Inherit))
        ...
        internal int GetTopBorderWidth(ElementStyle style)
        {
            if (style.PaintTopBorder)
            {
                ...
                if (style.CornerTypeTopLeft == CornerType.Rounded || style.CornerTypeTopLeft == CornerType.Diagonal
                    || style.CornerTypeTopRight == CornerType.Rounded || style.CornerTypeTopRight == CornerType.Diagonal ||
                    (style.CornerType == CornerType.Rounded || style.CornerType == CornerType.Diagonal) &&
        ...
        internal int GetRightBorderWidth(ElementStyle style)
        {
            if (style.PaintRightBorder)
            {
                ...
                if (style.CornerTypeTopRight == CornerType.Rounded || style.CornerTypeBottomRight == CornerType.Rounded
                    || style.CornerTypeTopRight == CornerType.Diagonal || style.CornerTypeBottomRight == CornerType.Diagonal ||
                    (style.CornerType == CornerType.Rounded || style.CornerType == CornerType.Diagonal) &&
                    (style.CornerTypeTopRight == CornerType.Inherit || style.CornerTypeBottomRight == CornerType.Inherit))
                    w = Math.Max(w, style.CornerDiameter / 2 + 1);
                return w;
            }
            return 0;
        ...
        internal int GetBottomBorderWidth(ElementStyle style)
        {
            if (style.PaintBottomBorder)
            {
                ...
                if (style.CornerTypeBottomLeft == CornerType.Rounded || style.CornerTypeBottomRight == CornerType.Rounded ||
                    style.CornerTypeBottomLeft == CornerType.Diagonal || style.CornerTypeBottomRight == CornerType.Diagonal ||
                    (style.CornerType == CornerType.Rounded || style.CornerType == CornerType.Diagonal) &&
                    (style.CornerTypeBottomLeft == CornerType.Inherit || style.CornerTypeBottomRight == CornerType.Inherit))
                    w = Math.Max(w, style.CornerDiameter / 2 + 1);
                return w;
            }
            return 0;
        ...
        private Rectangle GetClientRectangleForBorderStyle(Rectangle rect, ElementStyle style)
        {
            ...
            if (m_Control is TextBox && ((TextBox)m_Control).Multiline && ((TextBox)m_Control).ScrollBars != ScrollBars.None) return rect;

            rect.X += style.PaddingLeft;
            rect.Width -= style.PaddingLeft + style.PaddingRight;
            rect.Y += style.PaddingTop;
            rect.Height -= style.PaddingTop + style.PaddingBottom;
        ...
        private void PaintBorder(Graphics g)
        {
            ...
            else
            {
                ...
                {
                    if (m_Control.BackColor == Color.Transparent || style.PaintBorder && (style.CornerType == CornerType.Rounded || style.CornerType == CornerType.Diagonal ||
                        style.CornerTypeBottomLeft == CornerType.Rounded || style.CornerTypeBottomLeft == CornerType.Diagonal ||
                        style.CornerTypeBottomRight == CornerType.Rounded || style.CornerTypeBottomRight == CornerType.Diagonal ||
                        style.CornerTypeTopLeft == CornerType.Rounded || style.CornerTypeTopLeft == CornerType.Diagonal ||
                        style.CornerTypeTopRight == CornerType.Rounded || style.CornerTypeTopRight == CornerType.Diagonal))
                    {
    ...
    internal interface INonClientControl
    {
        /// <summary>
