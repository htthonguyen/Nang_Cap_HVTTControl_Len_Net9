...
namespace HVTT.UI.Window.Forms.Controls.Calendar
{
    ...
    public class MonthViewBoxEventArgs
    {
        ...
        private Font _font;
        private System.Windows.Forms.TextFormatFlags _TextFlags;
        #endregion
        ...
        internal MonthViewBoxEventArgs(Graphics g, Rectangle bounds, string text, StringAlignment textAlign, Color textColor, Color backColor, Color borderColor)
        {
            ...
            switch (textAlign)
            {
                ...
                case StringAlignment.Far:
                    TextFlags |= System.Windows.Forms.TextFormatFlags.Right;
                    break;
                case StringAlignment.Near:
                    TextFlags |= System.Windows.Forms.TextFormatFlags.Left;
                    break;
                default:
                    break;
            }

            TextFlags |= System.Windows.Forms.TextFormatFlags.VerticalCenter;
        }
        ...
        /// </summary>
        public System.Windows.Forms.TextFormatFlags TextFlags
        {
