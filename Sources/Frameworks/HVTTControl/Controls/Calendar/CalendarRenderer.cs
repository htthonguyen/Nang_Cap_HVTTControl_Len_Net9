...
namespace HVTT.UI.Window.Forms.Controls.Calendar
{
    ...
    public class CalendarRenderer
    {
        ...
        private System.Windows.Forms.Padding _itemTextMargin;
        ...
        public CalendarRenderer(Calendar calendar)
        {
            ...
            _itemsPadding = 5;
            _itemTextMargin = new System.Windows.Forms.Padding(3);
        ...
        public virtual int StandardItemHeight
        {
            get 
            {
                if (_standardItemHeight == 0)
                {
                    ...
                    _standardItemHeight = System.Windows.Forms.TextRenderer.MeasureText("Ag \n Xy", Calendar.Font).Height;
                }
        ...
        public virtual int DayTopMinHeight
        {
            get 
            {
                ...
                {
                    _dayTopMinHeight = System.Windows.Forms.TextRenderer.MeasureText("Ag", Calendar.Font).Height + 16;
                }
        ...
        public virtual int DayHeaderHeight
        {
            get
            {
                ...
                {
                    _dayHeaderHeight = System.Windows.Forms.TextRenderer.MeasureText("Ag", Calendar.Font).Height + 4;
                }
        ...
        /// </summary>
        public virtual System.Windows.Forms.Padding ItemTextMargin
        {
        ...
        public virtual int TimeScaleUnitHeight
        {
            get 
            {
                ...
                {
                    _timeScaleUnitHeight = System.Windows.Forms.TextRenderer.MeasureText("Ag", Calendar.Font).Height + 10;
                }
        ...
        public virtual int WeekHeaderWidth
        {
            get
            {
                ...
                {
                    _weekHeaderWidth = System.Windows.Forms.TextRenderer.MeasureText("Ag", Calendar.Font).Height + 4;
                }
        ...
        /// </summary>
        /// <param name="e"></param>
        protected virtual void DrawStandarBoxText(CalendarRendererBoxEventArgs e,Boolean IsLoadLanguage)
        {
           // e.Format = System.Windows.Forms.TextFormatFlags.WordBreak;
            if (IsLoadLanguage)
                System.Windows.Forms.TextRenderer.DrawText(e.Graphics, e.Text, e.Font, e.Bounds, e.TextColor, e.Format);
            else
            {
                
               // e.Bounds = new Rectangle(e.Bounds.Location, rc);
                System.Windows.Forms.TextRenderer.DrawText(e.Graphics, e.Text, e.Font, e.Bounds, e.TextColor, System.Windows.Forms.TextFormatFlags.WordBreak);
            }    
        }
        ...
        public virtual void OnDrawTimeScale(CalendarRendererEventArgs e)
        {
            ...
            for (int i = 0; i < e.Calendar.Days[0].TimeUnits.Length; i++)
            {
                ...
                if (!string.IsNullOrEmpty(minutes))
                {
                    ...
                    CalendarRendererBoxEventArgs hevt = new CalendarRendererBoxEventArgs(e, new Rectangle(hourLeft, unit.Bounds.Top, hourWidth, unit.Bounds.Height), hours, System.Windows.Forms.TextFormatFlags.Right);
                    ...
                    CalendarRendererBoxEventArgs mevt = new CalendarRendererBoxEventArgs(e, new Rectangle(minuteLeft, unit.Bounds.Top, minuteWidth, unit.Bounds.Height), minutes, System.Windows.Forms.TextFormatFlags.Top | System.Windows.Forms.TextFormatFlags.Left);
        ...
        public virtual void OnDrawItemContent(CalendarRendererItemBoundsEventArgs e)
        {
            ...
            for (int i = 0; i < rectangles.Count; i++)
            {
                ...
                if (e.Item.ShowEndTime && i == rectangles.Count - 1)
                {
                    ...
                    rEndTime = new Rectangle(Point.Empty, System.Windows.Forms.TextRenderer.MeasureText(endTime, e.Calendar.Font));
                ...
                if (e.Item.ShowStartTime && i == 0)
                {
                    ...
                    rStartTime = new Rectangle(Point.Empty, System.Windows.Forms.TextRenderer.MeasureText(startTime, e.Calendar.Font));
                ...
                CalendarRendererBoxEventArgs evt = new CalendarRendererBoxEventArgs(e, r, e.Item.Text, System.Windows.Forms.TextFormatFlags.Left | System.Windows.Forms.TextFormatFlags.Top);
                ...
                if (e.Item.IsOnDayTop || Calendar.DaysMode == CalendarDaysMode.Short)
                    evt.Format |= System.Windows.Forms.TextFormatFlags.HorizontalCenter;
        ...
        public virtual void OnDrawWeekHeaders(CalendarRendererEventArgs e)
        {
            ...
            for (int i = 0; i < Calendar.Weeks.Length; i++)
            {
                ...
                OnDrawWeekHeader(new CalendarRendererBoxEventArgs(e,
                    Calendar.Weeks[i].HeaderBounds, str, System.Windows.Forms.TextFormatFlags.Default));
            }
        }
        private String GetWeekHeaderText(String text)
        {
            return text.ToLower()
                .Replace("jan".ToLower(), "Jan")
                .Replace("feb".ToLower(), "Feb")
                .Replace("mar".ToLower(), "Mar")
                .Replace("apr".ToLower(), "Apr")
                .Replace("may".ToLower(), "May")
                .Replace("jun".ToLower(), "Jun")
                .Replace("jul".ToLower(), "Jul")
                .Replace("aug".ToLower(), "Aug")
                .Replace("sep".ToLower(), "Sep")
                .Replace("oct".ToLower(), "Oct")
                .Replace("nov".ToLower(), "Nov")
                .Replace("dec".ToLower(), "Dec")
                ;
        }
        ...
        public virtual void OnDrawWeekHeader(CalendarRendererBoxEventArgs e)
        {
            ...
            {
                e.Graphics.DrawString(GetWeekHeaderText(e.Text), e.Font, b, e.Bounds, sf);
            }
