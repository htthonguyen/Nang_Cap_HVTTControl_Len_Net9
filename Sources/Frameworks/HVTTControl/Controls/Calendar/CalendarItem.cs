...
namespace HVTT.UI.Window.Forms.Controls.Calendar
{
        ...
        : CalendarSelectableElement
    {
        ...
        //    get
        //    {
        //        var rc = System.Windows.Forms.TextRenderer.MeasureText(this.Text, Calendar.Font, new Size(base.Bounds.Width, base.Bounds.Height), System.Windows.Forms.TextFormatFlags.WordBreak);
        //        rc.Height = rc.Height + 4;
        //        var b = new Rectangle(base.Bounds.Location, rc);
        //        return b;
        //    }
        //}
        ...
        internal void AddBounds(Rectangle r)
        {
            ...
            if (Bounds.IsEmpty)
            {
                //var rc = System.Windows.Forms.TextRenderer.MeasureText(this.Text, Calendar.Font, new Size(r.Width, r.Height), System.Windows.Forms.TextFormatFlags.WordBreak);
                //r.Size = rc;
                SetBounds(r);
            }
            else
