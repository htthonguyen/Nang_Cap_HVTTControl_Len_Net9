...
namespace HVTT.UI.Window.Forms.Controls
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(HVTTCheckBox), "Controls.CheckBoxX.ico"), ToolboxItem(true), DefaultEvent("CheckedChanged"), System.Runtime.InteropServices.ComVisible(false)]
    public class HVTTCheckBox : BaseItemControl
    {
        ...
        public HVTTCheckBox()
        {
            ...
            m_CheckBox.Style = HVTTControlStyle.Office2007;
        ...
        private void OnCheckedChanged(object sender, CheckBoxChangeEventArgs e)
        {
            ...
            if (m_CheckBox.CheckBoxStyle == eCheckBoxStyle.RadioButton && m_CheckBox.Checked && this.Parent != null)
            {
                foreach (Control c in this.Parent.Controls)
                {
                    if (c == this)
                        continue;
                    HVTTCheckBox b = c as HVTTCheckBox;
    ...
    public class CheckBoxXChangeEventArgs : EventArgs
    {
        ...
        /// </summary>
        public readonly HVTTCheckBox NewChecked;
        /// <summary>
        ...
        /// </summary>
        public readonly HVTTCheckBox OldChecked;
        /// <summary>
        ...
        /// Default constructor.
        /// </summary>
        public CheckBoxXChangeEventArgs(HVTTCheckBox oldchecked, HVTTCheckBox newchecked, EventSource eventSource)
        {
