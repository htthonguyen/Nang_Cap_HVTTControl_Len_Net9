...
namespace HVTT.UI.Window.Forms
{
    ...
    [Designer(typeof(Design.HVTTLabelDesigner))]
    [ToolboxBitmap(typeof(HVTTLabel), "Controls.HVTTLabel.ico"), ToolboxItem(true), System.Runtime.InteropServices.ComVisible(false)]
    public class HVTTLabel : BaseItemControl
    {
        ...
        public Boolean _mblnChangeText = true;

        private String _msDescription = String.Empty;
        ...
        public Boolean AllowChangeText
        {
            get
            {
                return _mblnChangeText;
            }
            set
            {
                _mblnChangeText = value;
            }
        }
        #endregion
        ...
        public HVTTLabel()
        {
            ...
            m_Label.Style = HVTTControlStyle.Office2007;
        ...
        /// </summary>
        [Browsable(true), Category("Appearance"), Description("The alignment of the image in relation to text displayed by this item."), DefaultValue(ImagePosition.Left)]
