...
namespace HVTT.UI.Window.Forms.Controls
{
	...
	/// </summary>
    [ToolboxBitmap(typeof(ComboBoxEx), "Controls.ComboBoxEx.ico"), ToolboxItem(true), Designer(typeof(Design.ComboBoxExDesigner))]
	public class ComboBoxEx : System.Windows.Forms.ComboBox
	{
        ...
        private InternalComboColors GetComboColors()
        {
            ...
            if (this.Style == eDotNetBarStyle.Office2007 && GlobalManager.Renderer is Office2007Renderer)
            {
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == WM_CTLCOLORLISTBOX)
            {
                ...
                //if (m_DropDownHandle != IntPtr.Zero && m_Style == eDotNetBarStyle.Office2007)
                //{
            ...
            if ((m.Msg == WM_PAINT || m.Msg == WM_PRINTCLIENT) && this.DrawMode != DrawMode.Normal)
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        if (this.Style == eDotNetBarStyle.Office2003 || this.Style == eDotNetBarStyle.VS2005 || BarFunctions.IsOffice2007Style(this.Style))
                            thumbWidth -= 3;
                        ...
                        Rectangle r1;
                        if ((this.Style == eDotNetBarStyle.Office2003 || this.Style == eDotNetBarStyle.VS2005 || BarFunctions.IsOffice2007Style(this.Style)) && !this.Enabled)
                        ...
                        if ((this.Style == eDotNetBarStyle.Office2003 || m_Style == eDotNetBarStyle.VS2005 || BarFunctions.IsOffice2007Style(m_Style)) && this.Enabled)
                        {
                            using(SolidBrush brush = new SolidBrush(colors.Background))
                        ...
                        if (bFocus)
                        {
                            if (m_Style == eDotNetBarStyle.OfficeXP || m_Style == eDotNetBarStyle.Office2003 || m_Style == eDotNetBarStyle.VS2005 || BarFunctions.IsOffice2007Style(m_Style))
                            {
				...
				else
				{
					...
					if(o is ComboItem)
					{
						...
						else
						{
                            ...
                            if (m_Style == eDotNetBarStyle.Office2007)
                            {
                                e.ItemHeight += 6;
                                e.ItemWidth += 6;
                            }
...
//			}
		...
		[System.ComponentModel.Editor(typeof(HVTT.Editors.ComboItemsEditor), typeof(System.Drawing.Design.UITypeEditor)), Localizable(true)]
