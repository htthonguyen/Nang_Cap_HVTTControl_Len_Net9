...
{
    public class HVTTDrawObject
    {
        private ImageViewer KpViewer;
        ...
        public HVTTDrawObject(ImageViewer KpViewer, Bitmap bmp)
        {
            try
            {
        ...
        public HVTTDrawObject(ImageViewer KpViewer)
        {
            try
            {
                this.KpViewer = KpViewer;
