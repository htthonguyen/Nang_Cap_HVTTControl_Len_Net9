...
namespace HVTT.UI.Window.Forms.Controls.HVTTImageViewer
{
    ...
    public partial class ImageViewer : UserControl
    {
        ...
        private HVTTDrawEngine drawEngine;
        private HVTTDrawObject drawing;
        ...
        /// % thể hiện
        /// </summary>
        public double PreviewPercent { get; set; } = 75;

        private int GetPreviewIndex()
        {
            try
            {
                int i = Convert.ToInt32(Math.Round(PreviewPercent / 25, 0));
                if (i <= 0 || i > 16)
                    return 3;
                return i;
            }
        ...
        public string ImagePath
        {
            set 
            {
                _mstrImagePath = value;

                var bytes = File.ReadAllBytes(_mstrImagePath);
        ...
        public ImageViewer()
        {
            ...
            drawEngine = new HVTTDrawEngine();
            drawing = new HVTTDrawObject(this);
            ...
            try
            {
                ...
                imgStream = a.GetManifestResourceStream("HVTT.UI.Window.Forms.Controls.HVTTImageViewer.Resources.Grab.cur");
                if (imgStream != null)
                {
                ...
                imgStream = a.GetManifestResourceStream("HVTT.UI.Window.Forms.Controls.HVTTImageViewer.Resources.Drag.cur");
                if (imgStream != null)
                {
        ...
        private void KP_ImageViewerV2_Load(object sender, EventArgs e)
        {
            ...
            cbZoom.SelectedIndex = GetPreviewIndex();
        }
        ...
        private void KP_ImageViewerV2_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            if (drawing.Image != null)
            {
                if (e.Delta < 0)
                {
                    OnZoom(new ImageViewerZoomEventArgs(drawing.Zoom, HVTTZoom.ZoomOut));
                }
                else
                {
                    OnZoom(new ImageViewerZoomEventArgs(drawing.Zoom, HVTTZoom.ZoomIn));
                }
            }
        ...
        private void btnMode_Click(object sender, EventArgs e)
        {
            ...
            {
                selectMode = true;
                this.btnMode.Image = HVTT.UI.Window.Forms.Properties.Resources.btnDrag;
            }
            else
            {
                selectMode = false;
                this.btnMode.Image = HVTT.UI.Window.Forms.Properties.Resources.btnSelect;
            }
        }
        ...
        private void btnSnippingTool_Click(object sender, EventArgs e)
        {
            //var img = HVTT.Images.SnippingTool.Snip();
            //if(img!=null)
            //{
            //    frmSplitConfig myFrm = new frmSplitConfig();
            //    myFrm.NewImage = (Bitmap)img;
            //    myFrm.Image = img;
            //    myFrm.OldImagePath = _mstrImagePath;
            //    myFrm.Text = ((Descr == null || Descr.Trim() == "") ? "HVTT: " + _mstrImagePath : Descr);
            //    if(myFrm.ShowDialog()== DialogResult.OK)
            //    {
            //        this.ImagePath = _mstrImagePath;
            //    }
            //}
        }


        public Boolean EnableSplitButton
        {
            get
            {
                return btnSnippingTool.Enabled;
            }
            set
            {
                btnSnippingTool.Enabled = value;
            }
        }
        ...
        internal void Print(string FileName)
        {
            ...
            try
            {
                if (String.IsNullOrEmpty(FileName)) return; // Prevents execution of below statements if filename is not selected.
        ...
        {
            if (_mstrImagePath != null && _mstrImagePath.Trim() != "")
                Print(_mstrImagePath);
        }
    }
    ...
    public class ImageViewerZoomEventArgs : EventArgs
    {
        ...
        private HVTTZoom inOut;
        public HVTTZoom InOut
        {
            get { return inOut; }
        }

        public ImageViewerZoomEventArgs(double zoom, HVTTZoom inOut)
        {
