...
{
    public class HVTTDataGridViewRichTextBoxColumn : DataGridViewColumn
    {
        public HVTTDataGridViewRichTextBoxColumn()
            : base(new HVTTDataGridViewRichTextBoxCell())
        {
        }
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                if (!(value is HVTTDataGridViewRichTextBoxCell))
                    throw new InvalidCastException("CellTemplate must be a HVTTDataGridViewRichTextBoxCell");
    ...
    public class HVTTDataGridViewRichTextBoxCell : DataGridViewImageCell
    {
        ...
        public override Type EditType
        {
            get
            {
                return typeof(HVTTDataGridViewRichTextBoxEditingControl);
            }
        }
    ...
    class HVTTDataGridViewRichTextBoxEditingControl : RichTextBox, IDataGridViewEditingControl
    {
        private DataGridView _dataGridView;
        private int _rowIndex;
        private bool _valueChanged;

        public HVTTDataGridViewRichTextBoxEditingControl()
        {
        ...
        System.Windows.Forms.DataGridView IDataGridViewEditingControl.EditingControlDataGridView { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
