...
namespace HVTT.UI.Window.Forms.Controls
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(HVTTListView), "Controls.ListViewEx.ico"), ToolboxItem(true)]
    public class HVTTListView : ListView, INonClientControl
    {
        ...
        private void DrawColumnHeaderInternal(DrawListViewColumnHeaderEventArgs e)
        {
            ...
            TextFormatFlags flags = TextFormatFlags.Left | TextFormatFlags.SingleLine | TextFormatFlags.VerticalCenter | TextFormatFlags.WordEllipsis;
        ...
        private void DrawItemBackground(Graphics g, Rectangle r, ListViewItem item, ListViewItemStates state)
        {
            ...
            if (IsInState(state , ListViewItemStates.Selected))
            {
                Office2007ListViewColorTable ct = GetColorTable();
            ...
            else if (IsInState(state , ListViewItemStates.Hot) && this.HotTracking)
            {
                ...
                Office2007ButtonItemPainter.PaintBackground(g, rnd.ColorTable.ButtonItemColors[0].MouseOver, r, 0);
            }

            if (IsInState(state, ListViewItemStates.Focused) && (!IsInState(state, ListViewItemStates.Hot) && this.View != View.LargeIcon || IsInState(state, ListViewItemStates.Selected)))
            {
        ...
        private void DrawListViewItem(Graphics g, ListViewItem item, ColumnHeader header, Font font, Color color, ListViewItemStates state)
        {
            ...
            if (rText.Width > 2)
            {
                ...
                eTextFormat flags = eTextFormat.Left | eTextFormat.SingleLine;
                ...
                {
                    flags = eTextFormat.HorizontalCenter | eTextFormat.WordBreak | eTextFormat.EndEllipsis;
                }
            ...
            if (this.CheckBoxes && (this.View == View.Details || this.View == View.List || this.View == View.SmallIcon || this.View == View.LargeIcon) && this.StateImageList == null)
            {
                ...
                if ((state & ListViewItemStates.Grayed) != 0)
                    ct = ctt.Disabled;
        ...
        {
            //Console.WriteLine(e.Item.Text + "   " + e.ItemState.ToString() + "   " + DateTime.Now);
            Graphics g = e.Graphics;
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                DrawListViewItem(g, e.Item, e.Header, e.Item.Font, e.Item.ForeColor, e.ItemState);
        ...
        private void PaintSubItem(Graphics g, ListViewItem.ListViewSubItem subitem, Rectangle r, ListViewItemStates state, ColumnHeader header, Color itemBackColor)
        {
            ...
            eTextFormat flags = eTextFormat.Left | eTextFormat.SingleLine | eTextFormat.VerticalCenter | eTextFormat.WordEllipsis;
            ...
            //Size sz = TextRenderer.MeasureText(" ", subitem.Font);
            Rectangle rText = Rectangle.Inflate(r,-2, 0); // Rectangle.Inflate(r, -sz.Width, 0);
            TextDrawing.DrawString(g, subitem.Text, subitem.Font, subitem.ForeColor, rText, flags);
        }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            {
                base.OnMouseUp(e);
                if (this.View == View.Details && this.FullRowSelect)
                {
        ...
        {
            private HVTTListView m_Parent = null;
            private bool m_MouseDown = false;
            private Point m_MouseDownPoint = Point.Empty;
            public HeaderHandler(HVTTListView parent)
            {
                m_Parent = parent;
