...
namespace HVTT.UI.Window.Forms
{
    ...
    public abstract class BaseItemControl : Control
    {
        ...
        {
            if (m_Item!=null && m_Item.Style == HVTTControlStyle.Office2007)
            {
        ...
        /// <summary>
        /// Gets whether painting of focus cues is enabled.
        /// </summary>
        protected virtual bool FocusCuesEnabled
        {
            get { return true; }
        }
        ...
        /// </summary>
        [Browsable(true), Category("Appearance"), Description("Specifies the visual style of the control."), DefaultValue(HVTTControlStyle.Office2007)]
        ...
        {
            m_Item.RaiseClick(EventSource.Keyboard);
            return true;
        }
        #endregion
