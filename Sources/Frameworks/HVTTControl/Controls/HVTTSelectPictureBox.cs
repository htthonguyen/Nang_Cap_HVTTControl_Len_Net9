...
{
    public partial class HVTTSelectPictureBox : PictureBox
    {
        public HVTTSelectPictureBox()
        {
            InitializeComponent();
        ...
        public Image GetSeletedImage()
        {
           
            Pen selectPen = new Pen(Color.Red, 1);
            selectPen.DashStyle = DashStyle.DashDotDot;

            this.CreateGraphics().DrawRectangle(selectPen, this.SelectionRect.Location.X,
                this.SelectionRect.Location.Y, this.SelectionRect.Width, this.SelectionRect.Height);

            Rectangle rect = new Rectangle(this.SelectionRect.Location.X,
                this.SelectionRect.Location.Y, this.SelectionRect.Width, this.SelectionRect.Height);
            //create bitmap with original dimensions
            Bitmap OriginalImage = new Bitmap(this.Image, this.Width, this.Height);
            //create bitmap with selected dimensions
            Bitmap _img = new Bitmap(this.SelectionRect.Width, this.SelectionRect.Height);
