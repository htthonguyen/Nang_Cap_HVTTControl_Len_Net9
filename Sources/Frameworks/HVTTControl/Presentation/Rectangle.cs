...
namespace HVTT.UI.Window.Forms.Presentation
{
    internal class Rectangle : Shape
    {
        ...
        private CornerType m_TopLeftCornerType = CornerType.Square;
        private CornerType m_TopRightCornerType = CornerType.Square;
        private CornerType m_BottomLeftCornerType = CornerType.Square;
        private CornerType m_BottomRightCornerType = CornerType.Square;
        #endregion
        ...
        public Rectangle(ShapeBorder border, int cornerSize, CornerType cornerType)
        {
            m_Border = border;
        ...
        public Rectangle(ShapeBorder border, ShapeFill fill,int cornerSize, CornerType cornerType)
        {
            m_Border = border;
            m_Fill = fill;
            m_CornerSize = cornerSize;
        ...
        public Rectangle(ShapeBorder border, ShapeFill fill, int cornerSize, CornerType cornerType, PaddingInfo padding)
        {
            m_Border = border;
            m_Fill = fill;
            m_CornerSize = cornerSize;
