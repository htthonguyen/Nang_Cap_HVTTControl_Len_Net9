...
namespace HVTT.UI.Editors
{
	...
	public class ComboItem:Component
	{
		...
		internal HVTTComboBox m_ComboBox=null;
		...
		public ComboItem()
		{
			m_TextFormat=HVTT.UI.Window.Forms.BarFunctions.CreateStringFormat(); //new StringFormat(StringFormat.GenericDefault);
		...
		/// </summary>
        [DefaultValue(-1), System.ComponentModel.Editor(typeof(ImageIndexEditor), typeof(System.Drawing.Design.UITypeEditor)), TypeConverter(typeof(System.Windows.Forms.ImageIndexConverter)), Localizable(true)]
