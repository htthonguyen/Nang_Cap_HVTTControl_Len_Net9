...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(true),Designer(typeof(Design.PanelExDesigner)),DefaultEvent("Click")]
	public class HVTTPanel:System.Windows.Forms.Panel, IButtonControl
	{
		...
		private HVTTControlStyle m_ColorSchemeStyle=HVTTControlStyle.Office2003;
		...
		{
            return m_ColorScheme.SchemeChanged && m_ColorSchemeStyle != HVTTControlStyle.Office2007;
		}
        ...
        {
            if (m_ColorSchemeStyle == HVTTControlStyle.Office2007)
                RefreshStyleSystemColors();
            base.OnVisibleChanged(e);
        }

		private CornerType m_CurrentCornerType=CornerType.Square;
		...
		private void SetRegion(bool bResize)
		{
			if(bResize || m_CurrentCornerType!=m_Style.CornerType || m_CornerDiameter!=m_Style.CornerDiameter)
			{
				...
				if(m_Style!=null && !(DrawThemedPane && BarFunctions.ThemedOS) && m_Style.CornerType!=CornerType.Square)
				{
		...
		/// </summary>
        [Browsable(true), HVTTBrowsable(true), Editor(typeof(Design.TextMarkupUIEditor), typeof(System.Drawing.Design.UITypeEditor)), EditorBrowsable(EditorBrowsableState.Always), Category("Appearance"), Description("Gets or sets the text displayed on panel.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(false),Category("Appearance"),Description("Indicates whether focus rectangle is displayed when control has focus.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets panel style."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets the panel style when mouse hovers over the panel."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets the panel style when mouse button is pressed on the panel."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		public HVTTControlStyle ColorSchemeStyle
		{
			...
			set
			{
                ...
                if (m_ColorSchemeStyle == HVTTControlStyle.Office2007 && Rendering.GlobalManager.Renderer is Rendering.Office2007Renderer)
		...
		{
			//this.ColorSchemeStyle=HVTTControlStyle.Office2003;
		...
		public void ApplyButtonStyle()
		{
			...
			this.Style.BackColor1.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarBackground;
			this.Style.BackColor2.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarBackground2;
			//this.Style.BackgroundImagePosition = HVTT.UI.Window.Forms.BackgroundImagePosition.Tile;
			this.Style.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
			this.Style.BorderColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarDockedBorder;
			this.Style.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemText;
			this.Style.GradientAngle = 90;
			this.StyleMouseDown.Alignment = System.Drawing.StringAlignment.Center;
			this.StyleMouseDown.BackColor1.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBackground;
			this.StyleMouseDown.BackColor2.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBackground2;
			this.StyleMouseDown.BorderColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBorder;
			this.StyleMouseDown.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedText;
			this.StyleMouseOver.Alignment = System.Drawing.StringAlignment.Center;
			this.StyleMouseOver.BackColor1.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBackground;
			this.StyleMouseOver.BackColor2.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBackground2;
			this.StyleMouseOver.BorderColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBorder;
			this.StyleMouseOver.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotText;
		...
		public void ApplyLabelStyle()
		{
			...
			TypeDescriptor.GetProperties(this.Style.BackColor1)["ColorSchemePart"].SetValue(this.Style.BackColor1,HVTT.UI.Window.Forms.eColorSchemePart.BarBackground);
			TypeDescriptor.GetProperties(this.Style.BackColor2)["ColorSchemePart"].SetValue(this.Style.BackColor2,HVTT.UI.Window.Forms.eColorSchemePart.BarBackground2);
			//TypeDescriptor.GetProperties(this.Style)["BackgroundImagePosition"].SetValue(this.Style,BackgroundImagePosition.Tile);
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies whether item is drawn using Themes when running on OS that supports themes like Windows XP.")]
		...
		internal HVTT.UI.Window.Forms.ThemeTab ThemeTab
		{
			get
			{
				if(m_ThemeTab==null)
