...
namespace HVTT.UI.Window.Forms
{
	...
	{
		const BorderSide DEFAULT_BORDERSIDE=BorderSide.Top | BorderSide.Bottom | BorderSide.Left | BorderSide.Right;
		...
		private BorderSide m_BorderSide=DEFAULT_BORDERSIDE;
		...
		internal void ApplyStyle(ItemStyle style)
		{
			...
			if(style.BackgroundImagePosition!=BackgroundImagePosition.Stretch)
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets a background color or starting color for gradient background."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets a background color or ending color for gradient background."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Gets or sets a text color."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(0),Description("Gets or sets the gradient angle.")]
		...
		internal System.Drawing.Region GetRegion(Rectangle clientRectangle)
		{
			...
			if(m_Border!=eBorderType.None && m_BorderWidth>0 && m_CornerType!=CornerType.Square && !m_BorderColor.IsEmpty)
			{
		...
		private GraphicsPath GetPath(Rectangle clientRectangle)
		{
			...
			if(m_CornerType!=CornerType.Square)
			{
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(null),Description("Gets or sets the style Font")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(false),Description("Gets or sets a value that determines whether text is displayed in multiple lines or one long line.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),DefaultValue(StringAlignment.Near),Description("Specifies alignment of the text.")]
		...
		/// Specifies alignment of the text.
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(StringAlignment.Center),Description("Specifies alignment of the text.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(StringTrimming.EllipsisCharacter),Description("Specifies how to trim characters when text does not fit.")]
        ...
        /// </summary>
        [Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(null),Description("Specifies background image."),DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(BackgroundImagePosition.Stretch),Description("Specifies background image position when container is larger than image.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue((byte)255),Description("Specifies the transparency of background image.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(CornerType.Square),Description("Indicates corner type.")]		
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(DEFAULT_CORNER_DIAMETER),Description("Indicates diameter in pixels of the corner type rounded or diagonal.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(eBorderType.None),Description("Specifies the border type.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(DashStyle.Solid),NotifyParentPropertyAttribute(true),Category("Style"),Description("Indicates dash style for single line border type.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(DEFAULT_BORDERSIDE),Description("Specifies border sides that are displayed.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),Description("Specifies the border color."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(1),Description("Specifies the line tickness of single line border.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(0),Description("Specifies left text margin.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(0),Description("Specifies right text margin.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(0),Description("Specifies top text margin.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true),Category("Style"),DefaultValue(0),Description("Specifies bottom text margin.")]
...
//					{
//						if(imageAtt!=null)
//							g.DrawImage(m_BackgroundImage,r,0,0,m_BackgroundImage.Width,m_BackgroundImage.Height,GraphicsUnit.Pixel,imageAtt);
//						else
//                            g.DrawImage(m_BackgroundImage,r,0,0,m_BackgroundImage.Width,m_BackgroundImage.Height,GraphicsUnit.Pixel);
//						break;
//					}
//					case BackgroundImagePosition.Center:
//					{
//						Rectangle destRect=new Rectangle(r.X,r.Y,m_BackgroundImage.Width,m_BackgroundImage.Height);
//						if(r.Width>m_BackgroundImage.Width)
//							destRect.X+=(r.Width-m_BackgroundImage.Width)/2;
//						if(r.Height>m_BackgroundImage.Height)
//							destRect.Y+=(r.Height-m_BackgroundImage.Height)/2;
//						if(imageAtt!=null)
//							g.DrawImage(m_BackgroundImage,destRect,0,0,m_BackgroundImage.Width,m_BackgroundImage.Height,GraphicsUnit.Pixel,imageAtt);
//						else
//							g.DrawImage(m_BackgroundImage,destRect,0,0,m_BackgroundImage.Width,m_BackgroundImage.Height,GraphicsUnit.Pixel);
//						break;
//					}
...
//					{
//						Rectangle destRect=new Rectangle(r.X,r.Y,m_BackgroundImage.Width,m_BackgroundImage.Height);
//						if(m_BackgroundImagePosition==BackgroundImagePosition.TopRight)
//							destRect.X=r.Right-m_BackgroundImage.Width;
//						else if(m_BackgroundImagePosition==BackgroundImagePosition.BottomLeft)
//							destRect.Y=r.Bottom-m_BackgroundImage.Height;
//						else if(m_BackgroundImagePosition==BackgroundImagePosition.BottomRight)
//						{
//							destRect.Y=r.Bottom-m_BackgroundImage.Height;
//							destRect.X=r.Right-m_BackgroundImage.Width;
//						}
...
//						break;
//					}
//					case BackgroundImagePosition.Tile:
//					{
//						if(imageAtt!=null)
//						{
//							if(r.Width>m_BackgroundImage.Width || r.Height>m_BackgroundImage.Height)
//							{
//								int x=r.X,y=r.Y;
//								while(y<r.Bottom)
//								{
//									while(x<r.Right)
//									{
//										Rectangle destRect=new Rectangle(x,y,m_BackgroundImage.Width,m_BackgroundImage.Height);
...
//										g.DrawImage(m_BackgroundImage,destRect,0,0,destRect.Width,destRect.Height,GraphicsUnit.Pixel,imageAtt);
//										x+=m_BackgroundImage.Width;
//									}
//									x=r.X;
//									y+=m_BackgroundImage.Height;
//								}
//							}
//							else
//							{
//                                g.DrawImage(m_BackgroundImage,new Rectangle(0,0,m_BackgroundImage.Width,m_BackgroundImage.Height),0,0,m_BackgroundImage.Width,m_BackgroundImage.Height,GraphicsUnit.Pixel,imageAtt);
//							}
//						}
//						else
//						{
//                            TextureBrush brush=new TextureBrush(m_BackgroundImage);
...
//				}
				...
				else
				{
					switch(m_Border)
					{
						...
						case eBorderType.Raised:
						{
							...
							if(m_BorderSide==BorderSide.All)
								border3dside=System.Windows.Forms.Border3DSide.All;
							else
								border3dside=(((m_BorderSide&BorderSide.Left)!=0)?System.Windows.Forms.Border3DSide.Left:0) |
								(((m_BorderSide&BorderSide.Right)!=0)?System.Windows.Forms.Border3DSide.Right:0) |
								(((m_BorderSide&BorderSide.Top)!=0)?System.Windows.Forms.Border3DSide.Top:0) | 
								(((m_BorderSide&BorderSide.Bottom)!=0)?System.Windows.Forms.Border3DSide.Bottom:0);
		...
		internal void Deserialize(System.Xml.XmlElement styleElement)
		{
			...
			if(styleElement.HasAttribute("cornertype"))
				m_CornerType=(CornerType)System.Xml.XmlConvert.ToInt32(styleElement.GetAttribute("cornertype"));
	...
	public class ColorEx
	{
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),NotifyParentPropertyAttribute(true)]
		...
		/// </summary>
		[DefaultValue((byte)255),NotifyParentPropertyAttribute(true),Browsable(true),HVTTBrowsable(true)]
		public byte Alpha
		{
			get {return _Alpha;}
			set {
		...
		/// <summary>
		///     Specifies that color derived from system colors which is part of HVTTCONTROLS Color Scheme object is used.
		...
		/// </remarks>
		[DefaultValue(eColorSchemePart.Custom),NotifyParentPropertyAttribute(true),Browsable(true),HVTTBrowsable(true)]
