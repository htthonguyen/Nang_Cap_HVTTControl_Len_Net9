...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(true), Designer(typeof(Design.TabControlDesigner))]
	public class TabControl : System.Windows.Forms.Control,ISupportInitialize
	{
        ...
        private HVTT.UI.Window.Forms.TabStrip tabStrip1;
		...
		public TabControl()
		{
			...
			tabStrip1.TabLayoutType=TabLayoutType.FixedWithNavigationBox;
		...
		{
			this.tabStrip1 = new HVTT.UI.Window.Forms.TabStrip();
			this.SuspendLayout();
			// 
			// tabStrip1
			// 
			...
			this.tabStrip1.Style = HVTT.UI.Window.Forms.eTabStripStyle.OneNote;
			this.tabStrip1.TabAlignment = HVTT.UI.Window.Forms.eTabStripAlignment.Top;
			...
			this.tabStrip1.SelectedTabChanged += new HVTT.UI.Window.Forms.TabStrip.SelectedTabChangedEventHandler(this.tabStrip1_SelectedTabChanged);
			this.tabStrip1.SelectedTabChanging += new HVTT.UI.Window.Forms.TabStrip.SelectedTabChangingEventHandler(this.tabStrip1_SelectedTabChanging);
        ...
        /// </summary>
        [Browsable(false), System.ComponentModel.Editor(typeof(TabStripTabsEditor), typeof(System.Drawing.Design.UITypeEditor)), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), System.ComponentModel.Category("Data"), System.ComponentModel.Description("Returns the collection of Tabs.")]
		...
		{
			tabStrip1.SetTabIndex(TabName, index);
		}
		...
		private void tabStrip1_SelectedTabChanged(object sender, HVTT.UI.Window.Forms.TabStripTabChangedEventArgs e)
		{
		...
		protected virtual void InvokeSelectedTabChanged(HVTT.UI.Window.Forms.TabStripTabChangedEventArgs e)
		{
			if(SelectedTabChanged!=null)
				SelectedTabChanged(this,e);
		}

		private void tabStrip1_SelectedTabChanging(object sender, HVTT.UI.Window.Forms.TabStripTabChangingEventArgs e)
		{
			InvokeSelectedTabChanging(e);
		}

		protected virtual void InvokeSelectedTabChanging(HVTT.UI.Window.Forms.TabStripTabChangingEventArgs e)
		{
...
//		}
		...
		public void ApplyDefaultPanelStyle(TabControlPanel panel)
		{
            ...
            if (m_TabStripVisible)
            {
                ...
                {
                    case eTabStripAlignment.Top:
                        panel.Style.BorderSide = (BorderSide.Left | BorderSide.Right | BorderSide.Bottom);
                        break;
                    case eTabStripAlignment.Bottom:
                        panel.Style.BorderSide = (BorderSide.Left | BorderSide.Right | BorderSide.Top);
                        break;
                    case eTabStripAlignment.Left:
                        panel.Style.BorderSide = (BorderSide.Top | BorderSide.Right | BorderSide.Bottom);
                        break;
                    case eTabStripAlignment.Right:
                        panel.Style.BorderSide = (BorderSide.Left | BorderSide.Top | BorderSide.Bottom);
                        break;
                }
            }
            else
                panel.Style.BorderSide = BorderSide.All;
        ...
        {
            if (keyData != Keys.F4 && keyData != Keys.F5)
                return base.ProcessDialogKey(keyData);

            if (this.Tabs.Count > 0)
            {
                int iSelectedTab = this.SelectedTabIndex;
                if (keyData == Keys.F5)
                {
                    if (iSelectedTab < this.Tabs.Count - 1)
                        this.SelectedTabIndex = iSelectedTab + 1;
                    else
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Specifes whether end-user can reorder the tabs.")]
		...
		/// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Close Button"), Description("Indicates whether the Close button that closes the active tab is visible."), DefaultValue(false)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Appearance"),Description("Specifes the Tab Control style."),DefaultValue(eTabStripStyle.OneNote)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies whether tab is drawn using Themes when running on OS that supports themes like Windows XP.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Indicates whether tabs are scrolled continuously while mouse is pressed over the scroll tab button.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(300),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Indicates auto-repeat interval for the tab scrolling while mouse button is kept pressed over the scroll tab button.")]
		...
		/// </summary>
		[DefaultValue(eTabStripAlignment.Top),Browsable(true),HVTTBrowsable(true),Category("Appearance"),Description("Indicates the tab alignment within the Tab-Strip control.")]
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),Category("Behavior"),Description("Indicates selected tab."),DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Behavior"),Description("Indicates the index of selected tab.")]
