...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[System.ComponentModel.ToolboxItem(false),Designer(typeof(Design.ExplorerBarGroupItemDesigner))]
	public class ExplorerBarGroupItem:ImageItem,IDesignTimeProvider
	{
		...
		private ExplorerBarStockStyle m_StockStyle=ExplorerBarStockStyle.Custom;
		...
		public override void RecalcSize()
		{
			...
			if(textArea<=0)
				textArea=1;
			objStringSize=TextDrawing.MeasureString(g,text,this.GetFont(),textArea,m_TitleStyle.TextFormat);
			g.Dispose();
...
//					}
		...
		private Image GetImageFromImageList(int ImageIndex)
		{
			if(ImageIndex>=0)
			{
				...
				if(bar==null) bar=this.ContainerControl as HVTTMarkStatus; 
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DefaultValue(false),DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Category("Appearance"),Description("Specifies whether item is drawn using Themes when running on OS that supports themes like Windows XP.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),System.ComponentModel.DefaultValue(true),HVTTBrowsable(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Gets or sets whether expand button is visible.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),Category("Behavior"),System.ComponentModel.DefaultValue(false),Description("Gets or sets a value indicating whether group is expanded or not."),DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Style"), Description("Gets or sets a normal item style."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Style"), Description("Gets or sets a mouse over item style."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		[Browsable(false),HVTTBrowsable(false),DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Obsolete("This property is obsolete. Use TitleStyle property instead"),EditorBrowsable(EditorBrowsableState.Never)]
		public ItemStyleMapper HeaderStyle
		{
			get {return m_HeaderStyle;}
		}

        [Browsable(false), HVTTBrowsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Obsolete("This property is obsolete. Use TitleHotStyle property instead"), EditorBrowsable(EditorBrowsableState.Never)]
        public ItemStyleMapper HeaderHotStyle
		{
			get {return m_HeaderHotStyle;}
		}

        [Browsable(false), HVTTBrowsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Obsolete("This property is obsolete. Use BackStyle property instead"), EditorBrowsable(EditorBrowsableState.Never)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(true),Category("Behavior"),Description("Determines whether clicking the header of the control expands the item.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),Description("Applies the stock style to the object."),DefaultValue(ExplorerBarStockStyle.Custom),DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
		public ExplorerBarStockStyle StockStyle
		{
			get {return m_StockStyle;}
			set
			{
				m_StockStyle=value;
				if(m_StockStyle==ExplorerBarStockStyle.Custom)
					return;
				BarFunctions.SetExplorerBarStyle(this,m_StockStyle);
				foreach(BaseItem item in this.SubItems)
				{
                ...
                if (m_StockStyle == ExplorerBarStockStyle.BlueSpecial || m_StockStyle == ExplorerBarStockStyle.OliveGreenSpecial || m_StockStyle == ExplorerBarStockStyle.SilverSpecial)
                    this.XPSpecialGroup = true;
                else if (m_StockStyle != ExplorerBarStockStyle.SystemColors)
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(HVTTControlStyle.OfficeXP),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Determines the display of the item when shown.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),Description("Specifies expand button border color.") ]
		...
		{
			return (m_ExpandBorderColor!=Color.DarkGray && m_StockStyle==ExplorerBarStockStyle.Custom);
		}

		/// <summary>
		/// Gets or sets expand button back color.
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),Description("Specifies expand button back color.") ]
		...
		{
			return (m_ExpandBackColor!=Color.White && m_StockStyle==ExplorerBarStockStyle.Custom);
		}

		/// <summary>
		/// Gets or sets expand button fore color.
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),Description("Specifies expand button fore color.") ]
		...
		{
			return (m_ExpandForeColor!=SystemColors.ActiveCaption && m_StockStyle==ExplorerBarStockStyle.Custom);
		}

		/// <summary>
		/// Gets or sets hot expand button border color.
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),Description("Specifies hot expand button border color.") ]
		...
		{
			return (m_ExpandHotBorderColor!=Color.DarkGray && m_StockStyle==ExplorerBarStockStyle.Custom);
		}

		/// <summary>
		/// Gets or sets hot expand button back color.
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),Description("Specifies hot expand button back color.") ]
		...
		{
			return (m_ExpandHotBackColor!=Color.White && m_StockStyle==ExplorerBarStockStyle.Custom);
		}

		/// <summary>
		/// Gets or sets hot expand button fore color.
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),Description("Specifies hot expand button fore color.")]
		...
		{
			return (m_ExpandHotForeColor!=SystemColors.ActiveCaption && m_StockStyle==ExplorerBarStockStyle.Custom);
		}
		...
		protected internal override void Deserialize(ItemSerializationContext context)
		{
			...
			m_StockStyle=(ExplorerBarStockStyle)System.Xml.XmlConvert.ToInt32(groupItem.GetAttribute("stockstyle"));
        ...
        /// </summary>
        [Browsable(false), HVTTBrowsable(false), DefaultValue(true), Category("Behavior"), Description("Indicates whether is item enabled.")]
		...
		[System.ComponentModel.Browsable(true),HVTTBrowsable(false),System.ComponentModel.Editor(typeof(Design.ExplorerBarGroupItemEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.Category("Data"),System.ComponentModel.Description("Collection of sub items."),System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Content)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates whether XP themed special group colors are used for drawing."),System.ComponentModel.DefaultValue(false)]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Appearance"),DefaultValue(4),Description("Indicates margin in pixels between the edge of the container and the items contained inside of it")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Indicates whether text on sub items is wrapped on new line if it cannot fit the space available."),System.ComponentModel.DefaultValue(true)]
		...
		internal static void SetDesignTimeDefaults(ButtonItem button, ExplorerBarStockStyle e)
		{
			BarFunctions.SetExplorerBarStyle(button,e);
			button.Text="New Button";
			button.ButtonStyle = HVTTButtonStyle.ImageAndText;
			button.ImagePosition=ImagePosition.Left;
			button.HotTrackingStyle=HotTrackingStyle.None;
		...
		{
			this.StockStyle = ExplorerBarStockStyle.SystemColors;
			this.BackStyle.BackColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarBackground;
			this.BackStyle.BorderLeft =StyleBorderType.Solid;
			this.BackStyle.BorderRight =StyleBorderType.Solid;
			this.BackStyle.BorderTop =StyleBorderType.Solid;
			this.BackStyle.BorderBottom =StyleBorderType.Solid;
			...
			this.TitleStyle.BackColor2SchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarBackground2;
