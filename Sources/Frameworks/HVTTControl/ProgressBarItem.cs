    ...
    public class ProgressBarItem : ImageItem, IPersonalizedMenuItem
    {
        ...
        public override void Paint(ItemPaintArgs pa)
        {
            ...
            else
            {
                ...
                switch (this.Style)
                {
                    case HVTTControlStyle.OfficeXP:
                        {
                    ...
                    case HVTTControlStyle.Office2000:
                        {
                            // Simple Progress Bar
                            Region oldClip = g.Clip;
                            g.SetClip(rect, CombineMode.Intersect);
                    ...
                    case HVTTControlStyle.Office2003:
                    case HVTTControlStyle.VS2005:
                        {
                            // Bar progress
                            int chunkWidth = (int)Math.Floor(rect.Height * chunkFraction);
                            if (chunkWidth <= 0)
        ...
        public override void RecalcSize()
        {
            ...
            if ((m_Width == 0 || m_Height == 0) && m_TextVisible)
            {
                ...
                try
                {
                    ...
                    if (backgroundStyle.Border != StyleBorderType.None)
                        objStringSize.Width += 4;
        ...
        private ColorScheme GetColorScheme()
        {
            ...
            if (cc is HVTTMarkStatus)
                scheme = ((HVTTMarkStatus)cc).ColorScheme;
        ...
        private ElementStyle GetBackgroundStyle()
        {
            ...
            if (this.Style == HVTTControlStyle.Office2000 || this.Style == HVTTControlStyle.OfficeXP)
            {
            ...
            else if (this.Style == HVTTControlStyle.Office2003 || this.Style == HVTTControlStyle.VS2005 || BarFunctions.IsOffice2007Style(this.Style))
            {
                ColorScheme scheme = null;
            ...
            style.TextLineAlignment = StyleTextAlignment.Center;
        ...
        /// </summary>
        [HVTTBrowsable(true), Browsable(true), Description("Gets or sets the current position of the progress bar."), Category("Behavior"), DefaultValue(0)]
        public int Value
        {
            get { return m_Value; }
            set
        ...
        /// </summary>
        [HVTTBrowsable(true), Browsable(true), Description("Gets or sets the amount by which a call to the PerformStep method increases the current position of the progress bar."), Category("Behavior"), DefaultValue(1)]
        public int Step
        {
            get
            {
        ...
        /// </summary>
        [HVTTBrowsable(true), Browsable(true), Description("Gets or sets whether the text inside the progress bar is displayed."), Category("Behavior"), DefaultValue(false)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), DefaultValue(96), System.ComponentModel.Category("Layout"), System.ComponentModel.Description("Indicates the width of the label in pixels.")]
        public int Width
        {
            get
            {
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Appearance"), Description("Gets or sets the color of the progress chunk.")]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Appearance"), Description("Gets or sets the target gradient color of the progress chunk.")]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Appearance"), Description("Gets or sets the gradient angle of the progress chunk."), DefaultValue(0)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(false), DefaultValue(eProgressBarItemColor.Normal), Category("Appearance"), Description("Indicates predefined color of item when Office 2007 style is used.")]
