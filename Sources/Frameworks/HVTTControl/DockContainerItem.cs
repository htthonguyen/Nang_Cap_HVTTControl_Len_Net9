...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[System.ComponentModel.ToolboxItem(false),System.ComponentModel.DesignTimeVisible(false),Designer(typeof(Design.DockContainerItemDesigner))]
	public class DockContainerItem:ImageItem
	{
        ...
        private TabItemColor m_PredefinedTabColor = TabItemColor.Default;
		...
		{
			m_SupportedOrientation=HVTTSupportedOrientation.Both;
			this.Stretch=true;
		...
		protected internal override void Serialize(ItemSerializationContext context)
		{
            ...
            if(m_PredefinedTabColor!=TabItemColor.Default)
		...
		protected internal override void Deserialize(ItemSerializationContext context)
		{
            ...
            if (ItemXmlSource.HasAttribute("PredefinedTabColor"))
                m_PredefinedTabColor = (TabItemColor)System.Xml.XmlConvert.ToInt32(ItemXmlSource.GetAttribute("PredefinedTabColor"));
            else
                m_PredefinedTabColor = TabItemColor.Default;
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(false),DefaultValue(null),Description("Indicates the control hosted on dockable window"),Category("Docking")]
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DefaultValue(""),Category("Design"),Description("Indicates item category used to group similar items at design-time.")]
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DefaultValue(false),Category("Behavior"),Description("Gets or sets whether Click event will be auto repeated when mouse button is kept pressed over the item.")]
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DefaultValue(600),Category("Behavior"),Description("Gets or sets the auto-repeat interval for the click event when mouse button is kept pressed over the item.")]
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DefaultValue(""),Category("Design"),Description("Indicates description of the item that is displayed during design.")]
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DefaultValue(eItemAlignment.Near),Category("Appearance"),Description("Determines alignment of the item inside the container.")]
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DefaultValue(true),Category("Behavior"),Description("Determines whether sub-items are displayed.")]
...
//		}
		...
		public override void Paint(ItemPaintArgs pa)
		{
			...
			//if(bOnMenu && this.Style==HVTTControlStyle.OfficeXP)
			//{
		...
		public override void RecalcSize()
		{
			...
			Size objImageSize=GetMaxImageSize();
			if(this.IsOnMenu && this.Style!=HVTTControlStyle.Office2000)
			{
...
//		}
		...
		public override bool Visible
		{
			get
			{
				if(this.IsOnMenu)
					return false;
				HVTTMarkStatus objTlb=this.ContainerControl as HVTTMarkStatus;
				if(objTlb!=null)
				{
					if(objTlb.BarState==HVTTBarState.Docked || objTlb.BarState==HVTTBarState.Floating || objTlb.BarState==HVTTBarState.AutoHide)
						return base.Visible;
					else
						return false;
				}
        ...
        /// </summary>
        [Browsable(true),HVTTBrowsable(true),DefaultValue(null),Category("Appearance"),Description("Specifies the Tab image. Image specified here is used only on Tab when there are multiple dock containers on Bar.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(-1),Category("Appearance"),Description("Specifies the index of the Tab image if ImageList is used. Image specified here is used only on Tab when there are multiple dock containers on Bar."),System.ComponentModel.Editor(typeof(HVTT.UI.Editors.ImageIndexEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.TypeConverter(typeof(System.Windows.Forms.ImageIndexConverter))]
        ...
        /// <summary>
        /// Gets or sets the predefined tab color. Default value is TabItemColor.Default which means that default color is used.
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), DefaultValue(TabItemColor.Default), Category("Style"), Description("Applies predefined color to tab.")]
        public TabItemColor PredefinedTabColor
        {
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DefaultValue(0),Category("Layout"),Description("Indicates the width of the item in pixels."), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public int Width
		{
			get
			{
			...
			set
			{
				...
				if(value>=m_MinimumSize.Width)
				{
					...
					if(parent!=null && parent.SystemContainer && bar!=null && bar.LayoutType==HVTTLayoutType.DockContainer && bar.Stretch)
					{
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(true),DefaultValue(0),Category("Layout"),Description("Indicates height of the item in pixels."), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public int Height
		{
			get
			{
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),Category("Layout"),Description("Gets or sets the minimum size of the item.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Layout"),System.ComponentModel.Description("Gets or sets the default floating size of the Bar that is containing this item.")]
		...
		/// </summary>
		[Obsolete("This property is obsolete and it will be removed in next version"), EditorBrowsable(EditorBrowsableState.Never),Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(64),System.ComponentModel.Category("Layout"),System.ComponentModel.Description("Gets or sets the minimum size of the form client area that is tried to maintain when dockable window is resized."), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Category("Behavior"),Description("Indicates whether item can be customized by user.")]
		...
		{
			base.OnTextChanged();
			if(this.ContainerControl is HVTTMarkStatus /*&& !this.Displayed*/) // Refresh Tab Text even when dock container item is selected.
				((HVTTMarkStatus)this.ContainerControl).RefreshDockContainerItem(this);
		}

        protected override void OnTooltipChanged()
        {
            base.OnTooltipChanged();
            if (this.ContainerControl is HVTTMarkStatus) // Refresh Tab Tooltip even when dock container item is selected.
                ((HVTTMarkStatus)this.ContainerControl).RefreshDockContainerItem(this);
        }
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), DefaultValue(false), Category("Behavior"), Description("Indicates whether certain global properties are propagated to all items with the same name when changed.")]
