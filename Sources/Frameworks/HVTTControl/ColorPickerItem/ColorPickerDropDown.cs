...
namespace HVTT.UI.Window.Forms
{
    ...
    public class ColorPickerDropDown : ButtonItem
    {
        ...
        /// </summary>
        [Browsable(true), DefaultValue(true), HVTTBrowsable(true), DevCoSerialize(), Category("Appearance"), Description("Indicates whether theme colors are displayed on drop-down.")]
        ...
        /// </summary>
        [Browsable(true), DefaultValue(true), HVTTBrowsable(true), DevCoSerialize(), Category("Appearance"), Description("Indicates whether standard colors are displayed on drop-down.")]
        ...
        /// </summary>
        [Browsable(true), DefaultValue(true), HVTTBrowsable(true), DevCoSerialize(), Category("Appearance"), Description("Indicates more colors menu item is visible which allows user to open Custom Colors dialog box.")]
        ...
        ///// </summary>
        //[DefaultValue(true), Browsable(true), HVTTBrowsable(true), Category("Behavior"), Description("Indicates whether the item will auto-expand (display pop-up menu or toolbar) when clicked.")]
        ...
        private void InitializeColorDropDown()
        {
            ...
            if (m_DisplayThemeColors)
            {
                ...
                label.PaddingTop = 1;
                label.BorderSide = BorderSide.Bottom;
        ...
        private void AddColors(ArrayList colors)
        {
            ...
            for (int i = 0; i < colors.Count; i++)
            {
                ...
                cont.Orientation = HVTTOrientation.Horizontal;
        ...
        public void UpdateSelectedColorImage()
        {
            ...
            using (Graphics g = Graphics.FromImage(bmp))
            {
                ...
                using (SolidBrush b = new SolidBrush(this.SelectedColor))
                {
                    g.FillRectangle(b, r);
                }
        ...
        private ArrayList GetThemeColors()
        {
        ...
        private ArrayList GetStandardColors()
        {
            ArrayList colors = new ArrayList();
            colors.Add(new ColorItem[] {
                GetColorItem("BA1419"),
        ...
        protected virtual void OnSelectedColorChanged(EventArgs e)
        {
            ...
            HVTTManager manager = this.GetOwner() as HVTTManager;
            if (manager != null)
