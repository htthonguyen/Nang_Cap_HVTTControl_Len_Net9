...
{
    /// <summary>
    /// Represents color item used for color picker control. Color item can only be used as part of the color picker HVTTCONTROLS feature.
    /// </summary>
    public class ColorItem : BaseItem
    {
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), DevCoSerialize(), Category("Appearance"), Description("Indicates the color represented by this item.")]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), DevCoSerialize(), Category("Appearance"), Description("Indicates the size of the item when displayed.")]
        ...
        /// on all four sides.
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), DefaultValue(eColorItemBorder.All), Description("Indicate border drawn around the item"), DevCoSerialize()]
