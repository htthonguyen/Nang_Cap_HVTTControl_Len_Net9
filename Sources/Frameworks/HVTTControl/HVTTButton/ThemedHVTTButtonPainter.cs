...
namespace HVTT.UI.Window.Forms
{
    ...
    /// </summary>
    internal class ThemedHVTTButtonPainter
    {
        public static void PaintButton(ButtonItem button, ItemPaintArgs pa)
        {
            ...
            ThemHVTTButtonStates state = ThemHVTTButtonStates.PushButtonNormal;
            ...
            {
                state = ThemHVTTButtonStates.PushButtonDisabled;
            }
            else if (button.IsMouseDown || button.Expanded)
            {
                state = ThemHVTTButtonStates.PushButtonPressed;
            }
            ...
            {
                state = ThemHVTTButtonStates.PushButtonHot;
            }
            else if (button.Checked || button.Expanded)
            {
                ...
                state = ThemHVTTButtonStates.PushButtonDefaulted;
            ...
            {
                if (state == ThemHVTTButtonStates.PushButtonNormal && button.HotTrackingStyle == HotTrackingStyle.Color)
                {
                ...
                else if (state == ThemHVTTButtonStates.PushButtonNormal && !image.IsIcon)
                {
            ...
            // Draw Text
            if (button.ButtonStyle == HVTTButtonStyle.ImageAndText || button.ButtonStyle == HVTTButtonStyle.TextOnlyAlways || image == null)
            {
        ...
        private static eTextFormat GetStringFormat(ButtonItem button, ItemPaintArgs pa, CompositeImage image)
        {
            ...
            if (!isOnMenu)
            {
                if (image == null || button.ImagePosition == ImagePosition.Top || button.ImagePosition == ImagePosition.Bottom)
