...
namespace HVTT.UI.Window.Forms
{
    ...
    public class ButtonItem:PopupItem,IPersonalizedMenuItem
    {
		...
		private HVTTButtonStyle m_ButtonStyle;
		...
		private HotTrackingStyle m_HotTrackingStyle=HotTrackingStyle.Default;
        ...
        public ButtonItem(string sItemName, string ItemText):base(sItemName,ItemText)
        {
            m_IsContainer=false;
			m_Image=null;
			m_ImageIndex=-1;
			...
			m_MouseOver=false;
            m_MouseDown=false;
			m_ButtonStyle=HVTTButtonStyle.Default;
			m_ImagePosition=ImagePosition.Left;
			m_Font=null;
		...
		protected internal override void Serialize(ItemSerializationContext context)
		{
			...
			if(m_HotTrackingStyle!=HotTrackingStyle.Default)
		...
		protected internal override void Deserialize(ItemSerializationContext context)
		{
			...
			m_ImagePosition=(ImagePosition)System.Xml.XmlConvert.ToInt32(ItemXmlSource.GetAttribute("ImagePosition"));
			m_ButtonStyle=(HVTTButtonStyle)System.Xml.XmlConvert.ToInt32(ItemXmlSource.GetAttribute("ButtonStyle"));
			...
			if(ItemXmlSource.HasAttribute("hottrack"))
				m_HotTrackingStyle=(HotTrackingStyle)System.Xml.XmlConvert.ToInt32(ItemXmlSource.GetAttribute("hottrack"));
			else
				m_HotTrackingStyle=HotTrackingStyle.Default;
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The alignment of the image in relation to text displayed by this item."),System.ComponentModel.DefaultValue(ImagePosition.Left)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(false), DefaultValue(eButtonColor.Orange), Category("Appearance"), Description("Indicates predefined color of button when Office 2007 style is used.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Determines the style of the button."),System.ComponentModel.DefaultValue(HVTTButtonStyle.Default)]
		public HVTTButtonStyle ButtonStyle
		{
			get
			{
		...
		/// </summary>
		[DefaultValue(false),Browsable(true),HVTTBrowsable(true),Category("Behavior"),Description("Indicates whether the item will auto-expand (display pop-up menu or toolbar) when clicked.")]
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Appearance"),Description("Specifies the Button icon. Icons support multiple image sizes and alpha blending."),DefaultValue(null)]
		...
		/// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Appearance"), Description("The image that will be displayed on the face of the item."), DefaultValue(null)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Appearance"), Description("Specifies the small Button image used by Ribbon control when small image variant is needed"), DefaultValue(null)]
        public System.Drawing.Image ImageSmall
        {
            ...
            {
                m_ImageSmall = value;
                if (!m_ImageSizeOverride.IsEmpty || m_UseSmallImage)
                {
                    NeedRecalcSize = true;
                    OnAppearanceChanged();
                    OnImageChanged();
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The image list image index of the image that will be displayed on the face of the item."),System.ComponentModel.Editor(typeof(HVTT.UI.Editors.ImageIndexEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.TypeConverter(typeof(System.Windows.Forms.ImageIndexConverter)),System.ComponentModel.DefaultValue(-1)]
		public int ImageIndex
		{
			...
			set
			{
				...
				if(m_ImageIndex!=value)
				{
					...
					//	throw(new System.InvalidOperationException("Owner HVTTManager is not set. Add containing bar do the bars collection first."));
					m_ImageIndex=value;
                    if(ShouldSyncProperties)
		...
		public override void OnImageChanged()
		{
			...
			if(img!=null)
			{
				if(m_Image!=null)
				{
					...
					if(iImageSize!=null && iImageSize.ImageSize!=BarImageSize.Default)
					{
						if(iImageSize.ImageSize==BarImageSize.Medium)
						{
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The image list image index of the image that will be displayed when mouse hovers over the item."),System.ComponentModel.Editor(typeof(HVTT.UI.Editors.ImageIndexEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.TypeConverter(typeof(System.Windows.Forms.ImageIndexConverter)),System.ComponentModel.DefaultValue(-1)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The image list image index of the image that will be displayed when item is pressed."),System.ComponentModel.Editor(typeof(HVTT.UI.Editors.ImageIndexEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.TypeConverter(typeof(System.Windows.Forms.ImageIndexConverter)),System.ComponentModel.DefaultValue(-1)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The image list image index of the image that will be displayed when item is disabled."),System.ComponentModel.Editor(typeof(HVTT.UI.Editors.ImageIndexEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.TypeConverter(typeof(System.Windows.Forms.ImageIndexConverter)),System.ComponentModel.DefaultValue(-1)]
		...
		public override void Paint(ItemPaintArgs p)
		{
			...
			try
			{
				...
				try
				{
                    ...
                    if (m_Style == HVTTControlStyle.Office2000 && !this.IsThemed)
                        PaintOffice(p);
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (m_Style == HVTTControlStyle.Office2000)
                                    PaintOffice(p);
                                else
                                    PaintDotNet(p);
                            }
		...
		private void PaintDotNet(ItemPaintArgs pa)
		{
			...
			else if(mouseOver /*&& m_Checked*/ && !m_Expanded && /*!bIsOnMenu &&*/ m_HotTrackingStyle!=HotTrackingStyle.Image)
			...
			if(objImage!=null)
			{
				...
				if(!bIsOnMenu && (m_ImagePosition==ImagePosition.Top || m_ImagePosition==ImagePosition.Bottom))
			...
			if(GetEnabled(pa.ContainerControl) || this.DesignMode)
			{
				...
				{					
					...
					Point[] p;
					if(m_Orientation==HVTTOrientation.Horizontal && this.PopupSide==PopupSide.Default)
						p=new Point[4];
					else
						p=new Point[5];
					p[0].X=itemRect.Left;
					...
					p[1].X=itemRect.Left;
					p[1].Y=itemRect.Top;
					if(m_Orientation==HVTTOrientation.Horizontal /*&& !pa.Colors.ItemExpandedShadow.IsEmpty*/)
					...
					if(m_Orientation==HVTTOrientation.Vertical || this.PopupSide!=PopupSide.Default)
					{
						p[4].X=itemRect.Left;
					...
					// Draw the shadow
					if(!pa.Colors.ItemExpandedShadow.IsEmpty && m_Orientation==HVTTOrientation.Horizontal)
					{
				...
				if((mouseOver && m_HotTrackingStyle!=HotTrackingStyle.None) || m_Expanded && !bIsOnMenu)
				{
					...
					if(!m_Expanded || bIsOnMenu)
					{
						...
						else
						{
							if(m_MouseDown)
							{
								if(m_HotTrackingStyle==HotTrackingStyle.Image)
								{
									r=rect;
									r.Inflate(2,2);
								}
							...
							else if(m_HotTrackingStyle==HotTrackingStyle.Image && !rect.IsEmpty)
							{
					...
					if(objImage!=null && m_ButtonStyle!=HVTTButtonStyle.TextOnlyAlways)
					{
						...
						{
							if(NativeFunctions.ColorDepth>=16 && m_Style!=HVTTControlStyle.Office2003)
							{
							...
							{
								if(m_Style==HVTTControlStyle.OfficeXP)
									rect.Offset(-1,-1);
								//g.DrawImage(objImage,rect);
								objImage.DrawImage(g,rect);
							}
				...
				else
				{
					if(objImage!=null && m_ButtonStyle!=HVTTButtonStyle.TextOnlyAlways)
					{
						...
						{
							if(m_HotTrackingStyle!=HotTrackingStyle.Color)
							{
								objImage.DrawImage(g,rect);
							}
							else
						...
						else
						{
							if((m_Checked && bIsOnMenu || !this.Expanded) && !this.IsOnCustomizeDialog)
							{
								...
								else if(m_HotTrackingStyle==HotTrackingStyle.Image)
								{
									r=rect;
									r.Inflate(2,2);
								}
								...
								if(bIsOnMenu)
									r.Inflate(-1,-1);
								Color clr;
								if(mouseOver && m_HotTrackingStyle!=HotTrackingStyle.None)
								{
				...
				if(m_Checked && !this.IsOnCustomizeMenu && !this.IsOnCustomizeDialog)
				{
					...
					if((objImage==null || m_ButtonStyle==HVTTButtonStyle.TextOnlyAlways) && bIsOnMenu)
					{
						// Draw checker...
			...
			{
				if(bIsOnMenu && mouseOver && m_HotTrackingStyle==HotTrackingStyle.Default)
				{
			...
			// Draw menu item text
			if(bIsOnMenu || m_ButtonStyle!=HVTTButtonStyle.Default || objImage==null || (!bIsOnMenu && (m_ImagePosition==ImagePosition.Top || m_ImagePosition==ImagePosition.Bottom)) /*|| !this.IsOnBar*/) // Commented out becouse it caused text to be drawn if item is not on bar no matter what
			{
				if(bIsOnMenu)
				...
				{
					rect=m_TextDrawRect;
					if(m_ImagePosition==ImagePosition.Top || m_ImagePosition==ImagePosition.Bottom)
					{
					...
					if(m_MouseDown && m_HotTrackingStyle!=HotTrackingStyle.Image)
					{
						if(m_ForeColor.IsEmpty)
						{
				...
				if(m_Orientation==HVTTOrientation.Vertical && !bIsOnMenu)
				{
			...
			if((this.SubItems.Count>0 || this.PopupType==ePopupType.Container) && this.ShowSubItems)
			{
				...
				{
					if(GetEnabled(pa.ContainerControl) && ((mouseOver || m_Checked) && !m_Expanded && m_HotTrackingStyle!=HotTrackingStyle.None && m_HotTrackingStyle!=HotTrackingStyle.Image))
					{
					...
					Point[] p=new Point[3];
					if(this.PopupSide==PopupSide.Default)
					{
						if(m_Orientation==HVTTOrientation.Horizontal)
						{
		...
		private void PaintThemed(ItemPaintArgs pa)
		{
			...
			if(m_HotTrackingStyle==HotTrackingStyle.Image && image!=null)
			{
				backRect=rectImage;
			...
			// Draw Button Background
			if(m_HotTrackingStyle!=HotTrackingStyle.None)
			{
				theme.DrawBackground(g,part,state,backRect);
			}

			// Draw Image
			if(image!=null && m_ButtonStyle!=HVTTButtonStyle.TextOnlyAlways)
			{
				if(state==ThemeToolbarStates.Normal && m_HotTrackingStyle==HotTrackingStyle.Color)
				{
					// Draw gray-scale image for this hover style...
					float[][] array = new float[5][];
					array[0] = new float[5] {0.2125f, 0.2125f, 0.2125f, 0, 0};
			...
			// Draw Text
			if(m_ButtonStyle==HVTTButtonStyle.ImageAndText || m_ButtonStyle==HVTTButtonStyle.TextOnlyAlways || image==null /*|| !this.IsOnBar*/) // Commented out becouse it caused text to be drawn if item is not on bar no matter what
			{
			...
			if(bSplitButton)
			{
				...
				if(m_HotTrackingStyle!=HotTrackingStyle.None && m_HotTrackingStyle!=HotTrackingStyle.Image && GetEnabled(pa.ContainerControl))
				{
		...
		private void PaintOffice(ItemPaintArgs pa)
		{
			...
			Font objFont=null;
			bool bIsOnMenu=pa.IsOnMenu;
            bool HVTTButton = pa.ContainerControl is HVTTButton;
			...
			// Draw background
			if(bIsOnMenu && !this.DesignMode && this.MenuVisibility==HVTTMenuVisibility.VisibleIfRecentlyUsed && !this.RecentlyUsed)
			...
			if(GetEnabled(pa.ContainerControl) || this.DesignMode)
			{
				...
				if((m_MouseOver && m_HotTrackingStyle!=HotTrackingStyle.None) || m_Expanded || m_Checked && !this.IsOnCustomizeMenu && !this.IsOnCustomizeDialog)
				{
					//if(m_ButtonType!=eButtonType.Label)
					{
						...
						{
							if((m_MouseOver && m_HotTrackingStyle!=HotTrackingStyle.None) || m_Expanded)
							{
						...
						if(objImage!=null && m_ButtonStyle!=HVTTButtonStyle.TextOnlyAlways)
						{
							...
							//if(m_ImagePosition==ImagePosition.Right)
						...
						else if((objImage==null || m_ButtonStyle==HVTTButtonStyle.TextOnlyAlways) && m_Checked && !this.IsOnCustomizeMenu && !this.IsOnCustomizeDialog && bIsOnMenu)
						{
							// Draw checked box
							rTmp=new Rectangle(m_ImageDrawRect.X,m_ImageDrawRect.Y,m_ImageDrawRect.Width,itemRect.Height);
							rTmp.Offset(itemRect.Left,itemRect.Top);
				...
				else
				{
					if(objImage!=null && m_ButtonStyle!=HVTTButtonStyle.TextOnlyAlways)
					{
						...
						else if(m_HotTrackingStyle==HotTrackingStyle.Color)
						{
							// Draw gray-scale image for this hover style...
							float[][] array = new float[5][];
							array[0] = new float[5] {0.2125f, 0.2125f, 0.2125f, 0, 0};
			...
			// Draw menu item text
			if(bIsOnMenu || m_ButtonStyle!=HVTTButtonStyle.Default || objImage==null || (!bIsOnMenu && (m_ImagePosition==ImagePosition.Top || m_ImagePosition==ImagePosition.Bottom)))
			{
				if(bIsOnMenu)
				...
				else
				{
					...
					if(m_ImagePosition==ImagePosition.Top || m_ImagePosition==ImagePosition.Bottom)
					{
						if(m_Orientation==HVTTOrientation.Horizontal)
							rect=new Rectangle(m_TextDrawRect.X,m_TextDrawRect.Y,itemRect.Width,m_TextDrawRect.Height);
						if((this.SubItems.Count>0 || this.PopupType==ePopupType.Container) && m_Orientation==HVTTOrientation.Horizontal && this.ShowSubItems)
	                        rect.Width-=12;
				...
				if(((m_MouseOver && m_HotTrackingStyle!=HotTrackingStyle.None) || m_Expanded) && bIsOnMenu && !this.DesignMode)
			...
			if((this.SubItems.Count>0 || this.PopupType==ePopupType.Container) && this.ShowSubItems)
			{
				...
				{
					if(m_MouseOver && !m_Expanded && m_HotTrackingStyle!=HotTrackingStyle.None)
					{
		...
		internal CompositeImage GetImage()
		{
			...
			else if(m_MouseDown || this.Checked || this.Expanded && m_HotTrackingStyle== HotTrackingStyle.Image)
		...
		internal CompositeImage GetImage(ImageState state)
		{
			...
			if(state==ImageState.Disabled && (m_DisabledImage!=null || m_DisabledImageIndex>=0 || m_DisabledIcon!=null || m_Image!=null || m_ImageIndex>=0 || m_Icon!=null))
			{
				...
				if(m_DisabledImageIndex>=0)
				{
                    ...
                    //if (imgList != null)
                    //    return new CompositeImage(m_DisabledImageIndex, imgList);
					image=GetImageFromImageList(m_DisabledImageIndex);
					if(image!=null)
						return new CompositeImage(image,false,m_ImageSizeOverride);
					return null;
				}
			...
			if(state==ImageState.Hover && (m_HoverImage!=null || m_HoverImageIndex>=0))
			{
				...
				if(m_HoverImageIndex>=0)
				{
                    //ImageList imgList = GetImageList();
                    //if (imgList != null)
                    //    return new CompositeImage(m_HoverImageIndex, imgList);
			...
			if(state==ImageState.Pressed && (m_PressedImage!=null || m_PressedImageIndex>=0))
			{
				...
				if(m_PressedImageIndex>=0)
				{
                    //ImageList imgList = GetImageList();
                    //if (imgList != null)
                    //    return new CompositeImage(m_PressedImageIndex, imgList);
            ...
            if (m_ImageSmall != null && (m_UseSmallImage || m_ImageSizeOverride.Width == m_ImageSmall.Width && m_ImageSizeOverride.Height == m_ImageSmall.Height))
			...
			if(m_ImageIndex>=0)
			{
                //ImageList imgList = GetImageList();
                //if (imgList != null)
                //    return new CompositeImage(m_ImageIndex, imgList);
        ...
        //            if (iImageSize != null && iImageSize.ImageSize != BarImageSize.Default)
        //            {
        //                if (iImageSize.ImageSize == BarImageSize.Medium && owner.ImagesMedium != null)
        //                    return owner.ImagesMedium;
        //                else if (iImageSize.ImageSize == BarImageSize.Large && owner.ImagesLarge != null)
        //                    return owner.ImagesLarge;
        //                else if (owner.Images != null)
        //                    return owner.Images;
        //            }
        //            else if (m_Parent is SideBarPanelItem && ((SideBarPanelItem)m_Parent).ItemImageSize != BarImageSize.Default)
        //            {
        //                BarImageSize imgSize = ((SideBarPanelItem)m_Parent).ItemImageSize;
        //                if (imgSize == BarImageSize.Medium && owner.ImagesMedium != null)
        //                    return owner.ImagesMedium;
        //                else if (imgSize == BarImageSize.Large && owner.ImagesLarge != null)
        //                    return owner.ImagesLarge;
        //                else if (owner.Images != null)
        //                    return owner.Images;
        //            }
			...
			if(ImageIndex>=0)
			{
				...
				if(owner!=null)
				{
					try
					{
						if(iImageSize!=null && iImageSize.ImageSize!=BarImageSize.Default)
						{
							if(iImageSize.ImageSize==BarImageSize.Medium && owner.ImagesMedium!=null) // && owner.ImagesMedium.Images.Count>0 && ImageIndex<owner.ImagesMedium.Images.Count)
								return owner.ImagesMedium.Images[ImageIndex];
							else if(iImageSize.ImageSize==BarImageSize.Large && owner.ImagesLarge!=null) // && owner.ImagesLarge.Images.Count>0  && ImageIndex<owner.ImagesLarge.Images.Count)
						...
						{
							BarImageSize imgSize=((SideBarPanelItem)m_Parent).ItemImageSize;
							if(imgSize==BarImageSize.Medium && owner.ImagesMedium!=null) // && owner.ImagesMedium.Images.Count>0 && ImageIndex<owner.ImagesMedium.Images.Count)
								return owner.ImagesMedium.Images[ImageIndex];
							else if(imgSize==BarImageSize.Large && owner.ImagesLarge!=null) // && owner.ImagesLarge.Images.Count>0  && ImageIndex<owner.ImagesLarge.Images.Count)
								return owner.ImagesLarge.Images[ImageIndex];
							else if(owner.Images!=null)// && owner.Images.Images.Count>0 && ImageIndex<owner.Images.Images.Count)
								return owner.Images.Images[ImageIndex];
						}
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(false)]
		...
		/// </summary>
        [Browsable(true), HVTTBrowsable(false), Description("Indicates fixed size of the button."), Category("Layout")]
        public System.Drawing.Size FixedSize
		{
			...
			get
			{
				...
				try
				{
					if(iImageSize!=null && iImageSize.ImageSize!=BarImageSize.Default)
					{
						if(iImageSize.ImageSize==BarImageSize.Medium)
							size=new Size(24,24);
						else if(iImageSize.ImageSize==BarImageSize.Large)
							size=new Size(32,32);
					}
					else if(m_Parent is SideBarPanelItem && ((SideBarPanelItem)m_Parent).ItemImageSize!=BarImageSize.Default)
					{
						BarImageSize imgSize=((SideBarPanelItem)m_Parent).ItemImageSize;
						if(imgSize==BarImageSize.Medium)
							size=new Size(24,24);
						else if(imgSize==BarImageSize.Large)
							size=new Size(32,32);
					}
				}
				catch(Exception)
...
//			else
//				objImageSize=this.ImageSize;
//			if(_FitContainer && bHasImage && (m_ImagePosition==ImagePosition.Left || m_ImagePosition==ImagePosition.Right))
//			{
...
//			if(m_Text!="")
//			{
//                if (m_Orientation == HVTTOrientation.Vertical && !this.IsOnMenu)
...
//			{
//				bool bThemed=this.IsThemed;
//				if(m_Orientation==HVTTOrientation.Horizontal && (m_ImagePosition==ImagePosition.Left || m_ImagePosition==ImagePosition.Right))
//				{
...
//
//					m_ImageDrawRect=Rectangle.Empty;
//					if(m_ButtonStyle!=HVTTButtonStyle.TextOnlyAlways && bHasImage)
//					{
//						// We know the image position now, we will center it into this area
//						m_ImageDrawRect=new Rectangle(0,(m_Rect.Height-objImageSize.Height)/2,objImageSize.Width,objImageSize.Height);
//					}
...
//					m_TextDrawRect=Rectangle.Empty;
//					if(m_ButtonStyle!=HVTTButtonStyle.Default || !bHasImage)
//					{
...
//
//					if(m_ImagePosition==ImagePosition.Right && m_ImageDrawRect.Right>0)
//					{
//						m_TextDrawRect.X=3;
...
//						m_Rect.Height+=m_VerticalPadding;
//
//						if(m_ImagePosition==ImagePosition.Top)
//						{
...
//					else
//					{
//						if(objStringSize.Height>objImageSize.Width && m_ButtonStyle!=HVTTButtonStyle.Default)
...
//							m_Rect.Height=objImageSize.Height+6;
//
//						if(m_ImagePosition==ImagePosition.Top || m_ImagePosition==ImagePosition.Left)
//						{
//							if(bHasImage)
...
//			objCtrl=null;
		...
		private void RecalcSizeOffice()
		{
			...
			else
			{
				...
				else
				{
					...
					{
						// Calculate width, that is easy
						if(objStringSize.Height>objImageSize.Height && m_ButtonStyle!=HVTTButtonStyle.Default)
							m_Rect.Width=(int)objStringSize.Height+6;
						else
							m_Rect.Width=objImageSize.Width+6;
        ...
        private void SetMouseOver(bool value)
        {
            if (value != m_MouseOver)
            {
                ...
                bool fadeEnabled = IsFadeEnabled && this.GetEnabled() && this.Displayed && this.Visible && this.WidthInternal>0 && this.HeightInternal>0;
                if (fadeEnabled)
                {
        ...
        private Bitmap GetCurrentStateImage()
        {
            ...
            try
            {
                ...
                else if (cc is HVTTMarkStatus)
                {
                    antiAlias = ((HVTTMarkStatus)cc).AntiAlias;
                    pa = ((HVTTMarkStatus)cc).GetItemPaintArgs(g);
                }
                else if (cc is HVTTButton)
                {
                    antiAlias = ((HVTTButton)cc).AntiAlias;
                    pa = ((HVTTButton)cc).GetItemPaintArgs(g);
                }
        ...
        private bool IsFadeEnabled
        {
            get
            {
                if (this.DesignMode || m_HotTrackingStyle == HotTrackingStyle.None)
                    return false;
                System.Windows.Forms.Control cc = this.ContainerControl as System.Windows.Forms.Control;
                if (cc != null)
                {
                    if(cc is ItemControl)
                        ...
                        return ((HVTTMarkStatus)cc).IsFadeEnabled;
                    else if (cc is HVTTButton)
                        return ((HVTTButton)cc).IsFadeEnabled;
                }
                return false; 
            }
        }
		...
		public override void InternalMouseHover()
		{
			...
			if((this.SubItems.Count>0 || (this.PopupType==ePopupType.Container && !this.IsOnCustomizeMenu)) && this.IsOnMenu && this.ShowSubItems)
			{
        ...
        protected virtual void ButtonMouseDown(System.Windows.Forms.MouseEventArgs objArg)
        {
            ...
            if ((this.IsOnMenuBar || ShouldAutoExpandOnClick) && !this.DesignMode)
            {
                ...
                {
                    if ((this.ShowSubItems || ShouldAutoExpandOnClick) && (this.SubItems.Count > 0 || this.PopupType == ePopupType.Container))
                    {
                        if (this.Expanded)
                        {
        ...
        internal override void DoAccesibleDefaultAction()
        {
            if (this.VisibleSubItems > 0 && (this.IsOnMenu || this.IsOnMenuBar || _AccessibleExpandAction || ShouldAutoExpandOnClick))
            {
                ...
                this.RaiseClick(EventSource.Keyboard);
        }
		...
		public override void InternalDoubleClick(System.Windows.Forms.MouseButtons mb, System.Drawing.Point mpos)
		{
			...
			if(this.Expanded && this.IsOnMenuBar 
				...
				(this.PersonalizedMenus==HVTTPersonalizedMenus.Both || this.PersonalizedMenus==HVTTPersonalizedMenus.DisplayOnClick))
			{
...
//		}
		private void CreateDisabledImage()
		{
			...
			if(this.GetOwner() is IOwner && ((IOwner)this.GetOwner()).DisabledImagesGrayScale)
			{
				...
				{
					m_DisabledImage=BarFunctions.CreateDisabledBitmap(defaultImage.Image as Bitmap);
				}
			}
            ...
            if ((m_Style == HVTTControlStyle.OfficeXP || m_Style == HVTTControlStyle.Office2003 || m_Style == HVTTControlStyle.VS2005 || BarFunctions.IsOffice2007Style(m_Style)) && NativeFunctions.ColorDepth >= 8)
			{
				float[][] array = new float[5][];
				array[0] = new float[5] {0, 0, 0, 0, 0};
				array[1] = new float[5] {0, 0, 0, 0, 0};
...
//            return sfmt;
		...
		internal Font GetFont(ItemPaintArgs pa)
		{
			...
			if(m_MouseOver)
			{
				try
				{
					if(m_HotFontUnderline)
					{
						objFont=new Font(objFont,objFont.Style | System.Drawing.FontStyle.Underline);
						bFontSet=true;
					}
					if(m_HotFontBold)
					{
						objFont=new Font(objFont,objFont.Style | System.Drawing.FontStyle.Bold);
						bFontSet=true;
					}
				}
				catch
				{
					objFont=objFont.Clone() as Font;
				}
			}

			if(!bFontSet && (m_FontBold || m_FontItalic || m_FontUnderline))
			{
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates whether item is checked or not."),System.ComponentModel.DefaultValue(false)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Design"),System.ComponentModel.Description("Gets or set the alternative Shortcut Text.  This text appears next to the Text instead of any shortcuts"),System.ComponentModel.DefaultValue("")]
		...
		/// </summary>
		internal Rectangle SubItemsRect
		{
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Gets or set the Group item belongs to. The groups allows a user to choose from mutually exclusive options within the group."),System.ComponentModel.DefaultValue("")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The foreground color used to display text.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The foreground color used to display text when mouse is over the item.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies that text font is underlined when mouse is over the item."),System.ComponentModel.DefaultValue(false)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies that text font is bold when mouse is over the item."),System.ComponentModel.DefaultValue(false)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies whether the font used to draw the item text is bold."),System.ComponentModel.DefaultValue(false)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies whether the font used to draw the item text is italic."),System.ComponentModel.DefaultValue(false)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies whether the font used to draw the item text is underlined."),System.ComponentModel.DefaultValue(false)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(false),System.ComponentModel.Editor(typeof(ButtonItemEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.Category("Data"),System.ComponentModel.Description("Collection of sub items."),System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Content)]
        ...
        internal Rectangle GetTotalSubItemsRect()
        {
            ...
            if (this.SplitButton && (this.ButtonStyle == HVTTButtonStyle.ImageAndText || this.ImagePosition == ImagePosition.Top || this.ImagePosition == ImagePosition.Bottom)
                && (this.Image != null || this.ImageIndex >= 0) && this.Text.Length > 0)
            {
                ...
                if (r.IsEmpty)
                {
                    ...
                    else if (m_ImagePosition == ImagePosition.Bottom)
                    {
                        r.X = 0;// m_Rect.X - 1;
                        r.Width = m_Rect.Width;
                    }
		...
		/// </summary>
        [System.ComponentModel.Browsable(true), HVTTBrowsable(true), Editor(typeof(Design.TextMarkupUIEditor), typeof(System.Drawing.Design.UITypeEditor)), System.ComponentModel.Category("Appearance"), System.ComponentModel.Description("The text contained in the item."), System.ComponentModel.Localizable(true), System.ComponentModel.DefaultValue("")]
        ...
        /// </summary>
        [Browsable(true), DefaultValue(10), Category("Layout"), Description("Indicates amount of padding added horizontally to the button images when not on menus")]
...
//		}
		...
		public virtual HVTTMenuVisibility MenuVisibility
		{
			get
			{
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates the way item is painting the picture when mouse is over it. Setting the value to Color will render the image in gray-scale when mouse is not over the item."),System.ComponentModel.DefaultValue(HotTrackingStyle.Default)]
        ...
        /// </summary>
        [Browsable(true), DefaultValue(true), Localizable(true), Category("Appearance"), Description("Indicates whether the button text is automatically wrapped over multiple lines when button is used on RibbonBar control.")]
        public bool RibbonWordWrap
        {
