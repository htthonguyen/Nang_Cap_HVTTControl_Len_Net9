...
//			return;
		...
		public static HVTTPopupAnimation SystemMenuAnimation
		{
			get
			{
				bool bRet=false;
				...
				if(bRet)
				{
					...
					if(bRet)
						return HVTTPopupAnimation.Fade;
					else
						return HVTTPopupAnimation.Slide;
				}
				return HVTTPopupAnimation.None;
			}
		}
