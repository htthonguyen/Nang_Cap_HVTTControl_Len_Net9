...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	public enum HVTTControlStyle:int
	{
		OfficeXP=0,
		Office2000=1,
		Office2003=2,
		VS2005,
        //[Obsolete("Office12 style will be removed in next release. Replace it with Office2007")]
        //Office12,
        Office2007,
        HVTTStyle2008,
	}
	...
	/// </summary>
	public enum HVTTGrabHandleStyle:int
	{
		None=0,
		Single=1,
		Dotted=2,
	...
	/// </summary>
	public enum HVTTOrientation:int
	{
		Horizontal=0,
		Vertical=1
	}
	...
	/// </summary>
	public enum HVTTSupportedOrientation:int
	{
		Both=0,
		Horizontal=1,
		Vertical=2
	...
	/// </summary>
	public enum HVTTMenuVisibility:int
	{
		VisibleAlways=0,
	...
	/// </summary>
	public enum HVTTPersonalizedMenus:int
	{
		Disabled=0,
		DisplayOnHover=1,
		DisplayOnClick=2,
	...
	/// </summary>
	public enum HVTTPopupAnimation:int
	{
		None=0,
		ManagerControlled=1,
		Slide=2,
	...
	/// </summary>
	public enum HVTTButtonStyle:int
	{
	...
	/// </summary>
	public enum HotTrackingStyle:int
	{
		Default=0,
		Color=1,
		None=2,
	...
	/// </summary>
	public enum HVTTMenuDropShadow:int
	{
		SystemDefault=0,
		Show=1,
		Hide=2
	...
	internal enum DesignInsertPosition
	{
		None=0,
		Before=1,
		After=2
	...
	public enum HVTTLayoutType:int
	{
		Toolbar=0,
		TaskList=1,
		DockContainer=2
	...
	public enum BackgroundImagePosition:int
	{
		/// <summary>
	...
	public enum ExplorerBarStockStyle:int
	{
		Blue=0,
		BlueSpecial=1,
		OliveGreen=2,
	...
	/// </summary>
	public enum SideBarColorScheme
	{
		SystemColors,
		Blue,
		Silver,
	...
	/// </summary>
	public enum EndUserCustomizeAction
	{
		/// <summary>
	...
	/// </summary>
	public enum BubbleButtonAlignment
	{
		/// <summary>
...
//		Right
	...
	public enum StyleBackgroundImage:int
	{
	...
	/// </summary>
	public enum StyleBorderType:int
	{
	...
	/// </summary>
	public enum StyleTextAlignment
	{
		/// <summary>
    ...
    /// </summary>
    public enum TitleButtonAlignment
    {
        /// <summary>
    ...
    public enum eScrollBarSkin
    {
        ...
        None,
        /// <summary>
        /// Optimized scrollbar skinning algorithm is used. Might provide better apperance in certain scenarios.
        /// </summary>
        Optimized,
        /// <summary>
        /// Unoptimized scrollbar skinning algorithm is used. Might provide better apperance in certain scenarios.
        /// </summary>
        Unoptimized
    }
    ...
    /// </summary>
    public enum eTitlImagePosition
    {
        /// <summary>
