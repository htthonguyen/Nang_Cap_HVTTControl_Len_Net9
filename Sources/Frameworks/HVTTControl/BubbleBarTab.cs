...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(false),DesignTimeVisible(false),Designer(typeof(BubbleBarTabDesigner))]
	public class BubbleBarTab:Component,ISimpleTab,IBlock
	{
		...
		/// </summary>
		[Browsable(true),DesignerSerializationVisibility(DesignerSerializationVisibility.Content),Category("Buttons"),Description("Returns collection of buttons on the tab."),Editor(typeof(BubbleButtonCollectionEditor), typeof(System.Drawing.Design.UITypeEditor))]
		...
		eTabStripAlignment ISimpleTab.TabAlignment
		{
			get
			{
				if(m_Parent!=null)
				{
					if(m_Parent.Alignment==BubbleButtonAlignment.Top)
