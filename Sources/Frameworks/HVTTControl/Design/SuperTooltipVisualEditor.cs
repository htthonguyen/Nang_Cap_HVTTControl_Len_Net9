...
namespace HVTT.UI.Window.Forms.Design
{
	...
	public class SuperTooltipVisualEditor : UserControl
    {
        ...
        private HVTTPanel panelEx1;
        internal HVTTButton buttonOK;
        internal HVTTButton buttonCancel;
        ...
        private HVTTPanel panelBodyImage;
        private HVTTPanel panelEx5;
        private System.Windows.Forms.ComboBox comboColors;
        private System.Windows.Forms.Label label1;
        private HVTTPanel panelFooterImage;
        ...
        private HVTTPanel resetBodyImage;
        private HVTTPanel resetFooterImage;
        ...
        {
            this.panelEx1 = new HVTT.UI.Window.Forms.HVTTPanel();
            this.resetFooterImage = new HVTT.UI.Window.Forms.HVTTPanel();
            this.resetBodyImage = new HVTT.UI.Window.Forms.HVTTPanel();
            ...
            this.panelFooterImage = new HVTT.UI.Window.Forms.HVTTPanel();
            this.comboColors = new System.Windows.Forms.ComboBox();
            this.label1 = new System.Windows.Forms.Label();
            this.panelEx5 = new HVTT.UI.Window.Forms.HVTTPanel();
            this.panelBodyImage = new HVTT.UI.Window.Forms.HVTTPanel();
            ...
            this.superTooltip1 = new HVTT.UI.Window.Forms.SuperTooltip();
            ...
            this.panelEx1.Style.BackgroundImagePosition = HVTT.UI.Window.Forms.BackgroundImagePosition.Tile;
            this.panelEx1.Style.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
            this.panelEx1.Style.BorderColor.Color = System.Drawing.Color.DimGray;
            this.panelEx1.Style.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemText;
            ...
            this.resetFooterImage.Style.BackgroundImagePosition = HVTT.UI.Window.Forms.BackgroundImagePosition.Tile;
            this.resetFooterImage.Style.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
            this.resetFooterImage.Style.BorderColor.Color = System.Drawing.Color.Gray;
            this.resetFooterImage.Style.CornerType = HVTT.UI.Window.Forms.CornerType.Rounded;
            this.resetFooterImage.Style.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemText;
            ...
            this.resetFooterImage.StyleMouseDown.BackColor1.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBackground;
            this.resetFooterImage.StyleMouseDown.BackColor2.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBackground2;
            this.resetFooterImage.StyleMouseDown.BorderColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBorder;
            this.resetFooterImage.StyleMouseDown.CornerType = HVTT.UI.Window.Forms.CornerType.Rounded;
            this.resetFooterImage.StyleMouseDown.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedText;
            this.resetFooterImage.StyleMouseOver.Alignment = System.Drawing.StringAlignment.Center;
            this.resetFooterImage.StyleMouseOver.BackColor1.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBackground;
            this.resetFooterImage.StyleMouseOver.BackColor2.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBackground2;
            this.resetFooterImage.StyleMouseOver.BorderColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBorder;
            this.resetFooterImage.StyleMouseOver.CornerType = HVTT.UI.Window.Forms.CornerType.Rounded;
            this.resetFooterImage.StyleMouseOver.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotText;
            this.superTooltip1.SetSuperTooltip(this.resetFooterImage, new HVTT.UI.Window.Forms.SuperTooltipInfo("Reset footer image", "", "Click to reset footer image.", null, null, HVTT.UI.Window.Forms.TooltipColor.Lemon, true, false, new System.Drawing.Size(0, 0)));
            ...
            this.resetBodyImage.Style.BackgroundImagePosition = HVTT.UI.Window.Forms.BackgroundImagePosition.Tile;
            this.resetBodyImage.Style.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
            this.resetBodyImage.Style.BorderColor.Color = System.Drawing.Color.Gray;
            this.resetBodyImage.Style.CornerType = HVTT.UI.Window.Forms.CornerType.Rounded;
            this.resetBodyImage.Style.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemText;
            ...
            this.resetBodyImage.StyleMouseDown.BackColor1.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBackground;
            this.resetBodyImage.StyleMouseDown.BackColor2.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBackground2;
            this.resetBodyImage.StyleMouseDown.BorderColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBorder;
            this.resetBodyImage.StyleMouseDown.CornerType = HVTT.UI.Window.Forms.CornerType.Rounded;
            this.resetBodyImage.StyleMouseDown.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedText;
            this.resetBodyImage.StyleMouseOver.Alignment = System.Drawing.StringAlignment.Center;
            this.resetBodyImage.StyleMouseOver.BackColor1.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBackground;
            this.resetBodyImage.StyleMouseOver.BackColor2.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBackground2;
            this.resetBodyImage.StyleMouseOver.BorderColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBorder;
            this.resetBodyImage.StyleMouseOver.CornerType = HVTT.UI.Window.Forms.CornerType.Rounded;
            this.resetBodyImage.StyleMouseOver.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotText;
            this.superTooltip1.SetSuperTooltip(this.resetBodyImage, new HVTT.UI.Window.Forms.SuperTooltipInfo("Reset Body Image", "", "Click to reset body image.", null, null, HVTT.UI.Window.Forms.TooltipColor.Lemon, true, false, new System.Drawing.Size(0, 0)));
            ...
            this.panelFooterImage.Style.BackgroundImagePosition = HVTT.UI.Window.Forms.BackgroundImagePosition.Center;
            this.panelFooterImage.Style.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
            this.panelFooterImage.Style.BorderColor.Color = System.Drawing.Color.DimGray;
            this.panelFooterImage.Style.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemText;
            this.panelFooterImage.Style.GradientAngle = 90;
            this.superTooltip1.SetSuperTooltip(this.panelFooterImage, new HVTT.UI.Window.Forms.SuperTooltipInfo("Click to set footer image", "", "Allows you to choose footer image. Note that image displayed here is preview image. You can see tooltip preview below.", null, null, HVTT.UI.Window.Forms.TooltipColor.Lemon, true, false, new System.Drawing.Size(280, 170)));
            ...
            this.panelEx5.Style.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
            this.panelEx5.Style.BorderColor.Color = System.Drawing.Color.DimGray;
            this.panelEx5.Style.CornerType = HVTT.UI.Window.Forms.CornerType.Rounded;
            this.panelEx5.Style.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.PanelText;
            ...
            this.panelBodyImage.Style.BackgroundImagePosition = HVTT.UI.Window.Forms.BackgroundImagePosition.Center;
            this.panelBodyImage.Style.Border = HVTT.UI.Window.Forms.eBorderType.SingleLine;
            this.panelBodyImage.Style.BorderColor.Color = System.Drawing.Color.DimGray;
            this.panelBodyImage.Style.ForeColor.ColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemText;
            this.panelBodyImage.Style.GradientAngle = 90;
            this.superTooltip1.SetSuperTooltip(this.panelBodyImage, new HVTT.UI.Window.Forms.SuperTooltipInfo("Click to set body image", "", "Allows you to choose body image. Note that image displayed here is preview image. You can see tooltip preview below", null, null, HVTT.UI.Window.Forms.TooltipColor.Lemon, true, false, Size.Empty));
            ...
            this.buttonCancel.Style = HVTTControlStyle.Office2007;
            ...
            this.buttonOK.Style = HVTTControlStyle.Office2007;
        ...
        {
            InitializeComponent();
            panelBodyImage.Style.BackgroundImage = BarFunctions.LoadBitmap("SystemImages.ImagePlaceHolder.png");
            panelFooterImage.Style.BackgroundImage = BarFunctions.LoadBitmap("SystemImages.ImagePlaceHolder16x16.png");
            comboColors.Items.AddRange(Enum.GetNames(typeof(TooltipColor))); 
        }
        ...
        private void OnSuperTooltipInfoChanged()
        {
            ...
            comboColors.SelectedItem = Enum.GetName(typeof(TooltipColor), m_Info.Color);
        ...
        private void UpdateSuperTooltipInfo(SuperTooltipInfo info)
        {
            ...
            info.Color = (TooltipColor)Enum.Parse(typeof(TooltipColor), comboColors.SelectedItem.ToString());
