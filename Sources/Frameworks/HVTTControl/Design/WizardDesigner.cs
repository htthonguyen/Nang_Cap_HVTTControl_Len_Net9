    ...
    public class WizardDesigner : System.Windows.Forms.Design.ControlDesigner
    {
        ...
        internal static void ApplyDefaultWelcomePageStyle(WizardPage page, IDesignerHost dh, IComponentChangeService cc)
        {
            ...
            try
            {
                ...
                TypeDescriptor.GetProperties(page.Style)["BackgroundImagePosition"].SetValue(page.Style, StyleBackgroundImage.TopLeft);
            }
            catch
            {
                dt.Cancel();
        ...
        private void SetDefaultFooterStyle(Wizard w)
        {
            ...
            w.FooterStyle.BorderTop = HVTT.UI.Window.Forms.StyleBorderType.Etched;
            w.FooterStyle.BorderTopColor = System.Drawing.SystemColors.Control;
            w.FooterStyle.BorderTopWidth = 1;
            w.FooterStyle.TextAlignment = HVTT.UI.Window.Forms.StyleTextAlignment.Center;
            w.FooterStyle.TextColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.PanelText;
        }
        ...
        private void ChangeWizardStyle(eWizardStyle style)
        {
            ...
            try
            {
                ...
                if (style == eWizardStyle.Office2007)
                {
                    ...
                    w.HeaderStyle.Reset();
                    w.HeaderStyle.BackColor = ColorScheme.GetColor(0xBFD7F3);
                    w.HeaderStyle.BackColor2 = ColorScheme.GetColor(0xDBF1FE);
                    ...
                    w.HeaderStyle.BorderBottom = StyleBorderType.Solid;
                }
                else if (style == eWizardStyle.Default)
                {
                    ...
                    w.HeaderStyle.BackColorGradientAngle = 90;
                    w.HeaderStyle.BorderBottom = HVTT.UI.Window.Forms.StyleBorderType.Etched;
                    w.HeaderStyle.BorderBottomWidth = 1;
                    ...
                    w.HeaderStyle.TextAlignment = HVTT.UI.Window.Forms.StyleTextAlignment.Center;
                    w.HeaderStyle.TextColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.PanelText;
                }
