		...
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value) 
		{
			...
			if (context!=null && context.Instance!=null && provider!=null) 
			{
				...
				if(m_EdSvc!=null) 
				{
                    ...
                    else if (context.Instance is HVTTButton)
                        lst = new ShortcutsListBox(((HVTTButton)context.Instance).Shortcuts);
					else if(context.Instance is HVTTManager)
						lst=new ShortcutsListBox(((HVTTManager)context.Instance).AutoDispatchShortcuts);
