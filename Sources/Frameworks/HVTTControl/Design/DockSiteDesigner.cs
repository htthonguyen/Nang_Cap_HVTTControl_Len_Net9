...
namespace HVTT.UI.Window.Forms.Design
{
	...
	public class DockSiteDesigner:ParentControlDesigner
	{
        ...
        internal bool HVTTManagerRemoving = false;
		...
		private void OnComponentRemoving(object sender,ComponentEventArgs e)
		{
            ...
            if (c.Dock != DockStyle.Fill && !HVTTManagerRemoving)
            {
                throw new InvalidOperationException("HVTTManager dock sites must not be removed manually. Delete HVTTManager component to remove all dock sites.");
            }
            else
            {
                ...
                if (dh != null)
                {
                    HVTTMarkStatus[] bars = new HVTTMarkStatus[c.Controls.Count];
