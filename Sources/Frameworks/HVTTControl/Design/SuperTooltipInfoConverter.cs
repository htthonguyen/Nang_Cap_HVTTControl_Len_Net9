    ...
    public class SuperTooltipInfoConverter : TypeConverter
    {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            if ((destinationType == typeof(InstanceDescriptor)) && (value is SuperTooltipInfo))
            {
                ...
                {
                    constructorParams = new Type[] { typeof(string), typeof(string), typeof(string), typeof(Image), typeof(Image), typeof(TooltipColor) };
                ...
                else
                {
                    ...
                    constructorParams = new Type[] { typeof(string), typeof(string), typeof(string), typeof(Image), typeof(Image), typeof(TooltipColor), typeof(bool), typeof(bool), typeof(Size) };
                    constructorMemberInfo = typeof(SuperTooltipInfo).GetConstructor(constructorParams);
