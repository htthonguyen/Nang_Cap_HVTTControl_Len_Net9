...
namespace HVTT.UI.Window.Forms.Design
{
	...
	public class HVTTManagerDesigner:System.ComponentModel.Design.ComponentDesigner,IDesignerServices
    {
        ...
        internal static string GetLicenseKey()
        {
            ...
            regkey = regkey.OpenSubKey("Software\\HVTT\\Licenses", false);
            if (regkey != null)
            {
                object keyValue = regkey.GetValue("HVTT.UI.Window.Forms.HVTTManager2");
                if (keyValue != null)
...
//		}
        ...
        //public static bool OpenDesignerEditor(HVTTManager manager, IDesignerServices designerServices)
        //{
        //    HVTT.UI.Window.Forms.Design.DotNetBarDesigner designer=new HVTT.UI.Window.Forms.Design.DotNetBarDesigner();
        ...
        //    set
        //    {
        //        HVTTManager manager=this.Component as HVTTManager;
