...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
    [ToolboxItem(false), DesignTimeVisible(false), DefaultEvent("Click"), Designer(typeof(Design.SimpleBaseItemDesigner))]
	public class LabelItem:BaseItem
    {
        #region Private Variables
        internal const BorderSide DEFAULT_BORDERSIDE = BorderSide.Top | BorderSide.Bottom | BorderSide.Left | BorderSide.Right;
		...
		public override void Paint(ItemPaintArgs pa)
		{
			...
			else
			{
                if (m_BorderSide == BorderSide.All)
                    ...
                    borderside = (((m_BorderSide & BorderSide.Left) != 0) ? System.Windows.Forms.Border3DSide.Left : 0) |
			...
			if(thisRect.Height>0 && thisRect.Width>0)
			{
				...
				else
				{
                    ...
                    if (this.TextMarkupBody != null)
                    {
                        this.TextMarkupBody.Bounds = new Rectangle(thisRect.Top, -thisRect.Right, this.TextMarkupBody.Bounds.Width, this.TextMarkupBody.Bounds.Height);
                        TextMarkup.MarkupDrawContext d = new TextMarkup.MarkupDrawContext(g, this.GetFont(), textColor, pa.RightToLeft);
                        d.HotKeyPrefixVisible = !((GetStringFormat() & eTextFormat.HidePrefix) == eTextFormat.HidePrefix);
                        this.TextMarkupBody.Render(d);
                    }
                    else
                        TextDrawing.DrawStringLegacy(g, m_Text, this.GetFont(), textColor, new Rectangle(thisRect.Top, -thisRect.Right, thisRect.Height, thisRect.Width), GetStringFormat());
					g.ResetTransform();
				}
			}
        ...
        {
            if (this.Style == HVTTControlStyle.Office2007 && m_ForeColor == SystemColors.ControlText && pa.Renderer is Rendering.Office2007Renderer)
            {
                if ((pa.IsOnMenu || pa.IsOnPopupBar) && ((Rendering.Office2007Renderer)pa.Renderer).ColorTable.ButtonItemColors.Count>0)
                {
                    return ((Rendering.Office2007Renderer)pa.Renderer).ColorTable.ButtonItemColors[0].Default.Text;
                }
                else
                {
                    if((pa.ContainerControl is RibbonStrip || pa.ContainerControl is HVTTMarkStatus)&& ((Rendering.Office2007Renderer)pa.Renderer).ColorTable.RibbonTabItemColors.Count>0)
		...
		public override void RecalcSize()
		{
			...
			if(this.Orientation==HVTTOrientation.Horizontal || m_Width==0)
			{
				if(m_Width==0)
				{
					// Auto-size label
					...
					try
					{
						...
						if(this.Orientation==HVTTOrientation.Horizontal)
						{
							...
							if(image!=null)
							{
								if(m_ImagePosition==ImagePosition.Left || m_ImagePosition==ImagePosition.Right)
								{
						...
						else
						{
							...
							if(image!=null)
							{
								if(m_ImagePosition==ImagePosition.Left || m_ImagePosition==ImagePosition.Right)
								{
									...
									this.WidthInternal=Math.Max(this.HeightInternal,image.Height+IMAGETEXT_SPACING);
								}
								else
								{
				...
				else
				{
					...
					if(m_Height==0)
					{
                        ...
                        if (this.WordWrap)
                        {
                            ...
                            if (g != null)
                            {
                                Size textSize = TextDrawing.MeasureString(g, this.Text, objCurrentFont, this.WidthInternal - (m_PaddingLeft + m_PaddingRight));
        ...
        private void ArrangeMarkup(int specifiedWidth)
        {
            ...
            TextMarkup.MarkupDrawContext d = new HVTT.UI.Window.Forms.TextMarkup.MarkupDrawContext(g, objCurrentFont, this.ForeColor, false);
            d.HotKeyPrefixVisible = !((GetStringFormat() & eTextFormat.HidePrefix) == eTextFormat.HidePrefix);
        ...
        private Size GetMarkupAvailableSize(int specifiedWidth)
        {
            ...
            else
            {
                ...
                if (image != null && (m_ImagePosition == ImagePosition.Left || m_ImagePosition == ImagePosition.Right))
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Appearance"), DefaultValue(DEFAULT_BORDERSIDE), Description("Specifies border sides that are displayed.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Determines the background color of the label.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates text color.")]
        ...
        {
            return (m_ForeColor != SystemColors.ControlText);
        }

		/// <summary>
		/// Gets or sets the border line color when border is single line.
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Indicates border line color when border is single line.")]
		...
		/// </summary>
        [Browsable(true), DefaultValue(System.Drawing.StringAlignment.Near), HVTTBrowsable(true), Category("Layout"), Description("Indicates text alignment.")]
		...
		/// </summary>
		[Browsable(true),DefaultValue(null), HVTTBrowsable(true),Category("Appearance"),Description("Indicates label font.")]
		...
		/// </summary>
        [System.ComponentModel.Browsable(true), DefaultValue(0), HVTTBrowsable(true), System.ComponentModel.Category("Layout"), System.ComponentModel.Description("Indicates left padding in pixels.")]
		...
		/// </summary>
        [System.ComponentModel.Browsable(true), DefaultValue(0), HVTTBrowsable(true), System.ComponentModel.Category("Layout"), System.ComponentModel.Description("Indicates right padding in pixels.")]
		...
		/// </summary>
        [System.ComponentModel.Browsable(true), DefaultValue(0), HVTTBrowsable(true), System.ComponentModel.Category("Layout"), System.ComponentModel.Description("Indicates top padding in pixels.")]
		...
		/// </summary>
		[Browsable(true),DefaultValue(0),HVTTBrowsable(true),Category("Layout"),Description("Indicates bottom padding in pixels.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(0),System.ComponentModel.Category("Layout"),System.ComponentModel.Description("Indicates the width of the label in pixels.")]
		public int Width
		{
			get
			{
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(0),System.ComponentModel.Category("Layout"),System.ComponentModel.Description("Indicates height of the label in pixels.")]
		public int Height
		{
			get
			{
		...
		/// </summary>
		[Browsable(true),DefaultValue(false),HVTTBrowsable(true),Category("Appearance"),Description("Indicates whether label has divider style.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Style"),System.ComponentModel.DefaultValue(false),System.ComponentModel.Description("Gets or sets a value that determines whether text is displayed in multiple lines or one long line.")]
		...
		private eTextFormat GetStringFormat()
		{
            ...
            //StringFormat sfmt=new StringFormat(StringFormat.GenericTypographic);
            //sfmt.HotkeyPrefix=System.Drawing.Text.HotkeyPrefix.None;
            //if(m_WordWrap)
            ...
            //sfmt.Alignment=m_TextAlignment;
            //sfmt.LineAlignment=m_TextLineAlignment;
            //sfmt.SetTabStops(20.0f, new float[]{20.0f, 20.0f, 20.0f});
            //sfmt.FormatFlags=sfmt.FormatFlags|StringFormatFlags.FitBlackBox;
		...
		protected internal override void Deserialize(ItemSerializationContext context)
		{
            ...
            if (ItemXmlSource.HasAttribute("BorderSide"))
                m_BorderSide = (BorderSide)System.Xml.XmlConvert.ToInt32(ItemXmlSource.GetAttribute("BorderSide"));
            else
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),Editor(typeof(Design.TextMarkupUIEditor),typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("The text contained in the item.")]
		public override string Text
		{
			...
			set
			{
				...
				if(this.Displayed && m_Parent!=null && !this.SuspendLayout)
				{
					if(m_Width==0)
						NeedRecalcSize=true;
                    if(!(this.ContainerControl is HVTTLabel))
					    this.Refresh(); 
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies the label icon."),System.ComponentModel.DefaultValue(null)]
