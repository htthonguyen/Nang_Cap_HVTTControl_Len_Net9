...

{
	...
	public class ElementStyle:System.ComponentModel.IComponent
	{
		...
		private StyleBackgroundImage m_BackgroundImagePosition=StyleBackgroundImage.Stretch;
		...
		private StyleTextAlignment m_TextAlignment=StyleTextAlignment.Near;
		private StyleTextAlignment m_TextLineAlignment=StyleTextAlignment.Center;
		private StyleTextTrimming m_TextTrimming=StyleTextTrimming.EllipsisCharacter;
		...
		// Border
		private StyleBorderType m_BorderLeft=StyleBorderType.None;
		private StyleBorderType m_BorderRight=StyleBorderType.None;
		private StyleBorderType m_BorderTop=StyleBorderType.None;
		private StyleBorderType m_BorderBottom=StyleBorderType.None;
		...
		private CornerType m_CornerType=CornerType.Square;
		private CornerType m_CornerTypeTopLeft=CornerType.Inherit;
		private CornerType m_CornerTypeTopRight=CornerType.Inherit;
		private CornerType m_CornerTypeBottomLeft=CornerType.Inherit;
		private CornerType m_CornerTypeBottomRight=CornerType.Inherit;
		...
		/// </summary>
		[DevCoSerialize(),Browsable(true),Category("Background"),Description("Gets or sets the background color for UI element."),Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)),TypeConverter(typeof(ColorSchemeColorConverter))]
		...
		/// <a href="TreeGX~HVTT.Tree.eColorSchemePart.html">eColorSchemePart.None</a> to
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Background"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Gets or sets the target gradient background color for UI element."), TypeConverter(typeof(ColorSchemeColorConverter))]
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Background"), DefaultValue(StyleBackgroundImage.Stretch), Description("Specifies background image position when container is larger than image.")]
		public StyleBackgroundImage BackgroundImagePosition
		{
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Text Properties"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Gets or sets the text color displayed in this UI element."), TypeConverter(typeof(ColorSchemeColorConverter))]
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Text Formatting"), DefaultValue(StyleTextAlignment.Near), Description("Specifies alignment of the text.")]
		...
		/// Specifies alignment of the text.
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Text Formatting"), DefaultValue(StyleTextAlignment.Center), Description("Specifies alignment of the text.")]
		public StyleTextAlignment TextLineAlignment
		{
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Text Formatting"), DefaultValue(StyleTextTrimming.EllipsisCharacter), Description("Specifies how to trim characters when text does not fit.")]
		public StyleTextTrimming TextTrimming
		{
...
//		}
		...
		/// </summary>
		[DefaultValue(StyleBorderType.None),Browsable(true),Category("Border"),DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Description("Indicates the border type for all sides of the element.")]
		public StyleBorderType Border
		{
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(StyleBorderType.None), Browsable(true), Category("Border"), Description("Indicates the border type for top side of the element.")]
		public StyleBorderType BorderTop
		{
			get {return m_BorderTop;}
			set
			{
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(StyleBorderType.None), Browsable(true), Category("Border"), Description("Indicates the border type for bottom side of the element.")]
		public StyleBorderType BorderBottom
		{
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(StyleBorderType.None), Browsable(true), Category("Border"), Description("Indicates the border type for left side of the element.")]
		public StyleBorderType BorderLeft
		{
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(StyleBorderType.None), Browsable(true), Category("Border"), Description("Indicates the border type for right side of the element.")]
		public StyleBorderType BorderRight
		{
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Border"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Indicates border color for all sides. Specifing the color for the side will override this value."), TypeConverter(typeof(ColorSchemeColorConverter))]
        ...
        /// </summary>
        [DevCoSerialize(), Browsable(true), Category("Border"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Indicates target background gradient color for border on all sides. "), TypeConverter(typeof(ColorSchemeColorConverter))]
        ...
        /// </summary>
        [DevCoSerialize(), Browsable(true), Category("Border"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Indicates color for light border part when etched border is used."), TypeConverter(typeof(ColorSchemeColorConverter))]
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Border"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Indicates background color for the left side border."), TypeConverter(typeof(ColorSchemeColorConverter))]
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Border"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Indicates background color for the right side border."), TypeConverter(typeof(ColorSchemeColorConverter))]
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Border"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Indicates background color for the top side border."), TypeConverter(typeof(ColorSchemeColorConverter))]
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Border"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Indicates background color for the bottom side border."), TypeConverter(typeof(ColorSchemeColorConverter))]
        ...
        /// </summary>
        [DevCoSerialize(), Browsable(true), DefaultValue(""), Category("Design"), Description("Indicates the class style belongs to.")]

        [Editor(typeof(Design.ElementStyleClassTypeEditor), typeof(System.Drawing.Design.UITypeEditor))]
        ...
        internal eTextFormat TextFormat
        {
            get
            {
                ...
                if (m_TextLineAlignment == StyleTextAlignment.Center)
                    format |= eTextFormat.VerticalCenter;
                else if (m_TextLineAlignment == StyleTextAlignment.Far)
                ...
                if (m_TextTrimming != StyleTextTrimming.None)
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(CornerType.Square), Browsable(true), Category("Border"), Description("Indicates border corner type.")]
		public CornerType CornerType
		{
			...
			set
			{
				...
				{
					m_CornerType=value;
					if(m_CornerType==CornerType.Inherit)
						m_CornerType=CornerType.Square;
					this.OnStyleChanged();
				}
			}
		}
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(CornerType.Inherit), Browsable(true), Category("Border"), Description("Indicates top left border corner type.")]
		public CornerType CornerTypeTopLeft
		{
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(CornerType.Inherit), Browsable(true), Category("Border"), Description("Indicates top right border corner type.")]
		public CornerType CornerTypeTopRight
		{
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(CornerType.Inherit), Browsable(true), Category("Border"), Description("Indicates bottom left border corner type.")]
		public CornerType CornerTypeBottomLeft
		{
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(CornerType.Inherit), Browsable(true), Category("Border"), Description("Indicates bottom right border corner type.")]
		public CornerType CornerTypeBottomRight
		{
		...
		internal bool PaintLeftBorder
		{
			get
			{
				if(this.BorderLeft!=StyleBorderType.None && this.BorderLeftWidth>0 && 
					(!this.BorderColor.IsEmpty || !this.BorderLeftColor.IsEmpty))
					return true;
				return false;
			}
		}
		...
		internal bool PaintRightBorder
		{
			get
			{
				if(this.BorderRight!=StyleBorderType.None && this.BorderRightWidth>0 && 
					(!this.BorderColor.IsEmpty || !this.BorderRightColor.IsEmpty))
					return true;
				return false;
			}
		}
		...
		internal bool PaintTopBorder
		{
			get
			{
				if(this.BorderTop!=StyleBorderType.None && this.BorderTopWidth>0 && 
					(!this.BorderColor.IsEmpty || !this.BorderTopColor.IsEmpty))
					return true;
				return false;
			}
		}
		...
		internal bool PaintBottomBorder
		{
			get
			{
				if(this.BorderBottom!=StyleBorderType.None && this.BorderBottomWidth>0 && 
					(!this.BorderColor.IsEmpty || !this.BorderBottomColor.IsEmpty))
					return true;
				return false;
			}
		}
		...
		public virtual void ApplyStyle(ElementStyle style)
		{
			...
			if(style.BackgroundImagePosition!=StyleBackgroundImage.Stretch)
				this.BackgroundImagePosition=style.BackgroundImagePosition;
			if(style.BorderBottom!=StyleBorderType.None)
			...
			if(style.BorderLeft!=StyleBorderType.None)
			...
			if(style.BorderTop!=StyleBorderType.None)
			...
			if(style.BorderRight!=StyleBorderType.None)
			...
			if(style.CornerType!=CornerType.Square)
				this.CornerType=style.CornerType;
			if(style.CornerTypeTopLeft!=CornerType.Inherit)
				this.CornerTypeTopLeft=style.CornerTypeTopLeft;
			if(style.CornerTypeTopRight!=CornerType.Inherit)
				this.CornerTypeTopRight=style.CornerTypeTopRight;
			if(style.CornerTypeBottomLeft!=CornerType.Inherit)
				this.CornerTypeBottomLeft=style.CornerTypeBottomLeft;
			if(style.CornerTypeBottomRight!=CornerType.Inherit)
...
//				this.TextFormat=style.TextFormat;
			...
			if(style.TextTrimming==StyleTextTrimming.EllipsisCharacter)
        ...
        public virtual bool Custom
        {
            get
            {
                ...
                if (this.BackgroundImageAlpha != 255)
                    return true;
                if (this.BackgroundImagePosition != StyleBackgroundImage.Stretch)
                    return true;
                if (this.BorderBottom != StyleBorderType.None)
                    return true;
                ...
                if (!this.BorderColor.IsEmpty)
                    return true;
                if (this.BorderLeft != StyleBorderType.None)
                    return true;
                if (!this.BorderLeftColor.IsEmpty)
                    return true;
                if (this.BorderLeftWidth != 0)
                    return true;
                if (this.BorderTop != StyleBorderType.None)
                    return true;
                if (!this.BorderTopColor.IsEmpty)
                    return true;
                if (this.BorderTopWidth != 0)
                    return true;
                if (this.BorderRight != StyleBorderType.None)
                    return true;
                ...
                if (this.CornerDiameter != DEFAULT_CORNER_DIAMETER)
                    return true;
                if (this.CornerType != CornerType.Square)
                    return true;
                if (this.CornerTypeTopLeft != CornerType.Inherit)
                    return true;
                if (this.CornerTypeTopRight != CornerType.Inherit)
                    return true;
                if (this.CornerTypeBottomLeft != CornerType.Inherit)
                    return true;
                if (this.CornerTypeBottomRight != CornerType.Inherit)
                    return true;
                if (this.Font != null)
                    return true;
                ...
                if (this.PaddingTop != 0)
                    return true;
                if (this.TextAlignment != StyleTextAlignment.Near)
                    return true;
                if (!this.TextColor.IsEmpty)
                    return true;
                if (this.TextLineAlignment != StyleTextAlignment.Center)
                    return true;
                if (this.TextTrimming != StyleTextTrimming.EllipsisCharacter)
                    return true;
        ...
        public void Reset()
        {
		    ...
		    m_BackgroundImage=null;
		    m_BackgroundImagePosition=StyleBackgroundImage.Stretch;
		    ...
		    // Text Formating
		    m_WordWrap=false;
		    m_TextAlignment=StyleTextAlignment.Near;
		    m_TextLineAlignment=StyleTextAlignment.Center;
		    m_TextTrimming=StyleTextTrimming.EllipsisCharacter;
		    ...
		    // Border
		    m_BorderLeft=StyleBorderType.None;
		    m_BorderRight=StyleBorderType.None;
		    m_BorderTop=StyleBorderType.None;
		    m_BorderBottom=StyleBorderType.None;
		    ...
		    m_CornerType=CornerType.Square;
		    m_CornerTypeTopLeft=CornerType.Inherit;
		    m_CornerTypeTopRight=CornerType.Inherit;
		    m_CornerTypeBottomLeft=CornerType.Inherit;
		    m_CornerTypeBottomRight=CornerType.Inherit;
