...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
    [ToolboxBitmap(typeof(Wizard),"Wizard.Wizard.ico"), ToolboxItem(true), Designer(typeof(Design.WizardDesigner))]
    public class Wizard : UserControl
    {
        ...
        private HVTTButton buttonHelp;
        private HVTTButton buttonCancel;
        private HVTTButton buttonFinish;
        private HVTTButton buttonNext;
        private HVTTButton buttonBack;
		...
		{
            this.panelHeader = new HVTT.UI.Window.Forms.PanelControl();
            this.pictureHeader = new System.Windows.Forms.PictureBox();
            this.labelDescription = new System.Windows.Forms.Label();
            this.labelCaption = new System.Windows.Forms.Label();
            this.panelFooter = new HVTT.UI.Window.Forms.PanelControl();
            this.buttonHelp = new HVTTButton();
            this.buttonCancel = new HVTTButton();
            this.buttonFinish = new HVTTButton();
            this.buttonNext = new HVTTButton();
            this.buttonBack = new HVTTButton();
            ...
            this.panelHeader.Style.BorderBottom = HVTT.UI.Window.Forms.StyleBorderType.Etched;
            ...
            this.panelHeader.Style.TextAlignment = HVTT.UI.Window.Forms.StyleTextAlignment.Center;
            this.panelHeader.Style.TextColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.PanelText;
            ...
            this.buttonHelp.Style = HVTTControlStyle.Office2000;
            ...
            this.buttonCancel.Style = HVTTControlStyle.Office2000;
            ...
            this.buttonFinish.Style = HVTTControlStyle.Office2000;
            ...
            this.buttonNext.Style = HVTTControlStyle.Office2000;
            ...
            this.buttonBack.Style = HVTTControlStyle.Office2000;
        ...
        /// </summary>
        [Browsable(true), Localizable(true), DefaultValue("Cancel"), Category("Wizard Buttons"), Description("Indicates caption of the button")]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), NotifyParentPropertyAttribute(true), Category("Style"), Description("Gets or sets header background style."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), NotifyParentPropertyAttribute(true), Category("Style"), Description("Gets or sets footer background style."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// </summary>
        internal HVTTButton NextButtonControl
        {
        ...
        /// </summary>
        internal HVTTButton BackButtonControl
        {
        ...
        internal WizardPage GetBackPage()
        {
        ...
        private void OnWizardStyleChanged()
        {
            ...
            {
                buttonBack.Style = HVTTControlStyle.Office2000;
                buttonCancel.Style = HVTTControlStyle.Office2000;
                buttonFinish.Style = HVTTControlStyle.Office2000;
                buttonHelp.Style = HVTTControlStyle.Office2000;
                buttonNext.Style = HVTTControlStyle.Office2000;
            ...
            {
                buttonBack.Style = HVTTControlStyle.Office2007;
                buttonCancel.Style = HVTTControlStyle.Office2007;
                buttonFinish.Style = HVTTControlStyle.Office2007;
                buttonHelp.Style = HVTTControlStyle.Office2007;
                buttonNext.Style = HVTTControlStyle.Office2007;
