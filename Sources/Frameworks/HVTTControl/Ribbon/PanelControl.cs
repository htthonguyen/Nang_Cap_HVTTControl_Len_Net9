...
namespace HVTT.UI.Window.Forms
{
    ...
    /// </summary>
    [ToolboxItem(false), Designer(typeof(Design.PanelControlDesigner)), DefaultEvent("Click")]
    public class PanelControl : System.Windows.Forms.Panel, IButtonControl
    {
        ...
        private void SetRegion(bool bResize)
        {
            ...
            if (bResize || m_CurrentCornerType != style.CornerType || m_CornerDiameter != style.CornerDiameter)
            {
                ...
                if (style != null && !(DrawThemedPane && BarFunctions.ThemedOS) && style.CornerType != CornerType.Square)
                {
        ...
        protected virtual void PaintStyled(PaintEventArgs e)
        {
            ...
            ElementStyle style = GetStyle().Copy() as ElementStyle;
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), EditorBrowsable(EditorBrowsableState.Always), Category("Appearance"), Description("Gets or sets the text displayed on panel.")]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Style"), Description("Indicates panel style."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        public void ApplyPanelStyle()
        {
            ...
            m_Style.Border = StyleBorderType.Solid;
            ...
            m_Style.TextAlignment = StyleTextAlignment.Center;
            m_Style.TextLineAlignment = StyleTextAlignment.Center;
        ...
        public void ApplyButtonStyle()
        {
            ...
            this.Style.TextAlignment = StyleTextAlignment.Center;
            this.Style.TextLineAlignment = StyleTextAlignment.Center;
            this.Style.BackColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarBackground;
            this.Style.BackColor2SchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarBackground2;
            this.Style.BackgroundImagePosition = HVTT.UI.Window.Forms.StyleBackgroundImage.Tile;
            this.Style.Border = StyleBorderType.Solid;
            this.Style.BorderWidth = 1;
            this.Style.BorderColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarDockedBorder;
            this.Style.TextColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemText;
            this.Style.BackColorGradientAngle = 90;
            this.StyleMouseDown.BackColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBackground;
            this.StyleMouseDown.BackColor2SchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBackground2;
            this.StyleMouseDown.BorderColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedBorder;
            this.StyleMouseDown.TextColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemPressedText;
            this.StyleMouseOver.BackColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBackground;
            this.StyleMouseOver.BackColor2SchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBackground2;
            this.StyleMouseOver.BorderColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotBorder;
            this.StyleMouseOver.TextColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.ItemHotText;
        ...
        {
            style.Reset();
            style.TextAlignment = StyleTextAlignment.Center;
            style.BackColorSchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarBackground;
            style.BackColor2SchemePart = HVTT.UI.Window.Forms.eColorSchemePart.BarBackground2;
            style.BackgroundImagePosition = HVTT.UI.Window.Forms.StyleBackgroundImage.Tile;
