...
namespace HVTT.UI.Window.Forms
{
    ...
    /// <summary>
    /// Defines delegate for ToolItem rendering events.
    /// </summary>
    public delegate void RibbonCustomizeToolItemClickHandler(Object Sender,RibbonCustomizeToolItemClickArgs e);
