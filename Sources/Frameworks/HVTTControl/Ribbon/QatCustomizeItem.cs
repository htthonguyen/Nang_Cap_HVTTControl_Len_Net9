...
using HVTT.UI.Window.Forms.Ribbon;
...
namespace HVTT.UI.Window.Forms
{
    ...
    public class QatCustomizeItem : CustomizeItem
    {
        ...
        /// </summary>
        [Browsable(false), HVTTBrowsable(false), Category("Behavior"), Description("Indicates whether Customize menu item is visible."), DefaultValue(true), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), DefaultValue(QatCustomizeItem.DefaultTooltipText), System.ComponentModel.Category("Appearance"), System.ComponentModel.Description("Indicates the text that is displayed when mouse hovers over the item."), Localizable(true)]
        ...
        {
            this.PopupSide = PopupSide.Bottom;
            base.OnExpandChange();
        }
