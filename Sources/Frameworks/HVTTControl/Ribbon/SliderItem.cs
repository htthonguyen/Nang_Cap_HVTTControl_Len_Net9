    ...
    public class SliderItem : BaseItem
    {
        ...
        public override void RecalcSize()
        {
            ...
            if (m_LabelVisible)
            {
                ...
                {
                    sz.Height = Math.Max(sliderHeight, font.Height);
                    sz.Width += m_LabelWidth;
                }
                else
                {
                    sz.Height = sliderHeight + font.Height;
                }
            }
        ...
        public override void InternalMouseDown(System.Windows.Forms.MouseEventArgs objArg)
        {
            if (this.GetEnabled() && !this.DesignMode && objArg.Button == MouseButtons.Left)
            {
                ...
                if (mo == eSliderPart.IncreaseButton || mo == eSliderPart.DecreaseButton)
                {
                    if (m_ClickTimer == null)
        ...
        private int GetValueFromX(int x)
        {
            ...
            //r.X += (int)Math.Ceiling((double)m_SlideSize.Width / 2);
            ...
            if (this.Step > 1)
            {
                ...
                {
                    v = (int)Math.Ceiling((float)((v - this.Minimum) / (float)this.Step)) * this.Step;
                }
            }
        ...
        private void UpdateLayout()
        {
            ...
            if (m_LabelVisible)
            {
                if (m_LabelPosition == eSliderLabelPosition.Left && !rtl || m_LabelPosition == eSliderLabelPosition.Right && rtl)
                {
                    m_LabelBounds = new Rectangle(2, 0, m_LabelWidth - 2, r.Height);
                    r.Width -= m_LabelWidth;
                    r.X += m_LabelWidth;
                }
                else if (m_LabelPosition == eSliderLabelPosition.Left && rtl || m_LabelPosition == eSliderLabelPosition.Right && !rtl)
                {
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), DefaultValue(136), System.ComponentModel.Category("Layout"), System.ComponentModel.Description("Indicates the width of the slider part of the item in pixels.")]
        public int Width
        {
            get
            {
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), System.ComponentModel.DefaultValue(200), System.ComponentModel.Category("Behavior"), System.ComponentModel.Description("Gets or sets the auto-repeat interval for the click event when mouse button is kept pressed over the item.")]
        ...
        /// </summary>
        [Browsable(false), HVTTBrowsable(false), System.ComponentModel.DefaultValue(true), System.ComponentModel.Category("Behavior"), System.ComponentModel.Description("Determines whether sub-items are displayed.")]
        ...
        /// </summary>
        [Browsable(false), HVTTBrowsable(false), DefaultValue(false), Category("Appearance"), Description("Specifies whether item is drawn using Themes when running on OS that supports themes like Windows XP.")]
        ...
        /// </summary>
        [Browsable(false), HVTTBrowsable(false), System.ComponentModel.DefaultValue(false), System.ComponentModel.Category("Appearance"), System.ComponentModel.Description("Indicates whether item will stretch to consume empty space. Items on stretchable, no-wrap Bars only.")]
