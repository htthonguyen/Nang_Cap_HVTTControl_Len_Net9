...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(false),DesignTimeVisible(false),Designer(typeof(Design.RibbonTabItemDesigner))]
	public class RibbonTabItem:ButtonItem
	{
        ...
        private RibbonTabColor m_ColorTable = RibbonTabColor.Default; private string m_CashedColorTableName = "Default";
        ...
        /// any effect on other styles. Default value is RibbonTabColor.Default
        /// </summary>
        [Browsable(true), DefaultValue(RibbonTabColor.Default), Category("Appearance"), Description("Indicates predefined color of item when Office 2007 style is used.")]
        public new RibbonTabColor ColorTable
        {
            ...
            set
            {
                ...
                {
                    m_ColorTable = value;
                    m_CashedColorTableName = Enum.GetName(typeof(RibbonTabColor), m_ColorTable);
                    this.Refresh();
                }
            }
        }
		...
		/// </summary>
		[Editor(typeof(Design.RibbonTabItemGroupTypeEditor),typeof(System.Drawing.Design.UITypeEditor)),Browsable(true),DefaultValue(null),HVTTBrowsable(true),Category("Tab Group"),Description("Indicates the group tab belongs to.")]
		...
		protected override void OnCheckedChanged()
		{
            ...
            if (this.Style == HVTTControlStyle.Office2007 && this.ContainerControl is System.Windows.Forms.Control)
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DefaultValue(""),EditorBrowsable(EditorBrowsableState.Never)]
        ...
        private void UpdateTabAppearance()
        {
            ...
            else if (this.Style == HVTTControlStyle.Office2003)
            {
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Content)]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), Category("Behavior"), DefaultValue(true), Description("Indicates whether the item will auto-collapse (fold) when clicked.")]
		...
		/// </summary>
        [DefaultValue(false), Browsable(false), EditorBrowsable(EditorBrowsableState.Never), HVTTBrowsable(false), Category("Behavior"), Description("Indicates whether the item will auto-collapse (fold) when clicked.")]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), DefaultValue(true), System.ComponentModel.Category("Behavior"), System.ComponentModel.Description("Indicates whether item can be customized by user.")]
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),Category("Appearance"),Description("Indicates whether item is checked or not."),DefaultValue(false)]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), DefaultValue(false), Category("Behavior"), Description("Gets or sets whether Click event will be auto repeated when mouse button is kept pressed over the item.")]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), DefaultValue(600), Category("Behavior"), Description("Gets or sets the auto-repeat interval for the click event when mouse button is kept pressed over the item.")]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), Category("Appearance"), Description("Indicates item's visiblity when on pop-up menu."), DefaultValue(HVTTMenuVisibility.VisibleAlways)]
		public override HVTTMenuVisibility MenuVisibility
		{
			get
			{
		...
		/// </summary>
        [Browsable(false), EditorBrowsable(EditorBrowsableState.Never), HVTTBrowsable(false), Category("Appearance"), Description("Indicates when menu items are displayed when MenuVisiblity is set to VisibleIfRecentlyUsed and RecentlyUsed is true."), DefaultValue(HVTTPersonalizedMenus.Disabled)]
		public override HVTTPersonalizedMenus PersonalizedMenus
		{
			get
			{
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), Category("Behavior"), Description("Indicates Animation type for Popups."), DefaultValue(HVTTPopupAnimation.ManagerControlled)]
		public override HVTTPopupAnimation PopupAnimation
		{
			get
			{
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), Category("Appearance"), Description("Indicates the font that will be used on the popup window."), DefaultValue(null)]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), Category("Appearance"), Description("Indicates whether sub-items are shown on popup Bar or popup menu."), DefaultValue(ePopupType.Menu)]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), Category("Layout"), Description("Specifies the inital width for the Bar that hosts pop-up items. Applies to PopupType.Toolbar only."), DefaultValue(200)]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), DefaultValue(true), Category("Behavior"), Description("Determines whether sub-items are displayed.")]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), DefaultValue(false), Category("Appearance"), Description("Indicates whether item will stretch to consume empty space. Items on stretchable, no-wrap Bars only.")]
		...
		/// </summary>
        [Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), Category("Behavior"), Description("Indicates the width of the expand part of the button item."), DefaultValue(12)]
        ...
        /// </summary>
        [System.ComponentModel.Browsable(false), EditorBrowsable(EditorBrowsableState.Never), HVTTBrowsable(false), System.ComponentModel.Category("Design"), System.ComponentModel.Description("Gets or set the alternative Shortcut Text.  This text appears next to the Text instead of any shortcuts"), System.ComponentModel.DefaultValue("")]
        ...
        /// </summary>
        [System.ComponentModel.Browsable(false), HVTTBrowsable(false), System.ComponentModel.DefaultValue(""), System.ComponentModel.Category("Design"), System.ComponentModel.Description("Indicates item category used to group similar items at design-time."), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// </summary>
        [System.ComponentModel.Browsable(false), HVTTBrowsable(false), System.ComponentModel.Category("Appearance"), System.ComponentModel.Description("The foreground color used to display text when mouse is over the item."), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// </summary>
        [System.ComponentModel.Browsable(false), HVTTBrowsable(false), System.ComponentModel.Category("Appearance"), System.ComponentModel.Description("Indicates the way item is painting the picture when mouse is over it. Setting the value to Color will render the image in gray-scale when mouse is not over the item."), System.ComponentModel.DefaultValue(HotTrackingStyle.Default), EditorBrowsable(EditorBrowsableState.Never)]
        public override HotTrackingStyle HotTrackingStyle
        {
        ...
        /// </summary>
        [System.ComponentModel.Browsable(false), HVTTBrowsable(false), EditorBrowsable(EditorBrowsableState.Never), System.ComponentModel.Category("Appearance"), System.ComponentModel.Description("The foreground color used to display text.")]
