...
namespace HVTT.UI.Window.Forms
{
    ...
    public class RibbonLocalization
    {
        ...
        /// </summary>
        [DefaultValue("Customize Quick Access Toolbar"), Localizable(true), Description("Indicates the the title text of the Quick Access Toolbar Customize dialog form."), Category("QAT Customize Dialog")]
        ...
        /// </summary>
        [DefaultValue("&Place Quick Access Toolbar below the Ribbon"), Localizable(true), Description("Indicates the text of the 'Place Quick Access Toolbar below the Ribbon' check-box on the Quick Access Toolbar Customize dialog form."), Category("QAT Customize Dialog")]
        ...
        /// </summary>
        [DefaultValue("&Choose commands from:"), Localizable(true), Description("Indicates the text of the Choose commands from label on the Quick Access Toolbar Customize dialog form."), Category("QAT Customize Dialog")]
        ...
        /// </summary>
        [DefaultValue("&Remove"), Localizable(true), Description("Indicates the text of the Remove button on the Quick Access Toolbar Customize dialog form."), Category("QAT Customize Dialog")]
        ...
        /// </summary>
        [DefaultValue("&Add >>"), Localizable(true), Description("Indicates the text of the Add button on the Quick Access Toolbar Customize dialog form."), Category("QAT Customize Dialog")]
        ...
        /// </summary>
        [DefaultValue("OK"), Localizable(true), Description("Indicates the text of the OK button on the Quick Access Toolbar Customize dialog form."), Category("QAT Customize Dialog")]
        ...
        /// </summary>
        [DefaultValue("Cancel"), Localizable(true), Description("Indicates the text of the OK button on the Quick Access Toolbar Customize dialog form."), Category("QAT Customize Dialog")]
        ...
        /// </summary>
        [DefaultValue("&Remove from Quick Access Toolbar"), Localizable(true), Description("Indicates the text that is used on context menu used to customize Quick Access Toolbar."), Category("Quick Access Toolbar")]
        ...
        /// Gets or sets the text that is used on context menu used to customize Quick Access Toolbar.
        /// </summary>
        [DefaultValue("&Add to Quick Access Toolbar"), Localizable(true), Description("Indicates the text that is used on context menu used to customize Quick Access Toolbar."), Category("Quick Access Toolbar")]
        ...
        /// Gets or sets the text that is used on context menu used to customize Quick Access Toolbar.
        /// </summary>
        [DefaultValue("&Customize Quick Access Toolbar..."), Localizable(true), Description("Indicates the text that is used on context menu used to customize Quick Access Toolbar."), Category("Quick Access Toolbar")]
        ...
        /// </summary>
        [DefaultValue("<b>Customize Quick Access Toolbar</b>"), Localizable(true), Description("Indicates text that is used on Quick Access Toolbar customize menu label."), Category("Quick Access Toolbar")]
        ...
        /// </summary>
        [DefaultValue("&Place Quick Access Toolbar below the Ribbon"), Localizable(true), Description("Indicates the text that is used on context menu used to change placement of the Quick Access Toolbar."), Category("Quick Access Toolbar")]
        ...
        /// Gets or sets the text that is used on context menu used to change placement of the Quick Access Toolbar.
        /// </summary>
        [DefaultValue("&Place Quick Access Toolbar above the Ribbon"), Localizable(true), Description("Indicates the text that is used on context menu used to change placement of the Quick Access Toolbar."), Category("Quick Access Toolbar")]
        ...
        /// </summary>
        [DefaultValue("Mi&nimize the Ribbon"), Localizable(true), Description("Indicates text that is used on context menu item used to minimize the Ribbon."), Category("Quick Access Toolbar")]
        ...
        /// </summary>
        [DefaultValue("&Maximize the Ribbon"), Localizable(true), Description("Indicates text that is used on context menu item used to maximize the Ribbon."), Category("Quick Access Toolbar")]
