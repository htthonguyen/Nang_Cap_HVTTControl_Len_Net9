...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[DesignTimeVisible(false),ToolboxItem(false),TypeConverterAttribute(typeof(Design.RibbonTabItemGroupConverter))]
	public class RibbonTabItemGroup:Component
	{
		...
		internal ArrayList DisplayPositions=new ArrayList();
		...
		/// </summary>
		[Browsable(true),Category("Background"),Description("Gets the style for tab group."),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// </summary>
        [Browsable(true), HVTTBrowsable(true), DefaultValue(""), Localizable(true)]
