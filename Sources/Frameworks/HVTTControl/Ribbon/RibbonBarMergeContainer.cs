...
namespace HVTT.UI.Window.Forms
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(RibbonBarMergeContainer), "Ribbon.RibbonControl.ico"), ToolboxItem(true), Designer(typeof(Design.RibbonBarMergeContainerDesigner)), System.Runtime.InteropServices.ComVisible(false)]
    public class RibbonBarMergeContainer : RibbonPanel
    {
        ...
        private RibbonTabColor m_RibbonTabColorTable = RibbonTabColor.Default;
        #endregion
        ...
        public string RibbonTabText
        {
            ...
            set { m_RibbonTabText = value; }
        }

        /// <summary>
        /// Gets or sets the predefined color for the ribbon tab that is created when ribbon bar controls are merged into the ribbon.
        /// Default value is RibbonTabColor.Default
        /// </summary>
        [Browsable(true), DefaultValue(RibbonTabColor.Default), Category("Appearance"), Description("Indicates predefined color for the ribbon tab that is created when ribbon bar controls are merged into the ribbon.")]
        public RibbonTabColor RibbonTabColorTable
        {
