...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(false), Designer(typeof(HVTT.UI.Window.Forms.Design.RibbonPanelDesigner))]
    public class RibbonPanel : PanelControl, IKeyTipsControl
	{
        ...
        private HVTTButton m_ButtonScrollRight = null;
        private HVTTButton m_ButtonScrollLeft = null;
        ...
        private ElementStyle GetDefaultStyle()
        {
            ...
            if (this.ColorSchemeStyle == HVTTControlStyle.Office2007 || rc!=null && rc.Style == HVTTControlStyle.Office2007)
            {
                ...
                m_DefaultStyle.Border = StyleBorderType.Double;
                if (rc == null || !rc.IsPopupMode)
                    m_DefaultStyle.BorderTop = StyleBorderType.None;

                m_DefaultStyle.BorderWidth = 1;
                m_DefaultStyle.CornerDiameter = ct.RibbonControl.CornerSize;
                m_DefaultStyle.CornerType = CornerType.Rounded;
                m_DefaultStyle.CornerTypeTopLeft = CornerType.Square;
                m_DefaultStyle.CornerTypeTopRight = CornerType.Square;
            ...
            else
            {
                ...
                m_DefaultStyle.BorderBottom = StyleBorderType.Solid;
            }
        ...
        internal void LayoutRibbons()
        {
            ...
            else if (currentWidth < r.Width)
            {
                ...
                foreach(RibbonBar bar in overflowList)
                {
                    int oldWidth = bar.GetContentBasedSize().Width;
        ...
        private void RepositionRibbons(ArrayList layoutOrder, Rectangle layoutRectangle, int spacing, Control lastVisibleControl, int lastControlIncrease)
        {
            ...
            if (this.RightToLeft == RightToLeft.Yes)
            {
                ...
                {
                    currentWidth += bar.Width + spacing;
                }
            ...
            if (m_ViewBounds.Right > this.Width)
            {
                ...
                {
                    m_ButtonScrollRight = new HVTTButton();
            ...
            if (m_ScrollOffset < 0)
            {
                ...
                {
                    m_ButtonScrollLeft = new HVTTButton();
        ...
        //        minWidth += GetRibbonBarMinWidth(bar) + spacing;
        //        if (bar.GalleryStretch != null) barGallery = bar;
        ...
        //    if (r.Width >= minWidth)
        //    {
        //        int spaceAvailable = r.Width - minWidth;
                
        //        // Width available is enough to fit all bars
        //        foreach (RibbonBar bar in resizeOrder)
        //        {
        //            if (bar == barGallery) continue;
        //            int barMinWidth = GetRibbonBarMinWidth(bar);
        //            int barWidth = GetRibbonBarWidth(bar);
        //            if (barWidth > barMinWidth && barWidth - barMinWidth <= spaceAvailable)
        //            {
        //                bar.Width = barWidth;
        //                spaceAvailable -= (barWidth - barMinWidth);
        //            }
        //            else if (barWidth > bar.Width && barWidth - bar.Width <= spaceAvailable)
        //            {
        //                bar.Width = barWidth;
        //                spaceAvailable -= (barWidth - bar.Width);
        //            }
        //            if (spaceAvailable == 0)
        //                break;
        //        }
        //        if (barGallery != null && spaceAvailable != 0)
        //        {
        //            barGallery.Width = GetRibbonBarMinWidth(barGallery) + spaceAvailable;
        //        }
        //    }
        //    else
        //    {
        //        // Bars must be reduced so they can fit
        //        int reductionNeeded = minWidth - r.Width;
        //        foreach (RibbonBar bar in resizeOrder)
        //        {
        //            if(!bar.OverflowState)
        //            {
        //                int h = bar.Width;
        //                bar.Width -= reductionNeeded;
        //                if (bar.GetContentBasedSize().Width > bar.Width)
        //                    bar.Width = bar.GetContentBasedSize().Width;
        //                else
        //                {
        //                    bar.Width = bar.GetContentBasedSize().Width;
        //                    reductionNeeded += (bar.Width - h);
        //                }
        //            }
        ...
        //    //RepositionRibbons(layoutOrder);
        //}

        //private int GetRibbonBarMinWidth(RibbonBar bar)
        //{
        //    if (bar.OverflowState)
        //    {
        //        if (bar.LastReducedSize.Width > 0)
        //            return bar.LastReducedSize.Width;
        //        else if (bar.BeforeOverflowSize.Width > 0)
        //            return bar.BeforeOverflowSize.Width;
        //        return bar.GetContentBasedSize().Width;
        //    }
        //    else
        //    {
        //        if (bar.GalleryStretch != null)
        //        {
        //            if(bar.GalleryStretch.RecommendedSize.Width > 0)
        //                return bar.GetContentBasedSize().Width - bar.GalleryStretch.RecommendedSize.Width + bar.GalleryStretch.MinimumSize.Width;
        //            else
        //                return bar.GetContentBasedSize().Width - bar.GalleryStretch.DefaultSize.Width + bar.GalleryStretch.MinimumSize.Width;
        //        }
        //        else
        //            return bar.GetContentBasedSize().Width;
        //    }
        ...
        //private int GetRibbonBarWidth(RibbonBar bar)
        //{
        //    if (bar.OverflowState)
        //    {
        //        if (bar.BeforeOverflowSize.Width > 0)
        //            return bar.BeforeOverflowSize.Width;
        //        return bar.GetContentBasedSize().Width;
        //    }
        //    else
        //    {
        //        if (bar.GalleryStretch != null && bar.GalleryStretch.RecommendedSize.Width > 0)
        //            return bar.GetContentBasedSize().Width - bar.GalleryStretch.RecommendedSize.Width + bar.GalleryStretch.DefaultSize.Width;
        //        else
        //            return bar.GetContentBasedSize().Width;
        //    }
        //}
        ...
        /// <summary>
        /// Internal method to layout ribbon controls contained.
        /// </summary>
        //internal void LayoutRibbons2()
        //{
        //    int spacing = 2;
        //    bool stretchGalleryRibbonBar = false;
        ...
        //    ArrayList resizeOrder = new ArrayList();
        //    ArrayList layoutOrder = new ArrayList();
        //    ArrayList overflowBars = new ArrayList();
        //    Control lastVisibleControl = null;
        //    bool resizeOrderSpecified=false;
        //    foreach (Control c in this.Controls)
        //    {
        //        if (!c.Visible || !(c is RibbonBar))
        //            continue;

        //        currentWidth += (c.Width + spacing);
        //        RibbonBar rb = c as RibbonBar;
        //        if (rb.OverflowState || rb.IsItemsAutoSizeActive)
        //            overflowBars.Add(rb);
        //        if (rb.GalleryStretch != null && rb.GalleryStretch.WidthInternal>rb.GalleryStretch.MinimumSize.Width)
        //        {
        //            lastVisibleControl = rb;
        //            stretchGalleryRibbonBar = true;
        //        }

        //        minWidth += (rb.GetContentBasedSize().Width + spacing);
        //        if(rb.ResizeOrderIndex!=0)
        //            resizeOrderSpecified=true;
        //        resizeOrder.Add(rb);
        //        layoutOrder.Add(rb);
        //    }
        ...
        //    {
        //        resizeOrder.Sort(new ResizeOrderComparer());
        //        overflowBars.Sort(new ResizeOrderComparer());
        //    }
        //    else
        //    {
        //        resizeOrder.Sort(new XPositionComparer());
        //        overflowBars.Sort(new XPositionComparer());
        //    }

        //    if (stretchGalleryRibbonBar)
        //    {
        //        resizeOrder.Remove(lastVisibleControl);
        //        resizeOrder.Add(lastVisibleControl);
        //    }

        //    if (this.RightToLeft == RightToLeft.Yes)
        //        resizeOrder.Reverse();

        //    // Choose right last visible control
        //    if (lastVisibleControl == null && m_StretchLastRibbonBar)
        //    {
        //        if (this.RightToLeft == RightToLeft.Yes)
        //        {
        //            for (int i = 0; i < layoutOrder.Count; i++)
        //            {
        //                if (((RibbonBar)layoutOrder[i]).Visible)
        //                {
        //                    lastVisibleControl = (Control)layoutOrder[i];
        //                    break;
        //                }
        //            }
        //        }
        ...
        //    ArrayList controlBounds = new ArrayList();
        //    int lastBarExtend = 0;
        //    if (minWidth < r.Width)
        //    {
        //        int avail = r.Width - minWidth;

        //        // Either last ribbon needs to be expanded or if there are ribbons in overflow state they need to be expanded first
        //        //int start = overflowBars.Count - 1;
        //        //for (int i = start; i >=0; i--)
        //        for(int i=0 ; i<overflowBars.Count;i++)
        //        {
        //            RibbonBar bar = overflowBars[i] as RibbonBar;
        //            int w = bar.GetContentBasedSize().Width;
        //            if (w + avail < bar.LastReducedSize.Width && bar.LastReducedSize.Width > 0 && 
        //                w + avail < bar.BeforeOverflowSize.Width && bar.BeforeOverflowSize.Width > 0)
        //                continue;
        //            bar.Width = w + avail;
        //            if (!bar.OverflowState)
        //            {
        //                if (bar.Width >= bar.GetFullContentBasedSize().Width)
        //                    bar.Width = bar.GetFullContentBasedSize().Width;
        //                else
        //                    bar.Width = bar.GetContentBasedSize().Width;
        //                avail -= (bar.Width - w);
        //            }
        ...
        //        lastBarExtend = avail;
        //    }
        //    else if (minWidth > r.Width)
        //    {
        //        int reductionNeeded = minWidth - r.Width;
        //        int start = resizeOrder.Count - 1;
        //        int loopCount = 0;
        //        while (reductionNeeded>0 && loopCount < 2)
        //        {
        //            reductionNeeded = minWidth - r.Width;
        //            for (int i = start; i >= 0; i--)
        //            {
        //                RibbonBar bar = resizeOrder[i] as RibbonBar;
        //                if (!bar.OverflowState)
        //                {
        //                    int w = bar.GetContentBasedSize().Width;
        //                    if (bar.AutoSizeItems && !bar.IsItemsAutoSizeActive && bar.Width>reductionNeeded)
        //                    {
        //                        bar.Width -= reductionNeeded;
        //                    }
        //                    else
        ...
        //                    if (bar.OverflowState || bar.IsItemsAutoSizeActive || bar.Width == bar.GetContentBasedSize().Width)
        //                    {
        //                        bar.Width = bar.GetContentBasedSize().Width;
        //                        if (reductionNeeded < w - bar.Width)
        //                        {
        //                            // If we reduced more than needed
        //                            lastBarExtend = (w - bar.Width) - reductionNeeded;
        //                            reductionNeeded = 0;
        //                            break;
        //                        }
        //                        else
        //                        {
        //                            reductionNeeded -= (w - bar.Width);
        //                            if (reductionNeeded == 0)
        //                                break;
        //                        }
        //                    }
        ...
        //        if (currentWidth < r.Width)
        //        {
        //            offset = spacing + r.Width - currentWidth;
        //        }
        //    }
        ...
        //    foreach (RibbonBar bar in layoutOrder)
        //    {
        //        int width = bar.GetContentBasedSize().Width;
        //        if (bar == lastVisibleControl && (m_StretchLastRibbonBar || stretchGalleryRibbonBar) && !bar.OverflowState)
        //            width += lastBarExtend;
        //        //Rectangle bounds = new Rectangle(p.X, p.Y, width, r.Height);
        //        Rectangle bounds = new Rectangle(p.X + offset, p.Y, width, r.Height);
        //        if (this.DesignMode)
        //            TypeDescriptor.GetProperties(bar)["Bounds"].SetValue(bar, bounds);
        //        else
        //            bar.Bounds = bounds;
