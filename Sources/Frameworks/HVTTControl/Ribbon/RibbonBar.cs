...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxBitmap(typeof(RibbonBar),"Ribbon.RibbonBar.ico"),ToolboxItem(true),Designer(typeof(Design.RibbonBarDesigner)),System.Runtime.InteropServices.ComVisible(false)]
	public class RibbonBar:ItemControl
	{
        ...
        /// <summary>
        /// Occurs when overflow button for control is created becouse control size is below the minimum size required to display complete content of the control.
        ...
        /// </summary>
        [Description("Occurs when overflow button for control is created becouse control size is below the minimum size required to display complete content of the control.")]
        ...
        /// BackgroundStyle.
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Style"), Description("Indicates mouse over background style."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		/// default appearance for the button is used.
		/// </summary>
		[Browsable(true),DefaultValue(null), Category("Appearance"),Description("Indicates image that is used as dialog luncher button when mouse is over the button.")]
        ...
        /// reduced size of the control text for the button can be specifed using OverflowButtonText property. If
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),DefaultValue(false),Category("Behavior"),Description("Indicates whether dialog launcher button is visible in title of the ribbon.")]
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if (m_DialogLauncherRect.Contains(e.X, e.Y) && e.Button == MouseButtons.Left)
            {
                ...
                else if (this.Parent is HVTTMarkStatus && ((HVTTMarkStatus)this.Parent).BarState == HVTTBarState.Popup)
                {
                    PopupItem item = ((HVTTMarkStatus)this.Parent).ParentItem as PopupItem;
                    if (item != null)
                        item.ClosePopup();
                }
                InvokeLaunchDialog(new EventArgs());
        ...
        {
            if (cont.LayoutOrientation == HVTTOrientation.Vertical)
            {
                foreach (BaseItem item in cont.SubItems)
                {
                    ButtonItem b = item as ButtonItem;
                    if (b != null && b.ButtonStyle == HVTTButtonStyle.ImageAndText && (b.ImagePosition == ImagePosition.Left || b.ImagePosition == ImagePosition.Right))
                    {
                        BaseItemAutoSizeBag bag = AutoSizeBagFactory.CreateAutoSizeBag(b);
                        bag.RecordSetting(b);
                        bool gi = b.GlobalItem;
                        b.GlobalItem = false;
                        b.ButtonStyle = HVTTButtonStyle.Default;
            ...
            else
            {
                ...
                foreach (BaseItem item in cont.SubItems)
                {
                    ...
                    {
                        ButtonItem b = item as ButtonItem;
                        if (b.ImagePosition == ImagePosition.Top || b.ImagePosition == ImagePosition.Bottom)
                        {
                            buttons.Add(b);
                        }
                    }
                ...
                if (buttons.Count > 1)
                {
                    ...
                    for (int i = buttons.Count - 1; i >=lowerBound; i--)
                    {
                        ...
                        b.ButtonStyle = HVTTButtonStyle.ImageAndText;
                        b.ImageFixedSize = new Size(16, 16);
                        b.GlobalItem = gi;
                        m_AutoSizeBagList.Add(bag);
                    }
                    ...
                    cont.LayoutOrientation = HVTTOrientation.Vertical;
                    cont.MultiLine = true;
                }
            }
        }
        ...
        internal void RestoreAutoSizedItems()
        {
            ...
            foreach (BaseItemAutoSizeBag ab in m_AutoSizeBagList)
                ab.RestoreSettings();
        ...
        private HVTTOrientation m_OriginalLayoutOrientation = HVTTOrientation.Horizontal;
        ...
        private void SetupOverflowButton()
        {
            ...
            m_OverflowButton = new RibbonOverflowButtonItem();
            m_OverflowButton.Name = "sysOverflowButton";
            m_OverflowButton.Text = GetOverflowButtonText();
            m_OverflowButton.RibbonBar = this;
            m_OverflowButton.Image = GetOverflowButtonImage();
            m_OverflowButton.ButtonStyle = HVTTButtonStyle.ImageAndText;
            m_OverflowButton.ImagePosition = ImagePosition.Top;
            m_OverflowButton.AutoExpandOnClick = true;
            m_OverflowButton.PopupType = ePopupType.Menu;
            m_OverflowButton.ImagePaddingHorizontal = 16;
            m_OverflowButton.VerticalPadding = 12;
            m_OverflowButton.SubItemsExpandWidth = 14;
            m_OverflowButton.HotTrackingStyle = HotTrackingStyle.None;
            m_OverflowButton.PopupOpen += new HVTTManager.PopupOpenEventHandler(OverflowButton_PopupOpen);
            if (OverflowButtonSetup != null)
                OverflowButtonSetup(this, new OverflowButtonEventArgs(m_OverflowButton));
            ...
            m_ItemContainer.SubItems.Add(m_OverflowButton);
            ...
            m_ItemContainer.LayoutOrientation = HVTTOrientation.Horizontal;
            ...
            m_OverflowButton.SubItems.Add(ic);
        ...
        ///// <summary>
        ///// Applies predefined visual style to items, color schemes and control background.
        ///// </summary>
        ///// <param name="style"></param>
        //public void SetVisualStyle(HVTTControlStyle style)
        //{
        //    if(style==HVTTControlStyle.Office12)
        //        RibbonPredefinedColorSchemes.ApplyGrayColorScheme(this);
        //    else if(style==HVTTControlStyle.Office2003 || style==HVTTControlStyle.VS2005)
        //        RibbonPredefinedColorSchemes.ApplyOffice2003ColorScheme(this);
        //    this.Style=style;
        //}
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Appearance"),Description("Specifies the visual style of the control.")]
        ...
        protected override bool ProcessMnemonic(BaseItem container, char charCode)
        {
            ...
            return base.ProcessMnemonic(container, charCode);
        }
		...
		protected override void PaintControlBackground(ItemPaintArgs pa)
		{
            ...
            if (backStyle != null)
            {
                ...
                ElementStyleDisplayInfo displayInfo = new ElementStyleDisplayInfo(backStyle, pa.Graphics, r);
		...
		/// </summary>
		[Browsable(true),HVTTBrowsable(true),Category("Style"),Description("Specifies the style of the title of the control"),DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Style"), Description("Specifies the style of the title of the control when mouse is over the control."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Appearance"), Description("Specifies background color of the Bar."), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
