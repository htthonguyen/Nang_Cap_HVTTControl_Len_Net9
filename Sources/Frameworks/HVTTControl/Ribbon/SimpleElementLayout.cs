...
namespace HVTT.UI.Window.Forms
{
	...
	internal class SimpleElementLayout
	{
		internal static void LayoutSimpleElement(SimpleElementLayoutInfo info)
		{
			...
			{
				eVerticalAlign va=GetVerticalAlign(info.Element.ImageAlignment);
				eHorizontalAlign ha=GetHorizontalAlign(info.Element.ImageAlignment,info.LeftToRight);
				if(info.VerticalPartAlignment)
		...
		private static eHorizontalAlign GetHorizontalAlign(eSimplePartAlignment align, bool leftToRight)
		{
		...
		private static eVerticalAlign GetVerticalAlign(eSimplePartAlignment align)
		{
