...
namespace HVTT.UI.Window.Forms
{
	...
	/// </summary>
	[ToolboxItem(false),DesignTimeVisible(false),Designer(typeof(Design.ItemContainerDesigner))]
	public class ItemContainer:ImageItem , IDesignTimeProvider
	{
        ...
        private int m_BeginGroupSpacing = 2;
		...
		public ItemContainer()
		{
            ...
            m_BackgroundStyle.StyleChanged += new EventHandler(BackgroundStyleChanged);
		}
        ...
        /// </summary>
        [Browsable(true), HVTTBrowsable(true), Category("Style"), Description("Gets or sets container background style."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// </summary>
        [Browsable(true), DefaultValue(eVerticalItemsAlignment.Top), Category("Layout"), Description("Indicates item item vertical alignment."), HVTTBrowsable(true)]
        ...
        protected virtual Rectangle GetClipRectangle()
        {
            ...
            ElementStyle style = ElementStyleDisplay.GetElementStyle(m_BackgroundStyle);
		...
		public override void Paint(ItemPaintArgs p)
		{
            ...
            if (this.Style == HVTTControlStyle.Office2007 && this.BeginGroup)
            {
                Rectangle clip = this.DisplayRectangle;
                clip.Inflate(-1, -1);
                oldClip = g.Clip;
        ...
        protected virtual Size GetEmptyDesignTimeSize()
        {
            ...
            if (m_LayoutOrientation == HVTTOrientation.Horizontal)
                s.Width += 12;
            else
                s.Height += 12;
        ...
        protected virtual Rectangle LayoutItems(Rectangle bounds)
        {
            ...
            r.Width += ElementStyleLayout.HorizontalStyleWhiteSpace(style); // m_BackgroundStyle.PaddingHorizontal + m_BackgroundStyle.MarginHorizontal;
            r.Height += ElementStyleLayout.VerticalStyleWhiteSpace(style); // m_BackgroundStyle.PaddingVertical + m_BackgroundStyle.MarginVertical;
		...
		public override HVTTOrientation Orientation
		{
			get {return HVTTOrientation.Horizontal;}
			set	{}
		}
		...
		/// </summary>
        [Browsable(true), HVTTBrowsable(true), DefaultValue(HVTTOrientation.Horizontal), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), Category("Layout")]
        ...
        ///// </summary>
        //[Browsable(true), HVTTBrowsable(true), DefaultValue(eContainerVerticalAlignment.Top), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
		...
		private void OnOrientationChanged()
		{
			...
			if(m_LayoutManager!=null)
				m_LayoutManager.ContentOrientation=(this.LayoutOrientation==HVTTOrientation.Horizontal?eContentOrientation.Horizontal:eContentOrientation.Vertical);
            OnAppearanceChanged();
		}
		...
		/// <summary>
		/// Returns whether instance of the item container is used as system container internally by HVTTCONTROLS.
		/// </summary>
		[Browsable(false)]
		...
		/// <summary>
		/// Sets whether container is used as system container internally by HVTTCONTROLS.
		/// </summary>
		...
		/// </summary>
		[HVTTBrowsable(true),Browsable(true),Category("Accessibility"),Description("Gets or sets the accessible role of the item."),DefaultValue(System.Windows.Forms.AccessibleRole.Grouping)]
		...
		protected virtual IContentLayout GetContentLayout()
		{
            ...
            if (m_MinimumSize.Width > 0 && m_LayoutOrientation == HVTTOrientation.Vertical)
                m_LayoutManager.VerticalFitContainerWidth = true;
            else
                m_LayoutManager.VerticalFitContainerWidth = false;

            if (m_MinimumSize.Height > 0 && m_LayoutOrientation == HVTTOrientation.Horizontal)
            ...
            m_LayoutManager.BlockSpacing = m_ItemSpacing - (this.BeginGroup?1:0);
        ...
        private void LayoutManager_BeforeNewBlockLayout(object sender, LayoutManagerLayoutEventArgs e)
        {
            ...
            if (item != null && item.BeginGroup && !(item is ItemContainer) && e.BlockVisibleIndex>0)
            {
                if (m_LayoutOrientation == HVTTOrientation.Horizontal)
        ...
        {
            if (m_HorizontalItemAlignment == eHorizontalItemsAlignment.Left /*|| m_LayoutOrientation == HVTTOrientation.Vertical*/)
		...
		/// </summary>
		[Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Indicates whether item can be customized by user.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Gets or sets whether Click event will be auto repeated when mouse button is kept pressed over the item.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(600),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Gets or sets the auto-repeat interval for the click event when mouse button is kept pressed over the item.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(null),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies the mouse cursor displayed when mouse is over the item.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Indicates whether is item enabled.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(true),System.ComponentModel.Category("Behavior"),System.ComponentModel.Description("Indicates whether certain global properties are propagated to all items with the same name when changed.")]
		...
		/// </summary>
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.DefaultValue(false),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies whether item is drawn using Themes when running on OS that supports themes like Windows XP.")]
        ...
        ///// </summary>
        //[Browsable(true), HVTTBrowsable(true), Category("Appearance"), Description("Gets the container padding"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        ///// </summary>
        //[Browsable(true), HVTTBrowsable(true), Category("Appearance"), Description("Gets the container margin"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// <summary>
        /// Selectes first visible item contained by the container by sending mouse over message.
        /// </summary>
        ...
        /// <summary>
        /// Sets the new hot-sub item for the container. This method is designed for internal use by the HVTTCONTROLS and should not be used.
        /// </summary>
