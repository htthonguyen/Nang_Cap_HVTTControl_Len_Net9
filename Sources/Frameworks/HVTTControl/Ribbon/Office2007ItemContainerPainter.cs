...
namespace HVTT.UI.Window.Forms
{
    internal class Office2007ItemContainerPainter : ItemContainerPainter, IOffice2007Painter
    {
        ...
        {
            if (e.ItemContainer.Style != HVTTControlStyle.Office2007)
                return;
            ...
            if (!container.BeginGroup || container.IsOnMenu && !(container.Parent is ItemContainer))
            {
                ...
                e.ItemPaintArgs.ContainerControl is HVTTMarkStatus && ((HVTTMarkStatus)e.ItemPaintArgs.ContainerControl).BarType == eBarType.StatusBar)
                {                    
                    bounds.Y = 1;
            ...
            g.SmoothingMode = sm;
            bool isVertical = container.LayoutOrientation == HVTTOrientation.Vertical;
        ...
        public override void PaintItemSeparator(ItemContainerSeparatorRendererEventArgs e)
        {
            ...
            if (container.LayoutOrientation == HVTTOrientation.Horizontal)
            {
