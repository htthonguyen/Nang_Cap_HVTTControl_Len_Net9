...
namespace HVTT.UI.Window.Forms
{
    ...
    /// </summary>
    [DesignTimeVisible(false), ToolboxItem(false), TypeConverterAttribute(typeof(Design.GalleryGroupConverter))]
    public class GalleryGroup : Component
    {
        ...
        /// </summary>
        [Browsable(true), DefaultValue(""), Editor(typeof(Design.TextMarkupUIEditor), typeof(System.Drawing.Design.UITypeEditor)), Localizable(true), Description("Indicates title of the group that will be displayed on the group label when on popup gallery.")]
        public string Text
        {
            get { return m_Text; }
            set
