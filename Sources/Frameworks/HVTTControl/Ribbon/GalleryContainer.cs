...
{
    /// <summary>
    /// Represents the class that provides Office 2007 style Gallery contfainer with drop-down ability.
    /// </summary>
    [ToolboxItem(false), DesignTimeVisible(false), ProvideProperty("GalleryGroup", typeof(BaseItem)), Designer(typeof(Design.GalleryContainerDesigner))]
    public class GalleryContainer : ItemContainer, IExtenderProvider
    {
        ...
        public event HVTTManager.PopupOpenEventHandler GalleryPopupOpen;
        ...
        private void CreateButtons()
        {
            ...
            m_PopupGallery.PopupOpen += new HVTTManager.PopupOpenEventHandler(PopupGallery_PopupOpen);
        ...
        internal Rectangle PopupGalleryButtonBounds
        {
            get { return m_PopupGallery.DisplayRectangle; }
        }

        internal ButtonItem PopupGalleryItem
        {
        ...
        /// </summary>
        [Browsable(false), DefaultValue(HVTTOrientation.Horizontal), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), Category("Layout")]
        public override HVTTOrientation LayoutOrientation
        {
        ...
        /// of the Gallery are used to indicate the scrolling possiblity and enable scrolling. Buttons are only
        ...
        /// <summary>
        /// Scrolls the gallery if neccessary to ensures that item is visible.
        /// </summary>
        ...
        public void EnsureVisible(BaseItem item)
        {
            ...
            SetScrollPosition(GetScrollForItem(item));
        }
        ...
        protected override System.Drawing.Rectangle GetLayoutRectangle(System.Drawing.Rectangle bounds)
        {
            ...
            ElementStyle style = ElementStyleDisplay.GetElementStyle(BackgroundStyle);
            ...
            else
            {
                if (!this.DesignMode)
                {
                    ...
                    if (m_Groups.Count > 0)
                    {
                        ...
                        c.MultiLine = false;
                        c.LayoutOrientation = HVTTOrientation.Vertical;
        ...
        private ItemContainer CreateContainerFormGroup(GalleryGroup g)
        {
            ...
            c.LayoutOrientation = HVTTOrientation.Horizontal;
            c.MultiLine = true;
        ...
        private LabelItem CreateLabelForGroup(GalleryGroup g)
        {
            ...
            if (Rendering.GlobalManager.Renderer is Rendering.Office2007Renderer)
            {
                ...
                l.BorderSide = BorderSide.Bottom;
                l.PaddingTop = 1;
                l.PaddingLeft = 10;
                l.PaddingBottom = 1;
            }
        ...
        private void RecordStartState(object sender, EventArgs e)
        {
            ...
            try
            {
                ElementStyle style = ElementStyleDisplay.GetElementStyle(this.BackgroundStyle);
        ...
        private bool IsAnimationEnabled
        {
            get
            {
                if (this.DesignMode || !m_ScrollAnimation || !this.Displayed)
                    return false;
                System.Windows.Forms.Control cc = this.ContainerControl as System.Windows.Forms.Control;
                if (cc != null)
                {
        ...
        [Editor(typeof(Design.GalleryGroupTypeEditor),typeof(System.Drawing.Design.UITypeEditor)), DefaultValue(null)]
        ...
        /// </summary>
        [Editor(typeof(GalleryGroupCollectionEditor), typeof(System.Drawing.Design.UITypeEditor)), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Category("Groups"), Browsable(false), Description("Gets the collection of GalleryGroup objects associated with this gallery.")]
