...
namespace HVTT.UI.Window.Forms
{
    ...
    System.Runtime.InteropServices.ComVisible(false), Designer(typeof(Design.SuperTooltipDesigner))]
    public class SuperTooltip : Component , IExtenderProvider
    {
        ...
        private const string TREEGX_NODE_CLASS_NAME = "HVTT.Tree.Node";
        #endregion
        ...
        /// </summary>
        [Localizable(true), Editor(typeof(Design.SuperTooltipInfoEditor), typeof(System.Drawing.Design.UITypeEditor)), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), DefaultValue(null), Description("Indicates default setting for new Tooltips you create in design time.")]
		...
		/// </summary>
        [Editor(typeof(Design.SuperTooltipInfoEditor), typeof(System.Drawing.Design.UITypeEditor)), DefaultValue(null), Localizable(true)]
        ...
        private void RemoveSuperTooltipInfo(IComponent c)
        {
            ...
            else if (c.GetType().FullName == TREEGX_NODE_CLASS_NAME)
            {
        ...
        private ComboBoxItem GetComboBoxItemFromComboBoxEx(Controls.HVTTComboBox c)
        {
        ...
        private void ShowTooltip(object sender, Point screenPosition, bool useScreenPosition)
        {
            ...
            if (sender is Controls.HVTTComboBox)
            {
                BaseItem combo = GetComboBoxItemFromComboBoxEx(sender as Controls.HVTTComboBox);
            ...
            if (sender is BaseItem)
            {
                ...
                if (item is PopupItem && ((PopupItem)item).Expanded)
                    return;
                Control itemControl = item.ContainerControl as Control;
                if (itemControl != null)
                {
                    if (m_PositionBelowControl && !(itemControl is RibbonStrip && ((RibbonStrip)itemControl).QuickToolbarItems.Contains(item)))
                    ...
                    rightToLeft = (((Control)item.ContainerControl).RightToLeft == RightToLeft.Yes);
                }
            }
            ...
            else if (sender.GetType().FullName == TREEGX_NODE_CLASS_NAME)
            {
        ...
        {
            if (sender is HVTTMarkTextBox && !m_SuperTooltipInfo.Contains(sender))
            {
                foreach (object o in m_SuperTooltipInfo.Keys)
                {
            ...
            else if (sender is HVTTComboBox && !m_SuperTooltipInfo.Contains(sender))
            {
                foreach (object o in m_SuperTooltipInfo.Keys)
                {
        ...
        private bool IsFormActive(object sender)
        {
            ...
            if (sender is Control)
                ...
                c = ((BaseItem)sender).ContainerControl as Control;
        ...
        public bool CanExtend(object extendee)
        {
            if (extendee is Control || extendee is BaseItem || 
                extendee is ISuperTooltipInfoProvider || extendee.GetType().FullName == TREEGX_NODE_CLASS_NAME ||
                extendee is TabItem)
                return true;
            return false;
        }
    ...
    /// </summary>
    [TypeConverter(typeof(SuperTooltipInfoConverter)), DesignTimeVisible(false), ToolboxItem(false), Localizable(true)]
    public class SuperTooltipInfo
    {
        ...
        private TooltipColor m_Color = TooltipColor.Gray;
        ...
        /// </summary>
        public SuperTooltipInfo(string headerText, string footerText, string bodyText, Image bodyImage, Image footerImage, TooltipColor color, bool headerVisible, bool footerVisible, Size customSize)
        {
        ...
        /// Creates new instance of the class with specified parameters.
        /// </summary>
        public SuperTooltipInfo(string headerText, string footerText, string bodyText, Image bodyImage, Image footerImage, TooltipColor color)
        {
            m_HeaderText = headerText;
            m_FooterText = footerText;
            m_BodyText = bodyText;
        ...
        /// </summary>
        [Browsable(true), DefaultValue(TooltipColor.Gray), Description("Indicates predefined tooltip color."), Localizable(true)]
