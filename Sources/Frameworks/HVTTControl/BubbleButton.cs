...
namespace HVTT.UI.Window.Forms
{
	...
	public class BubbleButton:Component,HVTT.UI.ContentManager.IBlock
	{
...
//		}
		...
		/// </summary>
		[Browsable(true),Category("Images"),Description("Indicates default image used on the button."),Editor(typeof(HVTT.UI.Editors.ImageIndexEditor), typeof(System.Drawing.Design.UITypeEditor)),System.ComponentModel.TypeConverter(typeof(ImageIndexConverter)),DefaultValue(-1)]
		...
		/// </summary>
		[Browsable(true),Category("Images"),Description("Indicates image index of the enlarged image for the button."),Editor(typeof(HVTT.UI.Editors.ImageIndexEditor), typeof(System.Drawing.Design.UITypeEditor)),TypeConverter(typeof(ImageIndexConverter)),DefaultValue(-1)]
		...
		public void InvokeClick(EventSource source, MouseButtons mouseButton)
		{
		...
		/// </summary>
		Rectangle HVTT.UI.ContentManager.IBlock.Bounds
		{
			get {return m_DisplayRectangle;}
	...
	public class ClickEventArgs:EventArgs
	{
		...
		public ClickEventArgs(EventSource action, MouseButtons button)
		{
