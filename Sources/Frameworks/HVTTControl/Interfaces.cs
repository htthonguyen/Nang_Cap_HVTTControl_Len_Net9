namespace HVTT.UI.Window.Forms
{
	...
	/// <summary>
	/// Provides design-time support for HVTTCONTROLS items.
	/// </summary>
	...
	{
		HVTTMenuVisibility MenuVisibility {get;set;}
...
//		void InvokeItemDisplayedChanged(BaseItem item, EventArgs e);
	...
	public interface IOwnerMenuSupport
	{
		...
		HVTTMenuDropShadow MenuDropShadow{get;set;}
		HVTTPopupAnimation PopupAnimation{get;set;}
	...
	{
		void InvokeDockTabChange(HVTTMarkStatus bar,DockTabChangeEventArgs e);
		void InvokeBarDock(HVTTMarkStatus bar,EventArgs e);
		void InvokeBarUndock(HVTTMarkStatus bar,EventArgs e);
		void InvokeAutoHideChanged(HVTTMarkStatus bar,EventArgs e);
		void InvokeBarClosing(HVTTMarkStatus bar,BarClosingEventArgs e);
		void InvokeAutoHideDisplay(HVTTMarkStatus bar,AutoHideDisplayEventArgs e);
		void InvokeBarTearOff(HVTTMarkStatus bar,EventArgs e);
		...
		void AddShortcutsFromBar(HVTTMarkStatus bar);
		void RemoveShortcutsFromBar(HVTTMarkStatus bar);
	...
	{
		HVTT.UI.Window.Forms.ThemeWindow ThemeWindow{get;}
		HVTT.UI.Window.Forms.ThemeRebar ThemeRebar{get;}
		HVTT.UI.Window.Forms.ThemeToolbar ThemeToolbar{get;}
		HVTT.UI.Window.Forms.ThemeHeader ThemeHeader{get;}
		HVTT.UI.Window.Forms.ThemeScrollBar ThemeScrollBar{get;}
		HVTT.UI.Window.Forms.ThemeExplorerBar ThemeExplorerBar{get;}
		HVTT.UI.Window.Forms.ThemeProgress ThemeProgress{get;}
        HVTT.UI.Window.Forms.ThemeButton ThemeButton { get;}
	}

	public interface IBarImageSize
	{
		BarImageSize ImageSize {get;set;}
	}
    ...
    public interface IRenderingSupport
    {
        ...
        /// </summary>
        HVTT.UI.Window.Forms.Rendering.BaseRenderer Renderer { get; set;}
    }

    /// <summary>
    /// Defines interface for internal accessibility support for HVTTCONTROLS control.
    /// </summary>
