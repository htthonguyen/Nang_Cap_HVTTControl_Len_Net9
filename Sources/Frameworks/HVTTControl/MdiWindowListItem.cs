...
namespace HVTT.UI.Window.Forms
{
	...
	public class MdiWindowListItem:ImageItem
	{
		...
		[System.ComponentModel.Browsable(false),HVTTBrowsable(false),System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Category("Appearance"),System.ComponentModel.Description("Specifies whether the MDI Child Window Icons are displayed on items.")]
		...
		/// </summary>
		[System.ComponentModel.Category("Behavior"),System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.DefaultValue(22),System.ComponentModel.Description("Indicates maximum form caption length that will be displayed on each item. If caption length exceeds given value ... characters are added.")]
		...
		public void MdiFormAdded(object sender, System.Windows.Forms.ControlEventArgs e)
		{
			...
			btn.ButtonStyle=HVTTButtonStyle.ImageAndText;
...
//				btn.Image=img;
		...
		private void MdiWindowItemClick(object sender, EventArgs e)
		{
			...
			if(oldActive!=null && oldActive.WindowState==System.Windows.Forms.FormWindowState.Normal && !(this.ContainerControl is HVTTMarkStatus))
			{
...
//					btn.Image=img;
			...
			if(m_MdiItems.Count>0 && this.ContainerControl is HVTTMarkStatus)
				((HVTTMarkStatus)this.ContainerControl).RecalcLayout();
		}
		...
		private void FormVisibleChanged(object sender, EventArgs e)
		{
			...
			foreach(BaseItem item in m_MdiItems)
			{
				if(item.Tag==form)
				{
					...
					if(this.ContainerControl is HVTTMarkStatus && item.Visible)
						((HVTTMarkStatus)this.ContainerControl).RecalcLayout();
					break;
				}
			}
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Description("Indicates whether flicker associated with switching maximized Mdi child forms is attempted to eliminate."),System.ComponentModel.Category("Mdi Support"),System.ComponentModel.DefaultValue(true)]
		...
		/// </summary>
		[System.ComponentModel.Browsable(true),HVTTBrowsable(true),System.ComponentModel.Description("Indicates whether numbered access keys are created for MDI Child window menu items for first 9 items."),System.ComponentModel.Category("Mdi Support"),System.ComponentModel.DefaultValue(false)]
